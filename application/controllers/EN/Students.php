...
class Students extends CI_Controller
{
    ...
    public function Home()
    {
        ...
        $this->load->view('EN/students/Home');
    ...
    public function Mylifereports()
    {
        ...
        if ($this->input->method() == 'get') {
            ...
            $this->load->view('EN/inc/header', $data);
            $this->load->view('EN/students/Mylifereports');
            $this->load->view('EN/inc/footer');
    ...
    public function Mylifereportsmedia()
    {
        ...
        if ($this->input->method() == "post") {
            ...
            if ($this->uri->segment(4) && is_numeric($this->uri->segment(4))) {
                ...
                $data['id'] = $this->uri->segment(4);
                $this->load->view('EN/inc/header', $data);
                $this->load->view('EN/students/Mylifereportsmedia');
                $this->load->view('EN/inc/footer');
            } else {
                redirect('/EN/Students/Home');
            }
        }
    }
    ...
    public function Profile()
    {
        if ($this->input->method() == "get") {
            if ($this->uri->segment(4) && $this->uri->segment(4) == "edite") {
                ...
                $user_data = $this->db->query(" SELECT `l2_student`.* , Link , `l1_school`.`School_Name_EN` AS Schoolname
                FROM `l2_student` 
                ...
                $this->load->view("EN/inc/header", $data);
                $this->load->view("EN/students/Profile");
                $this->load->view("EN/inc/footer");
            }
        } else {
            $this->load->library('form_validation');
    ...
    public function Dashboard()
    {
        ...
        $this->load->view("EN/inc/header", $data);
        $this->load->view("EN/students/Dashboard");
        $this->load->view("EN/inc/footer");
    }
    ...
    public function start_survey()
    {
        ...
        if ($this->input->method() == "get") {
            if ($this->uri->segment(4) && is_numeric($this->uri->segment(4))) {
                ...
                redirect('EN/Students/Show_surveys');
            }
        } elseif ($this->input->method() == "post") {
