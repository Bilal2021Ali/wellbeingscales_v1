...
class Departments extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if (!empty($sessiondata)) {
            ...
            $this->load->view("EN/Department/dash");
    ...
    public function MembersList()
    {
        ...
        $data['sessiondata'] = $sessiondata;
        $this->load->view('EN/inc/header', $data);
        $this->load->view('EN/Department/Avatars');
        $this->load->view('EN/inc/footer');
    }
...
?>
            <table class="table">
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo base_url() ?>EN/Departments/ChangeMemberAvatar/<?php echo $type ?>/<?php echo $admin['Id']; ?>">
    ...
    public function Lab_Tests()
    {
        ...
        if ($devices_counter !== 0) {
            $this->load->view('EN/inc/header', $data);
            $this->load->view('EN/Department/Test_lab');
            $this->load->view('EN/inc/footer');
        } else {
            $data['hasntnav'] = true;
            $this->load->view('EN/inc/header', $data);
    ...
    public function ChangeMemberAvatar()
    {
        if ($this->uri->segment(3) && $this->uri->segment(4)) {
            ...
            $Body['user_id'] = $UserId;
            $this->load->view('EN/inc/header', $data);
            $this->load->view('EN/Department/ChangePhotoForMember', $Body);
            $this->load->view('EN/inc/footer');
        }
    }
    ...
    public function tests()
    {
        ...
        $data['sessiondata'] = $sessiondata;
        $this->load->view('EN/inc/header', $data);
        $this->load->view('EN/Department/Test');
        $this->load->view('EN/inc/footer');
    }
...
<?php } else {
    ...
    public function Attendance_Report()
    {
        ...
        $data['sessiondata'] = $sessiondata;
        $this->load->view('EN/inc/header', $data);
        $this->load->view('EN/schools/Attendance_Report');
        $this->load->view('EN/inc/footer');
    }
    ...
    public function All_Tests_Today()
    {
        ...
        $data['sessiondata'] = $sessiondata;
        $this->load->view('EN/inc/header', $data);
        $this->load->view('EN/Department/All_Tests_Today');
        $this->load->view('EN/inc/footer');
    }
