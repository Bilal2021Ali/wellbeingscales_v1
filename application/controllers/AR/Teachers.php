...
class Teachers extends CI_Controller
{
    ...
    public function Dashboard()
    {
        ...
        $this->load->view("AR/teachers/Dashboard");
    ...
    public function start_private_survey()
    {
        ...
        if ($this->input->method() == "get") {
            ...
            `sv_st1_surveys`.`title_ar` AS Title_en,
            `sv_st_surveys`.`Message_ar` AS Message,
            `sv_st_fillable_surveys`.`Id` AS main_survey_id ,
    ...
    public function Home()
    {
        ...
        $this->load->view("AR/inc/header", $data);
        $this->load->view("AR/teachers/Home");
        $this->load->view("AR/inc/footer");
    }
    ...
    public function Profile()
    {
        if ($this->input->method() == "get") {
            if ($this->uri->segment(4) && $this->uri->segment(4) == "edite") {
                ...
                $this->load->view("AR/inc/header", $data);
                $this->load->view("AR/teachers/Profile");
                $this->load->view("AR/inc/footer");
            }
        } else {
                ...
                if (!empty($data['survey_data'])) {
                    ...
                    if ($this->uri->segment(5)) {
                        ...
                        if (empty($answers)) {
                            ...
                            FROM `l2_student` WHERE Id = '" . $student_id . "' ")->result_array()[0] ?? redirect('teachers/DedicatedSurveys/' . $id);
                            ...
                            redirect('AR/teachers/DedicatedSurvey/' . $id);
                        }
                    }
                    $this->load->view("AR/inc/header", $data);
                    ...
                    redirect('AR/teachers/DedicatedSurveys');
                }
            } else {
                redirect('AR/teachers/DedicatedSurveys');
            }
