...
class Staffs extends CI_Controller
{
    ...
    public function Dashboard()
    {
        ...
        $this->load->view("AR/staffs/Dashboard");
    ...
    public function start_survey()
    {
        ...
        if ($this->input->method() == "get") {
            if ($this->uri->segment(4) && is_numeric($this->uri->segment(4))) {
                ...
                redirect('AR/Parents/Show_surveys');
            }
        } elseif ($this->input->method() == "post") {
    ...
    public function survey_feedback()
    {
        if ($this->uri->segment(4) && $this->uri->segment(5) && is_numeric($this->uri->segment(4)) && md5($this->uri->segment(4)) == $this->uri->segment(5)) {
            ...
            $this->load->view("AR/inc/header", $data);
            $this->load->view("AR/Global/l3_school/give_feedback_of_survey_exp");
            $this->load->view("AR/inc/footer");
        } else {
            $this->load->view('');
        }
    ...
    public function Profile()
    {
        if ($this->input->method() == "get") {
            if ($this->uri->segment(4) && $this->uri->segment(4) == "edite") {
                ...
                $this->load->view("AR/inc/header", $data);
                $this->load->view("AR/staffs/Profile");
                $this->load->view("AR/inc/footer");
            }
        } else {
