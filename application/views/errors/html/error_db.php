...
<body class="authentication-bg">
        <div class="my-5 pt-sm-5" show="yes">
            <div class="container" show="yes">

                <div class="row" show="yes">
                    <div class="col-md-12" show="yes">
                        <div class="text-center" show="yes">
                            <div show="yes">
                                <div class="row justify-content-center" show="yes">
                                    <div class="col-sm-4" show="yes">
                                        <div class="error-img" show="yes">
