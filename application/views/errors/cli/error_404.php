                        ...
                        <div class="text-center">
                            <div>
                                <div class="row justify-content-center">
                                    <div class="col-sm-4">
                                        <div class="error-img">
							<img src="<?php echo base_url(); ?>assets/images/closedAccount.svg" alt=""
								 class="img-fluid mx-auto d-block">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <h4 class="text-uppercase mt-4 ">نعتذر منكم</h4>
                            <p class="text-muted">أسفون , هذا الحساب متوقف حاليا من طرف الإدارة </p>
                            <div class="mt-5">
					<a class="btn btn-primary waves-effect waves-light" href="<?php echo base_url()  ?>AR/users">
						إتخاذ إجرائات  
					</a>
                            </div>
                        </div>
