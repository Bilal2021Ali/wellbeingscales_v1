                    ...
                    <div class="row">
                        <div class="col-lg-3 user_bar">
                            ...
                            <div class="content mt-10 text-center" data-pattern="priority-columns" data-simplebar="init">
                                ...
                                <div class="container">
                                <div class="container">
                                    <button type="button" class="btn btn-link waves-effect font-size-12 float-right showEdite mt-3">تعديل الملف</button>
                                    <hr class="d-block">
                                </div>
                                <form action="" class="needs-validation custom-validation" id="edite_my_data" novalidate>
                                    <div class="form-group">
                                        <label for="f_n" class="float-left">:الاسم الأول انجليزي</label>
                                    ...
                                    <div class="form-group group-ar">
                                        <label for="f_n_a" class="float-left">الاسم الأول عربي:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="m_n" class="float-left">الاسم الوسط انجليزي:</label>
                                    ...
                                    <div class="form-group group-ar">
                                        <label for="m_n_a" class="float-left">الاسم الوسط عربي:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="l_2" class="float-left">الاسم الأخير انجليزي:</label>
                                    ...
                                    <div class="form-group group-ar">
                                        <label for="l_2_a" class="float-left">الاسم الأخير عربي:</label>
                                    ...
                                    <div class="form-group">
                                        <label class="float-left">الجنيسة:</label>
