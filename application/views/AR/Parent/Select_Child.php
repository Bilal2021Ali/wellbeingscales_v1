    ...
    <div class="" style="padding: 20px;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0"> حدد الأبناء </h4>
                            <img width="130px" src="<?php echo base_url(); ?>assets/images/qlick-health-logo.png" alt="">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">ولي الأمر</a></li>
                                    <li class="breadcrumb-item active"> الأبناء </li>
                                </ol>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="card text-center child">
                                <div class="card-body">
                                    ...
                                    <h5 class="font-size-16 mb-1"><a href="#" class="text-dark"><?php echo $child['F_name_AR'] . ' ' . $child['L_name_AR'] ?></a></h5>
																					  
                                    <p class="text-muted mb-2">الصف: <?= $child['StudentClass'] ?></p>
        ...
        <script>
            ...
            function goToEdit(Id) {
                location.href = "<?php echo base_url(); ?>AR/Users/ChildAccount/" + Id;
            }

            function AddTemp(Id) {
                location.href = "<?php echo base_url(); ?>AR/Results/index/Student/" + Id;
            }
        </script>
    </div>
</body>