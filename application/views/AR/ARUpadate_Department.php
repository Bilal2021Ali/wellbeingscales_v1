                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title" id="title">Update Department Data</h4>
                                         <div class="alert alert-border alert-border-secondary alert-dismissible fade show" role="alert">
                                                <span id="Toast">Please Select Type</span> 
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom01" placeholder="Department Arabic Name" name="Arabic_Title" required="" value="<?php echo $data['Dept_Name_AR']; ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom02" placeholder="Department English Name" name="English_Title" required="" value="<?php echo $data['Dept_Name_EN']; ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="valid-feedback" 
                                                         value="<?php echo $data['Manager_AR']; ?>">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                </div>
...
<?php $citiesarray = $this->db->query('SELECT * FROM `r_cities` ORDER BY `Name_EN` ASC')->result_array();     ?>
     ...
     <input type="text" class="form-control" id="validationCustom02" value="<?php echo $data['Username']; ?>" placeholder="Write User Name" name="Username" required="">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
     ...
     Added_By = '".$sessiondata['admin_id']."' LIMIT 9 ")->result_array(); ?>
                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td>
                                   <?php echo $adminData['School_Name_EN'] ?>
                              </td>
     ...
     Added_By = '".$sessiondata['admin_id']."' LIMIT 9 ")->result_array(); ?>
                    ...
                    <tbody>
                         ...
                         <tr>
                              ...
                              <td>
                                   <?php echo $adminData['Dept_Name_EN'] ?>
                              </td>
