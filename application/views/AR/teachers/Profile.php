                    ...
                    <div class="row">
                        <div class="col-lg-12 user_bar">
                            ...
                            <div class="content mt-10 text-center" data-pattern="priority-columns" data-simplebar="init">
                                ...
                                <button type="button" class="btn btn-link waves-effect font-size-12 showEdite">تعديل</button>
                                ...
                                <div class="container">
                                    ...
                                    <form action="" class="needs-validation custom-validation" id="edite_my_data" novalidate>
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group group-ar">
                                                    <label for="l_2_a" class="float-left">الاسم الأخير بالعربي:</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label for="ph" class="float-left">الهاتف:</label>
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label for="lem" class="float-left">الايميل:</label>
