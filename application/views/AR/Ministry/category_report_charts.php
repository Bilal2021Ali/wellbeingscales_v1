        ...
        <div class="row">
          ...
          <?php /*?>  <div class="col-12">
            ...
            <div class="col-12">
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 066 إجمالي الاستطلاعات المستلمة حسب الجنس</h4>
                <div class="card">
                    <div class="card-body">
                        <h3 class="text-center ">إجمالي الاستطلاعات المستلمة حسب الجنس</h3>
            ...
            <div class="col-12">
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 067 الاستطلاعات المستلمة حسب نوع المستخدم</h4>
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">الاستطلاعات المستلمة حسب نوع المستخدم</h4>
