  ...
  <div class="page-content">
    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-12">
		 <br>
	      <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> MOE 020 - تقرير المواقع</h4>
...
function GetListOfSites($list_Tests){
	...
	$sitesForThisUser = $ci->db->select('l1_school.School_Name_AR,l2_site.*')
	->from('l1_school')
...
function get_site_of_test($sitesForThisUser){
	...
	$school_name = $site['School_Name_AR'];
    ...
    <td class="text-center"> <span class="badge font-size-12" style="width: 100%;background-color: #00ab00;color: #ffffff;">سلبي (-)</span></td>
    <?php }else{ ?> 
	...
	<td class="text-center">
		...
		<i class="uil uil-file-alt font-size-18" data-toggle="tooltip" data-placement="top" title="" data-original-title="التقرير PDF"></i>
		</a>
		<?php }else{ ?>
		<i class="uil uil-desktop-slash font-size-18" data-toggle="tooltip" data-placement="top" 
	    data-original-title="لا يوجد تقرير"></i>
		<?php } ?>
	</td>	
    </tr>
    <?php
