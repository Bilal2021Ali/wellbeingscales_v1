                ...
                <table class="table dt-responsive nowrap">
                  ...
                  <tbody>
                    ...
                    <tr id="serv_<?php  echo $survey['survey_id'];  ?>">
                      ...
                      <td><?php  echo $survey['set_name_ar']  ?>
                      </td>
                      <td><?php  echo $survey['choices_ar_title']  ?>
                      </td>
                      <td>0</td>
                      ...
                      <span  data-toggle="tooltip" data-placement="top" data-original-title="إعرض الأسئلة لهذا الإستبيان">
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myModalLabel">الأسئلة في هذا الإستبيان</h5>
    ...
    $.ajax({
     ...
     success: function (data) {
		 if(data === "ok"){
			...
			Command: toastr["success"]("تم تغيير تاريخ إتهاء الإستبيان إلى: " + new_date);
		 }else{
			 Swal.fire(
			 'error',
			 'نعتذر وقعت مشكلة غير متوقعة',
			 'error'
			 );
		 }
     },
...
var status = this.checked ? "مفعل" : "معطل";	
if(status == "معطل"){
    Swal.fire({
        title: "ماذا يعني هذا",
        ...
        confirmButtonText: "حسنًا ، يمكنك تغييره في أي وقت"
    ...
    $.ajax({
     ...
     success: function (data) {
		 if(data === "ok"){
			...
			Command: toastr["success"](" هذا الإستبيان الأن " + status);
		 }else{
			 Swal.fire(
			 'error',
       'نعتذر وقعت مشكلة غير متوقعة',
