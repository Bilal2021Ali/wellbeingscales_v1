...
<?php if (isset($fullpage)) { ?>
    <div class="main-content">
        ...
        <?php } ?>				  
<div class="col-12">
    <h4 class="card-body text-center" style="background: #33a2ff; padding: 10px;color: #fcf9f9;border-radius: 4px;">تقارير الجو العام</h4>
    <div class="card">
        <div class="card-body">
                        ...
                        <?php foreach ($climate_survyes as $survey) { ?>
                            <div class="climatesurvey item ml-3" data-category-id="<?= $survey["Cat_id"]; ?>">
                                <div class="card text-center">
                                    ...
                                    <a id="GaugeChart_action_<?= $survey['survey_id'] ?>" href="<?= base_url('AR/DashboardSystem/ClimateReports/' . $this->encrypt_url->safe_b64encode($survey['survey_id'])); ?>" class="w-100 btn btn-warning" style="border-radius: 0px;">اظهر التفاصيل <i class="uil uil-arrow-right"></i></a>
                                </div>
                            </div>
                        <?php } ?>
                    </div>
