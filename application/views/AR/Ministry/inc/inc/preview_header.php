...
<body data-sidebar="<?php echo $sidebar; ?>">
    <?php if (!isset($hasntnav)) {  ?>
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a class="dropdown-item" href="<?php echo base_url() . "AR/users/MyProfile" ?>"><i class="uil uil-user-circle font-size-18 align-middle text-muted mr-1"></i> <span class="align-middle"> user profile </span></a>
        ...
        <script>
            setInterval(function() {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Notifs/notification',
            ...
            $('#page-header-notifications-dropdown').click(function() {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Notifs/notificationList',
                    success: function(data) {
                        $('#notslist').html(data);
                    },
                });
            ...
            $(".set_readed").click(function() {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Notifs/SetReaded',
                });
                $('#notslist').html("empty !!");
            });
    ...
    <script>
        ...
        $("#feedBack_Form").on('submit', function(e) {
            ...
            if ($('#feedback_desc').val().length > 3) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Ajax/FeedBack',
                    data: {
                        img_txt: ScreenShoot,
    ...
    <script>
        $('.logout').click(function() {
            location.href = '<?php echo base_url() . "AR/users/logout"; ?>';
        });
    </script>