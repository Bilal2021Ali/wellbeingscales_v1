...
<?php
$categorys = $this->sv_ministry_reports->usedcategorys($sessiondata['admin_id']);
?>
<div class="col-lg-12 firstview">
    <div class="row slides_images">
        ...
        <div class="col-lg-6" id="slide_img_1">
            <div class="card">
                <div class="card-body text-center">
                    <h3 class="mb-5">مقالات</h3>
                    <?php foreach ($categorys as $category) { ?>
                        <div class="card">
                            <img class="card-img-top img-fluid w-100" src="<?= base_url("assets/images/Placeholder-Icon-File.png"); ?>" alt="Card image cap">
                            <div class="card-body">
                                <h4 class="card-title mt-0"><?= $category['Cat_ar'] ?></h4>
                                <hr>
