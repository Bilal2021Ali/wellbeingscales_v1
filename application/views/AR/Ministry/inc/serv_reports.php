...
<div class="row">
    <div class="col-lg-6">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 065 الاستبيانات المستلمة حسب الجنس</h4>
        <div class="card">
            <div class="card-body">
                <h3 class="text-center ">مجموع الاستبيانات المستلمة حسب الجنس</h3>
                <div id="genders_charts"></div>
            </div>
        </div>
    </div>
    <div class="col-lg-6">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 066 Average time response</h4>
        <div class="card p-4">
...
<div class="row p_surv">
    <div class="col-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 067 Your Published Surveys controle</h4>
        <div class="card">
            <div class="card-body">
                            ...
                            <div class="item ml-3">
                                <div class="card text-center">
                                    <div class="card-body">
                                        ...
                                        <span>رمز الاستبيان: إستبيان-<?php echo $survey['survey_id'] ?></span>
