...
<body class="light menu_light logo-white theme-white">
    ...
    <div class="main-content">
        <div class="page-content">
            ...
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CHL 038: التقارير</h4>
            <div class="row">
                <?php foreach ($links as $link) { ?>
                    <div class="col-md-4">
                        <div class="card card-body">
                            ...
                            <a href="<?= $link['link']; ?>" class="btn btn-warning waves-effect waves-light">القائمة</a>
                        </div>
                    </div>
                <?php } ?>
            </div>
