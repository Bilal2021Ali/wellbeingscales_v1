                    ...
                    <div class="col-lg-6 justify-content-center">
                        <div class="card" data-simplebar="init">
                            <div class="card-body __userData">
                                <h5 class="rounded p-3 mb-2 bg-danger text-white">صلاحيات المدارس <span
                                            class="float-right">الحالة</span>
                                </h5>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-nowrap table-centered">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success rounded text-white">تحميل ملفات
                                                        CSV</h5>
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">مجاميع المستخدمين</h5>
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">الإستبيانات</h5>
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">الجو العام</h5>
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">درجات الحرارة</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">الفحوصات المخبرية</h5>
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">الحجر الصحي والمنزلي</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">الرسم البياني </h5>
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">الحضور والغياب المدرسي</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">الفحوصات</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">فحوصات الموظفين</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">فحوصات المعلمين</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">فحوصات الطلاب</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">الحجر الصحي للجميع</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">الفحص الطبي للمواقع</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-success text-white">الحجر للمواقع</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                                            ...
                                            <tr class="hr">
                                                ...
                                                <td>
                                                    <h5 class="rounded p-3 mb-2 bg-primary text-white">أرشيف الحجر الصحي للمواقع</h5>
                                                </td>
                                                <td>
                                                    <label class="switch">
                    ...
                    <div class="col-lg-6 justify-content-center">
                        <div class="card ">
                            ...
                            <div class="card-body text-center __userData" style="display: grid;align-items: center;">
                                <h5 class="rounded p-3 mb-2 bg-danger text-white"><?= $user['School_Name_AR'] ?></h5>
...
<script>
    ...
    function changeThePermission(perm) {
        $.ajax({
            ...
            url: '<?= base_url(); ?>AR/DashboardSystem/permissions',
