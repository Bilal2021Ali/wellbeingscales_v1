          ...
          <div class="card-body"> 
              <div class="table-responsive mb-0" data-pattern="priority-columns">
                <table class="table dt-responsive nowrap">
                  <thead>
                    <th>#</th>
                    <th>معرف الإستبيان</th>
                    <th>عنوان الإستبيان</th>
                    <th> عنوان النموذج</th>
                    <th>مجموعة الخيارات</th>
                    <th>المنتهية</th>
                    <th>الأسئلة</th>
                    <th>الخيارات</th>
                    <th>إمكانيات</th>
                  ...
                  <tbody>
                    ...
                    <tr id="serv_<?php  echo $survey['survey_id'];  ?>">
                      ...
                      <td><?php  echo $survey['Title_ar']  ?></td>
                      <td><?php  echo $survey['set_name_ar']  ?></td>
                      <td><?php  echo $survey['choices_ar_title']  ?></td>
                      <td>0</td>
                      <td><?php  echo $survey['questions_count'];  ?></td>
                      <td><?php  echo $choices_count  ?></td>
                      <td class="text-center">
                      <span  data-toggle="tooltip" data-placement="top" data-original-title="إعرض أسئلة الإستبيان">
                      <i class="uil uil-notes questions"  data-toggle="modal" 
                      data-target="#myModal" group="<?php echo $survey['survey_id']; ?>"></i> 
                      </span>
                      <a href="<?php echo base_url() ?>AR/DashboardSystem/use_this_survey/<?php echo $survey['survey_id']; ?>"
                         class="use_ser"  data-toggle="tooltip" data-placement="top" data-original-title="إستعمل الإستبيان">
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myModalLabel"> أسئلة هذا الإستبيان  </h5>
