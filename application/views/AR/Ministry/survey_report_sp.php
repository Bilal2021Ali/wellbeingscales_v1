                    ...
                    <div class="card bg-primary">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    <p class="text-white font-size-18"><b>  تفاصيل الإستبيان   </b><i class="mdi mdi-arrow-left"></i></p>
                                    <div class="mt-4">
                                        <a href="<?php echo base_url("AR/DashboardSystem/survey_report_view/" . $serv_id); ?>" class="btn btn-success waves-effect waves-light">التفاصيل  <i class="mdi mdi-arrow-left"></i></a>
                                    </div>
                                </div>
                                <div class="col-sm-4">
