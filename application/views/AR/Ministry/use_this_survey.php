...
<?php print_r($serv_data);  ?>
    ...
    <script>
        ...
        $("#use_serv").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>AR/DashboardSystem/start_using_serv',
                ...
                success: function(data) {
                    ...
                    if (data == "ok_enabled") {
                        ...
                        setTimeout(() => {
                            location.href = "<?= base_url("AR/DashboardSystem/wellness"); ?>";
                        }, 800);
                    } else if (data == "ok_disabled") {
                        Swal.fire({
                            title: 'added successfully',
                            html: 'You can <b>active</b> it ' + '<a href="<?php echo base_url("AR/DashboardSystem/wellness"); ?>">here</a> ',
                            icon: 'success',
                            confirmButtonColor: '#5b8ce8',
