      ...
      <section class="content">
        ...
        <div class="main-content">
          <div class="page-content">
            ...
            <br>
            <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">MOE 013 - مجموع المدارس </h4>
            <div class="row">
              <div class="col-md-4 col-xl-4 InfosCards">
                <div class="card">
                  <div class="card-body" style="background-color: #144882;">
                    <div class="float-right mt-2"> <img src="<?php echo base_url(); ?>assets/images/icons/counterschools.png" alt="schools" width="50px"></i> </div>
                    <div>
                      <?php
                ...
                <div class="card">
                  <div class="card-body" style="background-color: #0164a8;">
                    ...
                    <div>
                      ...
                      <p class="mb-0"> مجموع المدارس المفعلة</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-4 col-xl-4 InfosCards">
                <div class="card">
                  <div class="card-body" style="background-color: #6f42c1;">
                    <div class="float-right mt-2"> <img src="<?php echo base_url(); ?>assets/images/icons/counterschools.png" alt="schools" width="50px"></i> </div>
                    <div>
                      <h4 class="mb-1 mt-1"> <span data-plugin="counterup"><?php echo $allDe ?></span> </h4>
                      <p class="mb-0"> مجموع المدارس المعطلة</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <!-- end row-->
            <br>
            <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">MOE 014 - إدارة وتفعيل المدارس </h4>
            <div class="container-fluid" style="overflow: auto;">
              <div class="card">
                <div class="card-body">
                  <table id="visi_table" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                    <thead>
                      <tr>
                        <th>#</th>
                        <th>اسم المدرسة بالعربي</th>
                        <th>اسم المدرسة بالإنجليزي</th>
                        <th>اسم المستخدم</th>
                        <th>نوع المدرسة</th>
                      ...
                      ?>
                        <tr>
                          ...
                          <td><?php
                              ...
                              ?></td>
                          <td><?php
                              $country = $this->db->query(" SELECT `name` FROM `r_countries` 
			   WHERE  id = '" . $admin['Country'] . "' LIMIT 1 ")->result_array();
                              echo $country[0]['name'];
                              echo ", ";
               ...
               WHERE id = '" . $admin['Citys'] . "' ORDER BY `Name_EN` ASC LIMIT 1")->result_array();
                              ...
                              ?></td>
                          <td><a href="<?php echo base_url() ?>AR/DashboardSystem/UpdateSchoolData/<?php echo $admin['Id']; ?>"> <i class="uil-pen" style="font-size: 25px;" title="Edit"></i></a></td>
                          <?php
                          if ($admin['status'] == 1) {
                            $cheked = 'checked';
                          } else {
                          ...
                          ?>
                          <td class="text-center"><a href="<?= base_url("EN/DashboardSystem/permissions/school/" . $admin['Id']) ?>"> <i class="uil uil-keyhole-circle" style="font-size: 25px;" data-toggle="tooltip" data-placement="top" title="" data-original-title="الصلاحيات"></i> </a></td>
