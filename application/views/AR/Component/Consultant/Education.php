<div class="main-content">
    <div class="page-content">
        ...
        <div class="col-lg-12 firstview">
            <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 061 الرسوم البيانية والمقالات</h4>
                        ...
                        <div class="card-body text-center">
                            ...
                            <?php if (!empty($articles)) { ?>
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title mt-0">مقالات</hh4>
                                            <hr>
                                            <a href="#" class="btn btn-primary waves-effect waves-light takemeto_articles" data-view-id="<?= $articles[0]['Id']; ?>">المزيد ++</a>
                                    </div>
                                </div>
                            <?php } else { ?>
                                <div class="container text-center p-5 empty " style="max-width : 200px;width : 100%;text-aligne:center">
                                    ...
                                    <h5 class="mt-2">لا توجد مقالات هنا حتى الآن.</h5>
                                </div> <?php } ?>
                        </div>
                    </div>
                </div>
