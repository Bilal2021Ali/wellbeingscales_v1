...
//                                    $type = explode("/", $mime_type)[1] ?? ""; ?>
            ...
            <!--                                    <p class="text-center">لم يتم العثور على الملف</p>-->
            <!--                                --><?php //} ?>
            <!--                            </div>-->
            <!--                            <div class="card-body">-->
            <!--                                <hr>-->
            <!--                                <h5 class="card-title text-center">--><?php //= strlen($file['file_name_ar']) > 30 ? substr($file['file_name_ar'], 0, 30) . "....." : $file['file_name_ar']; ?><!-- <a title="افتح المعاينة الكاملة في نافذة جديدة" href="--><?php //= base_url('uploads/Reports_resources/' . $file['file_language'] . "/" . $file["file_url"]) ?><!--" target="_blank" title="--><?php //= strlen($file['file_name_ar']) > 30 ? $file['file_name_ar'] : ""; ?><!--"><i class="uil uil-arrow-up-right"></i></a></h5>-->
            <!--                            </div>-->
            <!--                        </div>-->
            <!--                    </div>-->
            <!--                --><?php //} ?>
