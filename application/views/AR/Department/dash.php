...
WHERE Id = '" . $parentId . "' ORDER BY `Id` DESC LIMIT 1")->result_array();
                ...
                <div class="row">
                            ...
                            <div class="card_body ">
                                <div style="padding: 20px;padding-bottom: 0px;">
                                    <div class="float-right">
                                        <div class="dropdown">
                                            <a class=" dropdown-toggle" href="#" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                <span class="text-muted" data-toggle="modal" data-target="#myModal"><b>حدد نوع الفحص</b>
                                    ...
                                    <h4 class="card-title">
                                        ...
                                        مجموع الفحوصات المخبرية اليومي <?php echo $today; ?>
                                    </h4>
                                </div>
                                <div class="row" style="padding: 20px;" id="TempCounters">
                                    <div class="col-xl-12">
                                        <div class="card-body" style="border-radius: 5px;border: 3px solid #0eacd8;padding: 9px;">
                                            <h4 class="card-title">
                                                <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/Temp_Counter.png" style="width: 25px;margin: auto 5px;"> درجات الحرارة
                                            </h4>
                                        </div>
                                    </div>
					...
					ORDER BY Id DESC LIMIT 1 ")->result_array();
                                                            ...
                                                            <p class="mb-0 badge badge-success font-size-12">طبيعي</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card-body badge-soft-warning" style="height: 130px;display: grid;align-items: center;border-radius: 5px;border: 6px solid #f1b44c;">
                                                    <div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-xl-8">
                                                                <p class="mb-0 badge badge-warning font-size-12">منخفض</p>
                                                                ...
                                                                <span class="badge font-size-12" style="width: 104px;background-color: #00ab00;color: #fff;margin: 5px auto;display: block;">لا إجراءات <?php echo $LOW_In_School; ?></span>
                                                            </div>
                                                            <div class="col-xl-2" style="text-align: center;align-items: center;display: grid;">
                                                                <h4 class="mb-1 mt-1">
                                                ...
                                                <div class="card-body badge-soft-danger" style="border-radius: 4px;border: 6px solid #f57d6a;height: 130px;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-8">
                                                            ...
                                                            ?>
                                                            <p class="mb-0 badge badge-danger font-size-12">مرتفع</p>
                                                            ...
                                                            <span class="badge font-size-12" style="width: 104px;background-color: #ff2e00;color: #fff;margin: 5px auto;display: block;">الحجرالصحي <?php echo $HIGH_In_Quern; ?></span>
                                                            <span class="badge font-size-12" style="width: 104px;background-color: #00ab00;color: #fff;margin: 5px auto;display: block;">لا إجراءات <?php echo $HIGH_In_School; ?></span>
                                                        </div>
                                                        <div class="col-xl-2" style="text-align: center;align-items: center;display: grid;">
                                                            <h4 class="mb-1 mt-1">
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-title mb-4">
                                            <div class="float-right">
                                                <div class="dropdown">
                                                    <a class=" dropdown-toggle" href="#" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        <span class="text-muted" data-toggle="modal" data-target="#myModal"><b>حدد نوع الفحصt</b><i class="mdi mdi-chevron-down ml-1"></i></span>
                                                    </a>
                                                    <style>
                                                        .dropdown-menu * {
                                                            cursor: pointer;
                                        ...
                                        <h4 class="card-title mb-4">
                                            <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/Temp_Counter.png" style="width: 25px;margin: auto 5px;"> قائمة الفحوصات المخبرية <?php echo $today; ?> <font color=#e13e2b>(الموظفين) </font>
                                        </h4>
                                        ...
                                        <div data-simplebar style="height: 400px;overflow: auto;">
                                            <div id="simpl_staff_list">
                                                ...
                                                foreach ($Ourstaffs as $staff) {
                                                    ...
                                                    $getResults = $this->db->query("SELECT * FROM l2_result WHERE `UserId` = '" . $staff['Id'] . "' AND Result_Date = '" . $today . "' AND UserType = 'Staff' ORDER BY `Id` DESC LIMIT 1")->result_array();
...
*/ ?>
                                                                <td>
                                                                    ...
                                                                    <a href="javascript:void(0);" class="text-danger" data-toggle="tooltip" onClick="setmemberInAction(<?php echo $staffsRes['Id'] ?>,'Staff','Quarantine',);" data-placement="top" title="الحجر الصحي" theid="23">
                                            ...
                                            <div class="card-body">
                                                <h4 class="card-title mb-4">
                                                    <div class="float-right">
                                                        <div class="dropdown">
                                                            <a class=" dropdown-toggle" href="#" id="dropdownMenuButton2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                <span class="text-muted" data-toggle="modal" data-target="#myModal"><b>حدد نوع الفحص</b><i class="mdi mdi-chevron-down ml-1"></i></span>
                                                            </a>
                                                ...
                                                <h4 class="card-title mb-4">
                                                    ...
                                                    الحجر المنزلي(<span id="STAYHOMESHOWTESTNAME">درجات الحرارة</span>) <?php echo $today; ?> <font color=#e13e2b>(الموظفين, المعلمين)</font>
                                                </h4>
                                                ...
                                                <div data-simplebar style="height: 350px;overflow: auto;">
                                                    <div id="simpl_home_list">
                                                        ...
                                                        foreach ($OurStudens as $Teacher) {
                                                            ...
                                                            $getResults_Teacheer = $this->db->query("SELECT * FROM l2_result WHERE `UserId` = '" . $Teacher['Id'] . "' AND UserType = 'Student'  AND `Action` = 'Home' ORDER BY `Id` DESC LIMIT 1")->result_array();
                                                            foreach ($getResults_Teacheer as $T_results) {
                                                                $lastReads = $this->db->query("SELECT * FROM l2_result WHERE `UserId` = '" . $Teacher['Id'] . "' AND UserType = 'Student'  ORDER BY `Id` DESC LIMIT 1")->result_array();
                                    ...
                                    <div class="col-xl-6">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <h4 class="card-title mb-4"><img src="<?php echo base_url(); ?>assets/images/icons/png_icons/Temp_Counter.png" style="width: 25px;margin: auto 5px;"> الحجر الصحي (<span id="STAYQuarantineNOSHOWTESTNAME">درجات الحرارة</span>) <?php echo $today; ?> <font color=#e13e2b> (الموظفين, المعلمين)</font>
                                                </h4>
                                                ...
                                                <div data-simplebar style="height: 350px;overflow: auto;">
                                                    <div id="simpl_quarantin_list">
                                                        ...
                                                        $listTeachers = array();
                                                        $today = date("Y-m-d");
                                                        $OurTeachers = $this->db->query("SELECT * FROM l2_student WHERE `Added_By` = '" . $sessiondata['admin_id'] . "' ")->result_array();
                                                        foreach ($OurTeachers as $Teacher) {
                                                            $Teachername = $Teacher['F_name_AR'] . ' ' . $Teacher['L_name_AR'];
                                                            $ID = $Teacher['Id'];
                                                            $Position = $Teacher['Position'];

                                                            $getResults_Teacheer = $this->db->query("SELECT * FROM l2_result WHERE `UserId` = '" . $Teacher['Id'] . "' AND UserType = 'Student' AND `Action` = 'Quarantine' ORDER BY `Id` DESC LIMIT 1")->result_array();
                                                            foreach ($getResults_Teacheer as $T_results) {
                                                                $lastReads = $this->db->query("SELECT * FROM l2_result WHERE `UserId` = '" . $Teacher['Id'] . "' AND UserType = 'Student' ORDER BY `Id` DESC LIMIT 1")->result_array();
                                                                $lastRead = $lastReads[0]['Result'];
                                                                ...
                                                                $listTeachers[] = array(
                                                                    ...
                                                                    "Class_OfSt_q" => $this->schoolHelper->teacherClasses($ID, true)
                                                                );
                                                            }
                                                        }
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <h4 class="card-title mb-4"> <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/pin.png" style="width: 25px;margin: auto 5px;">قائمة الفحوصات المخبرية <?php echo $today; ?> <font color=#e13e2b> (Sites)</font>
                                        </h4>
...
<script>
    ...
    function GetTeacherChart() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/schools/ChartofTempForTeacher',
            beforeSend: function() {
                $('#drawChart').html('');
                $('#drawChart').html('<div class="spinner-border text-dark m-1" role="status"> <span class="sr-only">Loading...</span></div>');
            },
    ...
    $("#SelectFromClass").change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/Schools/ChartTempOfClass',
            data: {
    ...
    function GetTheTeacherResults() {
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/schools/ListResultsOfTeachers',
            beforeSend: function() {
                $('#ResultsTable').html('');
                $('#ResultsTable').html('<div class="spinner-border text-dark m-1" role="status"> <span class="sr-only">Loading...</span></div>');
            },
    ...
    function setmemberInAction(id, usertype, action) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Schools/ApplyActionOnMember',
                    data: {
                        S_Id: theId,
                        Action: action,
                        UserType: usertype,
    ...
    function SET_SiteInAction(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Ajax/Set_ActiononSite',
                    data: {
                        S_Id: theId,
                    },
                    success: function(data) {
    ...
    function Remove_SiteFromAction(id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Ajax/Remove_ActiononSite',
                    data: {
                        S_Id: theId,
                    },
                    success: function(data) {
    ...
    function RemoveThisMemberFrom_lab(id, usertype, action) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Schools/ApplyLabActionOnMember_lab',
                    data: {
                        S_Id: theId,
                        Action: action,
                        UserType: usertype,
    ...
    function Get_plus_minus(type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/Results/GetResultsCounterFor',
            data: {
                TeatsType: type,
            },
            success: function(data) {
    ...
    function staff_labTests(type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/ajax/Get_Staffs_List',
            data: {
                TestDesc: type,
            },
            success: function(data) {
    ...
    function quarntine_labTests(type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/ajax/Get_Quaranrine_List',
            data: {
                TestDesc: type,
            },
            success: function(data) {
    ...
    function home_labTests(type) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/ajax/Get_home_List',
            data: {
                TestDesc: type,
            },
            success: function(data) {
...
function StayHomeOf($type)
{
    ...
    foreach ($ours as $Teacher) {
        $Teachername = $Teacher['F_name_AR'] . ' ' . $Teacher['L_name_EN'];
        $ID = $Teacher['Id'];
        $Position = $Teacher['Position'];
...
function get_site_of_test($sitesForThisUser, $testType)
{
    ...
    foreach ($listSites as $siteResult) { ?>
        <tr>
            ...
            <td>
                <?php if ($siteResult['Action'] == "School") { ?>
                    <img src="<?php echo base_url(); ?>assets/images/icons/Home.png" alt="Set in Cleaning" width="20px" onClick="SET_SiteInAction(<?php echo $siteResult['Id']; ?>);" style="cursor:pointer;" data-toggle="tooltip" data-placement="top" data-original-title="أغلق لإزالة التلوث">
                <?php } ?>
            </td>
        </tr>
    <?php
...
function GetListOfSites_InCleaning($list_Tests)
{
    ...
    $sessiondata = $ci->session->userdata('admin_details');
    $sitesForThisUser = $ci->db->query(" SELECT * FROM `l2_site` WHERE 
    `Added_By` = '" . $sessiondata['admin_id'] . "' ORDER BY `Site_Code_ar` ASC ")->result_array();
    foreach ($list_Tests as $test) {
