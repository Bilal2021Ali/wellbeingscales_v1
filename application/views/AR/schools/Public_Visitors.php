...
<div class="main-content">
  <div class="page-content">
	...
	<br><h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH-MO010: الزوار</h4>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?= base_url(); ?>AR/schools/add_visitor/<?= $visitor['user_id'] ?>" 
