            ...
            <div class="col-lg-8 offset-lg-1">
                <div class="card">
                    <form class="card-body" method="post" action="<?= current_url(); ?>">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">للمعلمين:</label>
                                <select class="form-control select2" name="teacher">
                                    <option>حدد المعلمين</option>
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                <label class="form-label">حدد الطلاب:</label>
                                <select class="form-control select2" name="class">
                                    <option>المراحل الدراسية:</option>
...
<script>
    ...
    $('select[name="class"]').change(function() {
        ...
        $('select[name="students[]"]').select2({
            ...
            ajax: {
                url: '<?= base_url("AR/schools/av_students_in_class"); ?>',
                dataType: 'json',
                type: 'POST',
                data: {
                    classId: classid,
