...
<div class="main-content">
	...
	<div class="row">
	 ...
	 <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CHL 038: قوائم الموظفين، المعلمين، الطلاب، المواقع، الأجهزة المخبرية، موازين الحرارة، البوابات، الصور</h4>
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card card-body">
                    ...
                    <a href="<?= $link['link']; ?>" class="btn btn-primary waves-effect waves-light">عرض التقرير</a>
                </div>
            </div>
            <?php } ?>
        </div>
