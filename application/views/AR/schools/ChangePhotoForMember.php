  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-8 col-lg-6 col-xl-5">
		  	<h4 class="card-title" style="background: #abd034;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 045 تحميل الصورة الرمزية للموظفين والمعلمين والطلاب</h4>
...
<?php /*$("#DropZon").dropzone(
     { 
          url: " echo base_url();AR/users/UpladeImgs" ,
