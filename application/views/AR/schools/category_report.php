...
<div class="right-bar">
  <div data-simplebar class="h-100">
    <div class="rightbar-title d-flex align-items-center px-3 py-4"><a href="javascript:void(0);" class="right-bar-toggle ms-auto mr-5"><i class="mdi mdi-close noti-icon"></i></a>
      <h5 class="m-0 me-2">الاستبيانات</h5>
    </div>
...
<div class="main-content">
  <div class="page-content">
    ...
    <br>
    <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">تقرير الفئة المتلقاة (CH P009)</h4>
			<div class="row">
		  <?php foreach ($categorys as $key => $category) : ?>
		  <div class="col-md-6 col-xl-3">
			<div class="card">
			  <div class="card-body">
				<a href="<?= base_url('AR/schools/categorys-reports/' . $category['Id']) ?>" class="btn btn-info waves-effect waves-light w-100 text-center"><i class="uil uil-file-alt mr-2 font-size-20"></i>تقرير <?= $category['Cat_ar']; ?> </a>
			  </div>
			</div>
		  </div>
		  <?php endforeach; ?>
    ...
    <br>
    <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">تقرير مسح الإجابات (CH 036)</h4>
    <?php
    $this->load->view( "AR/schools/inc/question_categories", [
        "link" => "questions_reports",
        "isqreport" => false,
    ] );
    ?>
    <br>
    <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> تقرير استبيان الأسئلة(CH 037)</h4>
    <?php
    $this->load->view( "AR/schools/inc/question_categories", [
