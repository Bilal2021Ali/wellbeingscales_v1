            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box">
                        <a href="<?= $CurPageURL  ?>" class="logo logo-dark">
                            <span class="logo-sm">
                                <img src="<?= base_url(); ?>assets/images/fav_icon.png" style="margin-top: 23px;" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                                <img src="<?= base_url(); ?>assets/images/fav_icon.png" style="margin-top: 23px;" alt="" style="margin-left: -19px;" height="70">
                            </span>
                        </a>

                        <a href="<?= $CurPageURL  ?>" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="<?= base_url(); ?>assets/images/fav_icon.png" style="margin-top: 23px;" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                ...
                <div class="d-flex">
                    ...
                    <div class="dropdown d-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <!-- item-->
                            <a class="dropdown-item" href="<?= base_url() . "AR/users/MyProfile" ?>"><i class="uil uil-user-circle font-size-18 align-middle text-muted mr-1"></i> <span class="align-middle"> user profile </span></a>
        ...
        <div class="vertical-menu mm-active">
            ...
            <div class="navbar-brand-box">
                <a href="<?php    ?>" class="logo logo-dark">
                    <span class="logo-sm">
                        <img src="<?= base_url(); ?>assets/images/fav_icon.png" alt="" height="42" style="margin-left: -10px;">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= base_url(); ?>assets/images/qlick-health-logo.png" alt="" style="margin-left: -19px;" height="70">
                    </span>
                </a>

                <a href="/" class="logo logo-light">
                    <span class="logo-sm">
                        <img src="<?= base_url(); ?>assets/images/fav_icon.png" alt="" height="22">
                    </span>
                    <span class="logo-lg">
                        <img src="<?= base_url(); ?>assets/images/qlick-health-logo.png" alt="" style="margin-left: -19px;" height="70">
                    </span>
                                ...
                                <div class="simplebar-content" style="padding: 0px;">
                                    ...
                                    <div id="sidebar-menu" class="mm-active">
                                        ...
                                        <ul class="metismenu list-unstyled mm-show" id="side-menu" style="margin-top: 20px;">
                                            ...
                                            <li>
                                                <a>
                                                    <i class=""><img src="<?= base_url(); ?>assets/images/icons/png_icons/dashboard.png" width="19px"></i>
                                                    <span>Dashboard</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a >
                                                    <i class=""><img src="<?= base_url(); ?>assets/images/icons/png_icons/student_card.png" width="19px"></i>
                                                    <span>My Profile</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a>
                                                    <i class=""><img src="<?= base_url(); ?>assets/images/icons/png_icons/waiting.png" width="19px"></i>
                                                    <span>Home</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a>
                                                    <i class=""><img src="<?= base_url(); ?>assets/images/icons/png_icons/team.png" width="19px"></i>
                                                    <span>About us</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a>
                                                    <i class=""><img src="<?= base_url(); ?>assets/images/icons/png_icons/device.png" width="19px"></i>
                                                    <span>Videos</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a>
                                                    <i class=""><img src="<?= base_url(); ?>assets/images/icons/png_icons/menu.png" width="19px"></i>
                                                    <span>Surveys</span>
                                                </a>
                                            </li>
                                            <li>
