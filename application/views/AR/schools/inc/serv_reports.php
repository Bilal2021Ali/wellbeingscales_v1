...
<div class="row">
    <div class="col-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 061 المعلمين </h4>
        <div class="card ontypecard">
            <div class="card-body">
                <h2 class="text-center">المعلمين</h2>
                <hr>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
                            <div class="card-body text-center" style="background: var(--orange);">
                                ...
                                <h4>مجموع الاستبيانات المستلمة </h4>
...
<div class="row">
    <div class="col-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 062 الموظفين </h4>
        <div class="card ontypecard">
            <div class="card-body">
...
<div class="row">
    <div class="col-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 063 أولياء الأمور </h4>
        <div class="card ontypecard">
            <div class="card-body">
                <h2 class="text-center">أولياء الأمور</h2>
                <hr>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="card">
...
<div class="row">
    <div class="col-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 064 الطلاب</h4>
        <div class="card ontypecard">
            <div class="card-body">
...
<div class="row">
    <div class="col-lg-6">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 065 الرسم البياني حسب الجنس</h4>
        <div class="card">
            <div class="card-body">
    ...
    <div class="col-lg-6">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 066 متوسط زمن الإستجابة</h4>
        <div class="card p-4">
...
<div class="row">
    <div class="col-lg-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 065 الرسم البياني حسب الجنس</h4>
        <div class="card">
            <div class="card-body">
                <h3 class="text-center ">حسب العمر</h3>
...
<div class="row p_surv">
    <div class="col-12">
        <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 067 إدارة الإستبيانات</h4>
        <div class="card">
            <div class="card-body">
                <h3 class="card-title">الإستبيانات المنشورة</h3>
                                ...
                                <div class="card text-center">
                                    <div class="card-body">
                                        <div class="dropdown float-right">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="#"><i class="uil uil-pen mr-1"></i>تحرير</a>
                                                <a class="dropdown-item" href="survey_reports/<?php echo $survey['survey_id'] ?>"><i class="uil uil-notes mr-1"></i>التقارير</a>
                                    ...
                                    <div class="btn-group" role="group">
                                        <?php if ($survey['answers_counter'] !== '0') { ?>
                                            <a href="survey_reports/<?php echo $survey['survey_id'] ?>" class="btn btn-outline-light text-truncate"><i class="uil uil-notes mr-1"></i> التقارير</a>
                                        <?php } ?>
                                        <a href="survey_preview/<?php echo $survey['survey_id'] ?>" target="_blank" class="btn btn-outline-light text-truncate"><i class="uil uil-eye mr-1"></i> المعاينة </a>
                                    </div>
                                </div>
                            </div>
                        <?php } ?>
