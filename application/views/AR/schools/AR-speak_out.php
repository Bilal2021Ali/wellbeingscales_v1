            ...
            <div class="col-12">
              ...
              <table class="table table-hover table-responsive">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?= $sn + 1  ?></td>
                    <td class="text-center"><img src="<?= base_url("uploads/avatars/") . ($report['useravatar'] ?? "default_avatar.jpg") ?>" class="img-thumbnail rounded-circle avatar-sm" alt=""></td>
                    ...
                    <td class=""><span class="badge rounded-pill bg-<?= status($report['status'])['class'] ?> status-box-<?= $report['id'] ?>">
                      <?= status($report['status'])['text'] ?>
                      </span></td>
                    <td class=""><span class="badge rounded-pill bg-<?= priority($report['priority'])['class'] ?>">
