...
<div class="main-content">
    <div class="page-content">
        <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Create new article with images</h4>
        <div class="container">
            ...
            <form class="row" id="newarticles">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary btn-lg btn-block waves-effect waves-light mb-1">Update Article</button>
                </div>
            </form>
        </div>
    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "ok") {
                            ...
                            setTimeout(function() {
                                location.href = '<?= base_url("AR/schools/L3_config"); ?>'
                            } , 1000);
                        } else {
                            $('.alert-danger').show();
