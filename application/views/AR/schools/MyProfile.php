...
<body class="authentication-bg">
     ...
     <a href="<?php echo base_url(); ?>AR/Schools" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
        </div>
                                  ...
                                  <a href="<?php echo base_url(); ?>AR/users/changePhoto">
                                   ...
                                   <h5 class="font-size-15 mt-3" style="position: relative;top: -42px;margin: 0px;">
                                      ...
                                      <?php  $Useradta = $this->db->query("SELECT * FROM l1_school WHERE Id = '".$sessiondata["admin_id"]."' ")->result_array();  
                                        ...
                                        <input type="text" class="form-control" name="School_Name_AR" 
                                        value="<?php echo $admin['School_Name_AR'] ?>">   
                                        </div> 
                                             
                                        <div class="form-group">
                                        <label>School Name EN :</label>      
                                        <input type="text" class="form-control" name="School_Name_EN" 
                                        value="<?php echo $admin['School_Name_EN'] ?>">   
                                        </div> 
                                        ...
                                        <div class="form-group">
                                        <a class="" href="<?php echo base_url(); ?>AR/users/ResetMyPassword">Set New Password ?</a> 
                                        </div> 
                                        <button class="btn btn-primary w-sm waves-effect waves-light btn-block" 
										type="Submit" name="Submit" id="sub">Change it.</button>                                      
                                        </form> 
                                         <?php } ?>
                                    </div>
                                </div>
...
$( "#ResetUsername" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>AR/users/SchoolUserupdate',
