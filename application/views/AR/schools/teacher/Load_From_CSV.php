...
<h6 class="m-0">
<strong>For Teacher</strong> <i class="mdi mdi-chevron-up float-right accor-down-icon"></i></h6></div></a>
<div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordion" style="">
<div class="card-body">
<h6 style="background-color:yellow"> <b>Teachers Steps</b></h6> 
<p>1- Download the <a href="<?php echo base_url(); ?>uploads/Csv/teacher_template.xlsx" onClick="DownloadStart();">Teacher Excell Template</a> <br>
					...
					<div class="col-xl-6">
													<div class="card">
														<div class="card-body">
															...
															<h4 class="card-title uploadtype"> Upload <strong>Teachers</strong> CSV File </h4>
															<!-- Tab panes -->
																	<div class="wrapper TeacherUpload">
																		<div class="file_upload_list">
																			<i class="display-4 text-muted uil uil-cloud-upload"></i>
																			<h3 class="StatusBoxTeacher">
																				 Please Select Teachers CSV File  </h3>
...
$( "#Teacher" ).on( 'submit', function ( e ) {
   ...
   $.ajax( {
		type: 'POST',
		url: '<?php echo base_url(); ?>AR/Ajax/uploadTeacherCsv',
