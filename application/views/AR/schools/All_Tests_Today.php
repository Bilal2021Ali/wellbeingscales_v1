...
<br><h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> REP 001: عرض التقرير اليومي | درجة الحرارة (الموظفين، المعلمين، الطلاب)</h4>																																																															 
...
<tr>
                                            ...
                                            <th class="text-center"> المخاطر </th>
