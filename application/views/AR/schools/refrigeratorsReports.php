                    ...
                    <form class="row mb-3" method="POST">
                        <div class="col-lg-6">
                            ...
                            <select name="machine" class="form-control">
                                <option value="" <?= $selected == "" ? "selected" : "" ?>>جميع الثلاجات</option>
                        ...
                        <div class="col-lg-6">
                            <label class="form-label"> إسم الرحلة <span class="text-danger">*</span>:</label>
                            <select name="trip_name" class="form-control">
                                <option value="" <?= $tripName == "" ? "selected" : "" ?>>جميع الرحلات</option>
...
<script>
    $('select[name="machine"]').change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/schools/tripNames_forthisMachine',
            data: {
                machine_id : id,
            },
