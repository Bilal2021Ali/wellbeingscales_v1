...
<body>
            ...
            <form token="<?= md5(time()); ?>" method="post">
                <div class="row">
                    <div class="container-fluid">
                        <div class="col-12 ">
                            <h4 class="card-title" style="background: #fca301;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 077 التقرير</h4>
                            <div class="card">
                                <div class="card-body">
                                                            ...
                                                            <div class="card col">
                                                                <div class="card-body quastions-title">
                                                                    <h3 class="card-title"><?= $questions_counter ?> . <?= $question['ar_title'] ?>
                                                                        <span class="open_more_q float-right" link="<?= base_url('AR' . (isset($fromMinistry) ? "/DashboardSystem/school_question_detailed_report/" : "/schools/question_detailed_report/") . $serv_id . "/" . $question['q_id'] . "/" . $group_choices . '/' . md5(time())) ?>" target="_blank" rel="noopener noreferrer"><i class="uil uil-analytics"></i></span>
                                                                    </h3>
                                                                </div>
                                                            </div>
                                                            <div class="row px-2">
                                                                <?php foreach ($choices as $key => $choice) { ?>
                                                                    ...
                                                                    <div class="card col">
                                                                        <div class="card-body">
                                                                            <div class="mr-2">
                                                                                <label><?= $choice['title_ar'] ?>(<?= calc_perc($use_count, $all_count); ?>)</label>
                                                                                <span class="open_moreD" link="<?= base_url('AR' . (isset($fromMinistry) ? "/DashboardSystem/schools_question_choice_report/" : "/schools/question_choice_report/") . $serv_id . "/" . $choice['Id'] . "/" . $question['q_id'] . "/"  . calc_perc($use_count, $all_count) . '/' . md5(time())) ?>" target="_blank" rel="noopener noreferrer">
    ...
    <div class="downBar">
        <div class="header">
            ...
            <p style="margin: auto;width : 90%;margin-top: -25px;" class="text-center">التفاصيل</p>
        </div>
...
<script>
    $("#my_answers").on('submit', function(e) {
        e.preventDefault();
        alert('عذرا لا يمكنك استكمال هذا الاستطلاع');
    });
