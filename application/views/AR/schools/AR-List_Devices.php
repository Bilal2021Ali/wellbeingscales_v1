        ...
        <div class="main-content">
            <div class="page-content">
                <div class="container-fluid">
                     <h4 class="card-body" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px">CH 039 قائمة الأجهزة - موازين الحرارة والمختبرات والبوابات</h4>
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="float-right mt-2">
                                        ...
                                        <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/adddevicescounter.png" alt="schools" width="64px">
                                    </div>
                                    <div>
                                        <?php
                                    ...
                                    <?php if (!empty($lasts)) { ?>
                                        <p class="mt-3 mb-0"><span class="mr-1" style="color: #060606;">
                                    ...
                                    <?php } ?>
                                <?php } else { ?>
                                    <p class="mt-3 mb-0"><span class="mr-1" style="color: #131313;">
                                            <?php echo "--/--/--" ?></span><br>
                                        آخر جهاز تم إضافته
                                    </p>
                                <?php } ?>
                        ...
                        <div class="col-md-3 col-xl-3 InfosCards">
                            <div class="card">
                                <div class="card-body">
                                    <div class="float-right mt-2">
                                        <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/Temp_Devices_Icons.png" alt="schools" width="50px">
                                    </div>
                                    <div>
                                        <?php
                                        $allDevices = 0;
                                        ...
                                        <p class="mb-0"> مجموع الأجهزة الحرارية </p>
                                    </div>
                    ...
                    <!-- start page title -->
                    <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 040 قائمة الأجهزة</h4>
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">الأجهزة</a></li>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
                                            <tr>
                                                <th> # </th>
                                                <th> رقم الجهاز MAC Address </th>
                                                <th> نوع الجهاز </th>
                                                <th> الوصف </th>
                                                <th> تاريخ الإضافة </th>
                                                <th class="actions" style="text-align: center;">الإجراء</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($listofadevices as $sn => $data) { ?>
                                                <tr id="<?php echo $data['Id']; ?>">
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <?php } ?>
                                                        <?php /* <i class="bx bxs-comment-detail seebatches" onClick="getBtches(<?php echo $data['Id'];  ?>);" data-toggle="modal" data-target="#exampleModalScrollable" ></i> */ ?>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
    ...
    <script>
        $('.delet').each(function() {
            $(this).click(function() {
                ...
                console.log(theId);
                Swal.fire({
                    title: 'هل أنت متأكد من حذف الجهاز؟',
                    showDenyButton: true,
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            type: 'POST',
                            url: '<?php echo base_url(); ?>AR/Schools/DeletDevice',
                            data: {
                                Conid: theId,
                            },
    ...
    <script>
        $('input[type="checkbox"]').each(function() {
            $(this).change(function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url(); ?>AR/Dashboard/changestatus',
                    data: {
                        adminid: theAdminId,
                    },
                    success: function(data) {
        ...
        function getBtches(id) {
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>AR/Schools/ListofBatches',
                data: {
                    Deviceid: id,
                },
                beforeSend: function() {
