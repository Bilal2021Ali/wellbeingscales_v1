...
<h6 class="m-0">
<strong>For Staff</strong><i class="mdi mdi-chevron-up float-right accor-down-icon"></i></h6></div></a>
<div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion" style="">
<div class="card-body">
<h6 style="background-color:yellow"> <b>Staff Steps</b></h6> 
1- Download the <a href="<?php echo base_url(); ?>uploads/Csv/staff_template.xlsx" onClick="DownloadStart();">Staff Excell Template</a> <br>
					...
					<div class="col-xl-6">
													<div class="card">
														<div class="card-body">
															...
															<h4 class="card-title uploadtype"> Upload <strong>Staff</strong> CSV File </h4>
															<!-- Nav tabs -->
																	<div class="wrapper staffUpload">
																		<div class="file_upload_list">
																			<i class="display-4 text-muted uil uil-cloud-upload"></i>
																			<h3 class="StatusBoxStaff"> Please Select Staff CSV File </h3>
...
$( "#Staff" ).on( 'submit', function ( e ) {
   ...
   $.ajax({
		type: 'POST',
		url: '<?php echo base_url(); ?>AR/Ajax/uploadStaffCsv',
