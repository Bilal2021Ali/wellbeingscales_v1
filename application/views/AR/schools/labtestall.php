    ...
    <div class="page-content">
        ...
        <?php if (isset($permissions['users_daily_labtests']) && $permissions['users_daily_labtests'] == '1') { ?>
            <h4 class="card-title"
                ...
                CH007 : مجاميع الفحوصات اليومية </h4>
        ...
        <?php foreach ($tests as $test) { ?>
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card-body mb-2"
                                 style="border-radius: 5px;border: 3px solid #0eacd8;padding: 9px;">
            ...
            <script>
                var options = {
                    ...
                    labels: ["Negative"سلبي, "Positiveإيجابي"],
...
<script>
    ...
    function setmemberInAction(id, usertype, action) {
        var theId = id;
        Swal.fire({
            title: 'هل أنت متأكد من هذا الإجراء؟',
            showDenyButton: true,
            showCancelButton: true,
            confirmButtonText: `نعم, أنا متأكد!`,
            icon: 'warning',
    ...
    foreach ($listTeachers as $TeacherRes) {
        ...
        <tr>
            ...
            WHERE `For_User` = '" . $TeacherRes['Id'] . "' AND `Type_Of_User` = '" . $type . "' LIMIT 1 ")->result_array();
                ?>
                <?php if (empty($avatar)) { ?>
                    <img src="<?= base_url(); ?>uploads/avatars/default_avatar.jpg" class="avatar-xs rounded-circle "
                         alt="...">
                <?php } else { ?>
        ...
        <tr>
            ...
            <?php if ($siteResult['Action'] == "School") { ?>
                <?php if ($siteResult['Result'] == '0') { ?>
                    <td><span class="badge font-size-12" style="width: 100%;background-color: #00ab00;color: #ffffff;">Negative (-)</span>
                    </td>
                <?php } else { ?>
                    <td><span class="badge font-size-12" style="width: 100%;background-color: #ff2e00;color: #F4F4F4;">Positive (+)</span>
                    </td>
                <?php } ?>
            <?php } else { ?>
                <?php if ($siteResult['Result'] == '0') { ?>
                    <td><span class="badge font-size-12" style="width: 100%;background-color: #047B04;color: #ffffff;">Negative (-)</span>
                    </td>
                <?php } else { ?>
                    <td><span class="badge font-size-12" style="width: 100%;background-color: #BC2200;color: #FFFFFF;">Positive (+)</span>
                    </td>
                <?php } ?>
            <?php } ?>
...
<tr>
    ...
    <?php if ($siteResult['Action'] == "School") { ?>
        ...
        <?php } else { ?>
            <td><span class="badge font-size-12" style="width: 100%;background-color: #ff2e00;color: #d2d2d2;">Positive (+)</span>
            </td>
        <?php } ?>
    <?php } else { ?>
        <?php if ($siteResult['Result'] == '0') { ?>
            <td><span class="badge font-size-12" style="width: 100%;background-color: #008700;color: #ffffff;">Negative (-)</span>
            </td>
        <?php } else { ?>
            <td><span class="badge font-size-12" style="width: 100%;background-color: #B82100;color: #d2d2d2;">Positive (+)</span>
            </td>
        <?php } ?>
    <?php } ?>
    ...
    <td><?php if ($siteResult['Action'] == "School") { ?>
            <img src="<?= base_url(); ?>assets/images/icons/Home.png" alt="Set in Cleaning" width="20px"
                 onClick="SET_SiteInAction(<?= $siteResult['Id']; ?>);" style="cursor:pointer;" data-toggle="tooltip"
                 data-placement="top" data-original-title="Close For Sterilization">
        <?php } else { ?>
