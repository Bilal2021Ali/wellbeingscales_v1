...
<div class="container-fluid" style="overflow: hidden;">
    <div class="row">
        <div class="col-12">
            <br>
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">ملاحظة:
                لطباعة هذه الصفحة يفضل التحويل إلى الواجهة باللغة الإنجليزية وذلك لضمان إنشاء QR بشكل صحيح</h4>
    ...
    <div class="row pagecon">
        <?php foreach ($user_data as $student): ?>
            <div class="col-4">
                ...
                $text = "Full Name :" . $student['F_name_AR'] . ' ' . $student['M_name_AR'] . ' ' . $student['L_name_AR'] . '\n';
                $text .= "Gender :" . $gender . '\n';
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card-title">Card
                            For <?php echo $student['F_name_AR'] . ' ' . $student['L_name_AR'] ?></div>
                        <div class="row" style="height: 192px;">
                            <div class="fOR8pRINT col-lg-8 " id="fOR8pRINT">
                                <div class="col-lg-8 user_data">
                                    <p> Full Name
                                        : <?php echo $student['F_name_AR'] . ' ' . $student['M_name_AR'] . ' ' . $student['L_name_AR'] ?></p>
...
<script>
    ...
    $text = "Full Name :" . $data['F_name_AR'] . ' ' . $data['M_name_AR'] . ' ' . $data['L_name_AR'] . '\n';
    $text .= "Gender :" . $gender . '\n';
