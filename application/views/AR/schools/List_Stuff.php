    ...
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 030
                Chart - الرسم البياني - درجات حرارة الموظفين اليومية</h4>
            <div class="row">
            ...
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 031
                تعديل بيانات الموظفين - بطاقة QR</h4>
            <div class="container-fluid" style="overflow: auto;">
                ...
                <div class="page-title-right">
                    ...
                    <ol class="breadcrumb m-0">
                        ...
                        <a href="<?= base_url(); ?>AR/Schools/infos_Card/AllStaffs"
                           style="position: absolute;right: 10px;"> عرض قائمة جميع الموظفين <i
                        ...
                        <table class="table">
                            ...
                            foreach ($listofaStaffs as $admin) {
                                ...
                                <tr id="User_<?= $admin['Id'] ?>">
                                    ...
                                    <td>
                                        <a href="<?= base_url() ?>AR/schools/UpdateStaffData/<?= $admin['Id']; ?>">
                                            <i class="uil-pen" style="font-size: 25px;" data-toggle="tooltip"
                                               data-placement="top" title="" data-original-title="تحديث"></i>
                                        </a>
                                        <a href="<?= base_url() ?>AR/schools/infos_Card/Staff/<?= $admin['Id']; ?>">
                                            <i class="uil-credit-card" style="font-size: 25px;" data-toggle="tooltip"
                                               data-placement="top" title="" data-original-title="بطاقة"></i>
                                        </a>
...
foreach ($Ourstaffs as $staff) {
    ...
    $getResults = $this->db->query("SELECT * FROM l2_result WHERE `UserId` = '" . $staff['Id'] . "' AND Created = '" . $today . "' AND UserType = 'Staff'  ORDER BY `Id` DESC LIMIT 1")->result_array();
