...
<body>
    ...
    <div class="main-content">
        <div class="page-content">
            ...
            <br><h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">REP 043: تقرير الحضور والإنصراف - خلال فترة زمنية - جميع المستخدمين (أجهزة البوابات)</h4>
    ...
    <script>
        $("#getData").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>AR/Ajax/Attendence_in_of_all',
...
?>
    ...
    <td class="Td-Results_font"><?php if ($result >= 38.50 && $result <= 45) { ?>
    ...
    <td class="Td-Results"><?php if ($result >= 38.50 && $result <= 45) { ?>
