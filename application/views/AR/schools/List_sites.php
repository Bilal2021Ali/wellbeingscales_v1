               ...
               <section class="content">
                    <div class="main-content">
                         <div class="page-content">
							 <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 037 قائمة المواقع</h4>
                              <div class="row">
                                             ...
                                             <div class="card-body" style="background-color: #3df0f0;padding: 5px">
                                                  <div class="card-body" style="background-color: #022326;">
                                                       <div class="float-right mt-2">
                                                            ...
                                                            <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/sites_counter.png" alt="schools" width="50px">
                                                       </div>
                                                       <div>
                                                            <?php
                                                            ...
                                                            <p class="mb-0">مجموع المواقع العامة </p>
                                                       </div>
                                        ...
                                        <div class="card">
                                             <div class="card-body" style="background-color: #ff26be;padding: 5px">
                                                  <div class="card-body" style="background-color: #2e001f;">
                                                       <div class="float-right mt-2">
                                                            <img src="<?php echo base_url(); ?>assets/images/icons/png_icons/area_counter.png" alt="schools" width="50px">
                                                       </div>
                                                       <div>
                                                            <?php
                                                            $allarea = $this->db->query("SELECT * FROM `l2_site` WHERE `Added_By` = '" . $idd . "' ")->num_rows();
                                                            $lastsareas = $this->db->query("SELECT * FROM `l2_site`  WHERE `Added_By` = $idd  ORDER BY Id DESC LIMIT 1 ")->result_array();
                                                            ?>
                                                            <h4 class="mb-1 mt-1">
                                                                 <span data-plugin="counterup"><?php echo $allarea ?></span>
                                                            </h4>
                                                            <p class="mb-0">مجموع المواقع  الخاصة </p>
                                                       </div>
							 ...
							 <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 038 قائمة المواقع الخاصة</h4>

                              <div class="container-fluid" style="overflow: auto;">
                                   <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <li class="breadcrumb-item"><a href="javascript: void(0);">المواقع الخاصة</a></li>
                                             <li class="breadcrumb-item active">قائمة</li>
                                             <a href="<?php echo base_url(); ?>AR/Schools/infos_Card/SitesList" style="position: absolute;right: 10px;">
                                                  عرض جميع المواقع الخاصة
                                   ...
                                   <div class="card">
                                        <div class="card-body">
                                             <table class="table">
                                                  ...
                                                  <tbody>
                                                       <?php foreach ($listofaStaffs as $key=>$admin) { ?>
                                                            <tr>
                                                                 ...
                                                                 <td><?php foreach ($sitecodes as $code) { echo $code['Site_Code'] . " - " . $Site_name; }  ?></td>
                                                                 <td><?php echo $admin['Description']; ?></td>
                                                                 <td style="text-align: center;">
                                                                      <a href="<?php echo base_url() ?>AR/schools/UpdateSite/<?php echo $admin['Id']; ?>">
                                                                           <i class="uil-pen" style="font-size: 25px;" title="Edit'"></i>
                                                                      </a>
                                                                      <a href="<?php echo base_url() ?>AR/schools/infos_Card/Site/<?php echo $admin['Id']; ?>">
                                                                           <i class="uil-credit-card" style="font-size: 25px;" title="Card"></i>
                                                                      </a>
                                                                 </td>
                                                            </tr>
                                                       <?php  } ?>
