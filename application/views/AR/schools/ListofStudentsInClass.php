            ...
            <table class="Students_Table" style="width: 100%;">
              ...
              <tbody>
                ...
                <tr id="TrStudId<?php echo $stud['Id']; ?>">
                  ...
                  <td><?php echo $stud['F_name_AR'].' '.$stud['M_name_AR'].' '.$stud['L_name_AR'];?></td>
...
e.preventDefault();
 $.ajax({
     type: 'POST',
     url: '<?php echo base_url(); ?>AR/Results/AddResultForStudent',
     ...
     'error'
            ...
            <div class="mt-5" style="text-align: center;"> <a class="btn btn-primary waves-effect waves-light"  href="<?php echo base_url(); ?>AR/schools/Tests">العودة إلى صفحة الاختبارات</a> </div>
          </div>
          <?php
          }
          } else {
              echo "الرجاء اختيار الصف.";
          }
          ?>
        </div>
