...
<body class="light menu_light logo-white theme-white">
    ...
    <?php
    $Positions  = $this->db->query("SELECT * FROM `r_positions_tech`")->result_array(); 
    ...
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 031 تعديل بيانات المعلمين - بطاقة QR </h4>
            <div class="row">
                <div class="col-xl-12">
                    <div class="">
                        <div class="card-body">
                            <div class="alert alert-border alert-border-secondary alert-dismissible fade show" role="alert">
                                <span id="Toast">يرجى تحديث المعلومات الخاصة بالمعلم</span>
                            ...
                            <div class="col-md-12 formcontainer" id="staff">
                                <div class="row">
                                    <?php foreach ($data as $Teacher) { ?>
                                        <form class="needs-validation InputForm col-md-12" novalidate="" style="margin-bottom: 27px;" id="UpdateTeacherData">
                                            <div class="card">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-md-2" style="margin-bottom: 11px;">
                                                            ...
                                                            <select class="custom-select" id="Prefix" name="Prefix">
                                                                ...
                                                                <?php foreach ($tbl_prefix as $pref) : ?>
                                                                    <option value="<?php echo $pref['Prefix']; ?>" <?php echo $Teacher['Prefix'] == $pref['Prefix'] ? "selected" : ""; ?>>
                                                    ...
                                                    <div class="row" style="padding: 0px;">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom02" placeholder="الإسم الأول بالإنجليزي" name="First_Name_EN" required="" value="<?php echo $Teacher['F_name_EN'] ?>">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="الإسم الأوسط بالإنجليزي" name="Middle_Name_EN" required="" value="<?php echo $Teacher['M_name_EN'] ?>">
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="الإسم الأخير بالإنجليزي" name="Last_Name_EN" required="" value="<?php echo $Teacher['L_name_EN'] ?>">
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom02" placeholder="الإسم الأول بالعربي" name="First_Name_AR" required="" value="<?php echo $Teacher['F_name_AR'] ?>">
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="الإسم الاوسط بالعربي" name="Middle_Name_AR" required="" value="<?php echo $Teacher['M_name_AR'] ?>">
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="الاسم الاخير بالعربي" name="Last_Name_AR" required="" value="<?php echo $Teacher['L_name_AR'] ?>">
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-format="dd-m-yyyy" name="DOP" value="<?php echo $Teacher['DOP'] ?>">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="tel" class="form-control" required placeholder="رقم الهاتف" name="Phone" value="<?php echo $Teacher['Phone'] ?>">
                                                                </div>
                                                                <!-- input-group -->
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="custom-select" name="Gender">
                                                                <option value="M" <?php echo $Teacher['Gender'] == 'M' ? "selected" : "" ?>>ذكر</option>
                                                                <option value="F" <?php echo $Teacher['Gender'] == 'F' ? "selected" : "" ?>>أنثى</option>
                                                            </select>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6" style="margin-bottom: 11px;">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom02" value="<?php echo $Teacher['National_Id'] ?>" placeholder="نعتذر لا يمكنك تعديل الرقم الوطني  ): " data-toggle="tooltip" data-placement="top" title="" data-original-title="نعتذر لا يمكنك تعديل الرقم الوطني " readonly>
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" name="Nationality">
                                                                    <?php foreach ($contriesarray as $contries) { ?>
                                                                        <option value="<?php echo $contries['name']; ?>" <?php echo $Teacher['Nationality'] == $contries['name'] ? "selected" : "" ?> class="option">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="Position">
                                                                    <?php foreach ($Positions as $Position) { ?>
                                                                        <option value="<?= $Position['Id']  ?>" <?= $Teacher['Position'] == $Position['Id'] ? "selected" : "" ?>>
                                                        ...
                                                        <div class="col-md-4" style="margin-bottom: 11px;">
                                                            <div class="form-group">
                                                                <label> الإيميل </label>
                                                                <input type="email" class="form-control" id="validationCustom02" placeholder="الإيميل" name="Email" required="" value="<?php echo $Teacher['Email'] ?>">
                                                                <div class="valid-feedback">
                                                                    يبدو جيداً
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label> المراحل الدراسية </label><!-- Classes -->
                                                            <div class="form-group">
                                                                <?php $teacherClasses = array_column($this->schoolHelper->teacherClasses($Teacher['Id']) , "class_Key");                                                                  ?>
                                                                <?php if (!empty($classes)) { ?>
                                                                    <select name="Classes[]" class="form-control select2 select2-multiple" multiple="multiple" data-placeholder="Choose ..." id="">
                                                                        <?php foreach ($classes as $class) {  ?>
                                                                            <option <?= in_array($class['Id'] , $teacherClasses) ? "selected" : "" ?> value="<?= $class['Id'] ?>"><?= $class['Class'] ?></option>
                                                                        <?php } ?>
                                                                    </select>
                                                                <?php } else { ?>
                                                                    <p>ليس لديك أي مراحل دراسية !! الرجاء تحرير ملف النظام المدرسي<a href="<?php echo base_url() ?>AR/schools/Profile">ملف النظام المدرسي</a> </p>
                                                                <?php } ?>
                                                            </div>
                                                        </div> 
                                                        <input type="hidden" name="old_NID" value="<?php echo $Teacher['National_Id'];  ?>">
    ...
    <script>
        // ajax sending
        $("#UpdateTeacherData").on('submit', function(e) {
            e.preventDefault();
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>AR/schools/UpdateTeacherData',
