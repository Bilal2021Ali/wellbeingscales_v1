...
<script>
    $("#add_visitor").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/schools/update_visitor<?php echo isset($user_data[0]) ? '?visitor_key=' . $user_data[0]['user_id']  : "" ?>',
            ...
            success: function(data) {
                if (data == 'ok') {
                    ...
                    setTimeout(() => {
                        location.href = "<?php echo base_url("AR/schools/visitor_report"); ?>";
                    }, 800);
                } else {
