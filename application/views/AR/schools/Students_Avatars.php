...
<body>
     <div class="main-content">
          <div class="page-content">
			  <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 042 رفع الصور</h4>
               <div class="row">
...
<tr id="TrStafffId<?php echo $stud['Id']; ?>" role="row" class="odd">
    ...
    <?php
     ...
     <?php } ?>          
      ...
      <td>
     <a href="<?php echo base_url(); ?>AR/Schools/ChangeMemberAvatar/Student/<?php echo $stud['Id']; ?>/<?php echo $class; ?>">
