...
<body>
    ...
    WHERE `air_result_daily`.`User_type` = 'school' 
    ...
    ?>
        ...
        ?>
            <div class="col-sm-12">
                <h3 class="text-center" style="width: 100%;"> <?= $type  ?> </h3>
            </div>
            <div class="col-sm-12 dataShow" data-fColor="<?= $f_color;  ?>" bkcolor="<?= $color;  ?>"> <img src="<?= base_url() ?>assets/images/icons/<?= $img_url  ?>" alt="" width="30px">
                <h4>
                    <?= $status;  ?>
                </h4>
                <h6 class="F_T">(
        ...
        <?php  } else {  ?>
            ...
            <div class="col-sm-12" data-fColor="<?= $f_color;  ?>"> <img src="<?= base_url() ?>assets/images/icons/<?= $img_url  ?>" alt="" width="30px">
                <h4>NA/NA</h4>
                <h6 class="F_T">(-- / --)</h6>
    ...
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 012: قائمة نتائج أجهزة جودة الهواء
            </h4>
            ...
            <div class="container-fluid">
                <div class="row">
					...
					<br><br>
					<br>
						<img src="<?= base_url("assets/images/legendaqar.png"); ?>" class="img-responsive w-100" alt="" srcset="">
                    </div>
					...
					<div class="col-xl-9">
						...
						<div class="row  justify-content-center">
							...
							<?php foreach ($data as $devices) {  ?>
                                ...
                                ?>
                                    <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#Device<?= $devices['device_id']  ?>" role="tab" aria-selected="false"> <span class="d-block d-sm-none"><i class="fas fa-home"></i></span> <span class="d-none d-sm-block">
                                                <?= $devices['Area']  ?>
                                            </span> </a> </li>
                                <?php  }  ?>
                            <?php  }  ?>
                    ...
                    <div class="tab-content p-3 text-muted">
                        ...
                        foreach ($data as $devices) {
                            if (!in_array($devices['device_id'], $exist)) {
                                $exist[] = $devices['device_id'];
                        ?>
                                <div class="tab-pane col-xl-12 col-xl-auto" id="Device<?=  $devices['device_id']  ?>" role="tabpanel">
                                    <div class="row">
                                        <div class="col-xl-4">
											<div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['aq'], 'مؤشر جودة الهواء', 1, "1000.png", $devices['aq_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['ch2o'], 'الفورمالديهايد', 2, "1001.png", $devices['ch2o_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['co2'], 'ثاني أكسيد الكربون', 3, "1002.png", $devices['co2_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['humidity'], 'الرطوبة', 4, "1005.png", $devices['humidity_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['Temperature_c'], 'درجة الحرارة', 5, "1008.png", $devices['Temperature_c_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['pm2_5'], 'الجسيمات 2.5', 6, "1019.png", $devices['pm2_5_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <a href="<?= base_url() ?>AR/schools/Realtime_Dashboard/<?= $devices['Device_Mac']  ?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="text-center">
                                ...
                                <h4 class="text-uppercase mt-4">لا يوجد بيانات</h4>
                                <p class="text-muted">عذرا ، لا يمكننا العثور على أي نتائج.</p>
                            </div>
                        </div>
                    </div>
                <?php  }  ?>                            </div>
...
<script>
    ...
    function go_addData(device_return) {
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>AR/Ajax/sync_device',
            data: {
