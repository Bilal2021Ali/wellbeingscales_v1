...
<body class="light menu_light logo-white theme-white">
    ...
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 027 تعديل ملف الموظف </h4>
            <div class="row">
                <div class="col-xl-12">
                    <div class="">
                        <div class="card-body">
                            <div class="alert alert-border alert-border-secondary alert-dismissible fade show" role="alert">
                                <span id="Toast">يرجى تحديث المعلومات الخاصة بالموظف</span>
                                                        ...
                                                        <div class="col-md-2" style="margin-bottom: 11px;">
                                                            ...
                                                            <select class="custom-select" id="Prefix" name="Prefix">
                                                                ...
                                                                <?php foreach ($tbl_prefix as $pref) : ?>
                                                                    <option value="<?php echo $pref['Prefix']; ?>" <?php echo $stuffdata['Prefix'] == $pref['Prefix'] ? "selected" : ""; ?>>
                                                    ...
                                                    <div class="row" style="padding: 0px;">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom02" placeholder="First Name EN" name="First_Name_EN" required="" value="<?php echo $stuffdata['F_name_EN'] ?>">
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="Middle Name EN" name="Middle_Name_EN" required="" value="<?php echo $stuffdata['M_name_EN'] ?>">
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="Last Name EN" name="Last_Name_EN" required="" value="<?php echo $stuffdata['L_name_EN'] ?>">
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom02" placeholder="First Name AR" name="First_Name_AR" required="" value="<?php echo $stuffdata['F_name_AR'] ?>">
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="Middle Name AR" name="Middle_Name_AR" required="" value="<?php echo $stuffdata['M_name_AR'] ?>">
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-sm-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom01" placeholder="Last Name AR" name="Last_Name_AR" required="" value="<?php echo $stuffdata['L_name_AR'] ?>">
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="input-group">
                                                                    <input type="text" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-format="dd-mm-yyyy" name="DOP" value="<?php echo $stuffdata['DOP'] ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select class="custom-select" name="Gender">
                                                                <option value="M" <?= $stuffdata['Gender'] == 'M' ? "selected" : "" ?>>ذكر</option>
                                                                <option value="F" <?= $stuffdata['Gender'] == 'F' ? "selected" : "" ?>>أنثى</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6" style="margin-bottom: 11px;">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" class="form-control" id="validationCustom02" value="<?php echo $stuffdata['National_Id'] ?>" placeholder="Sorry You Can't Change The National Id  ): " data-toggle="tooltip" data-placement="top" title="" data-original-title="Sorry You Can't Change The National Id " readonly>
                                                                <div class="valid-feedback">
                                                                    Looks good!
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="custom-select" name="Nationality">
                                                                    <?php foreach ($contriesarray as $contries) { ?>
                                                                        <option value="<?php echo $contries['name']; ?>" <?php echo $stuffdata['Nationality'] == $contries['name'] ? "selected" : "" ?> class="option">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="Position">
                                                                    <?php foreach ($Positions as $Position) { ?>
                                                                        <option value="<?= $Position['Id']  ?>" <?= $stuffdata['Position'] == $Position['Id'] ? "selected" : "" ?>>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control" name="relationship">
                                                                    <?php foreach ($av_relationships as $av_relationship) { ?>
                                                                        <option value="<?= $av_relationship['Id'] ?>" <?= $av_relationship['Id'] == $stuffdata['martial_status'] ? "selected" : "" ?>><?= $av_relationship['name_ar'] ?></option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        </div>
    ...
    <script>
        ...
        $("#UpdateMemberData").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>AR/schools/UpdateStaff',
