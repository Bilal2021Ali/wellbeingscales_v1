...
<div class="right-bar" style="z-index: 100000;">
    <div data-simplebar class="h-100">
        ...
        <hr class="mt-0"/>
        <h6 class="text-center mb-0"> المعلمين المرتبطين </h6>
...
<div class="main-content">
        ...
        <?php if (isset($permissions['users_counters']) && $permissions['users_counters'] == '1') { ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">العدادات والنسبة المئوية</h3>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">مجموع المستخدمين حسب الجنس</h3>
        ...
        <?php if (isset($permissions['users_wellbeing']) && $permissions['users_wellbeing'] == '1') { ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title text-center">الرفاهية</h3>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title text-center">أنواع المستخدمين</h3>
                ...
                <script>
                    var options = {
                        ...
                        xaxis: {
                            categories: ["الاستطلاعات المنشورة", "استطلاعات منتهية الصلاحية", "استطلاعات الرأي المكتملة", "فئات الإستطلاعات"]
                        },
                        tooltip: {
                            x: {
                                show: false
                    ...
                    var options = {
                        ...
                        xaxis: {
                            categories: ["الموظفين", "المعلمين", "الطلاب", "أولياء الأمور"]
                        },
                        tooltip: {
                            x: {
                                show: false
        ...
        <?php if (isset($permissions['users_speak_out']) && $permissions['users_speak_out'] == '1') { ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">الشكاوى حسب الأهمية</h3>
            ...
            <script>
                var options = {
                    ...
                    xaxis: {
                        categories: ['قيد الانتظار', 'تم الموافقة عليها', 'تم حلها', 'تم مشاهدتها']
                    },
                    tooltip: {
                        x: {
                            show: false
                ...
                var options = {
                    ...
                    xaxis: {
                        categories: ['أهميتها متوسطة', 'العاجلة', 'أهميتها عالية', 'الأعلى أهمية']
                    },
                    tooltip: {
                        x: {
                            show: false
        ...
        <?php if (isset($permissions['users_daily_temperature']) && $permissions['users_daily_temperature'] == '1') { ?>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title text-center">درجات الحرارة</h3>
                ...
                <script>
                    var options = {
                        ...
                        xaxis: {
                            categories: ["درجة حرارة منخفضة", "درجة الحرارة الطبيعية", "درجة الحرارة المعتدلة", "درجة الحرارة المرتفعة"]
                        },
                        tooltip: {
                            x: {
                                show: false
                    ...
                    var options = {		   
                        ...
                        labels: ["درجة حرارة منخفضة", "درجة الحرارة الطبيعية", "درجة الحرارة المعتدلة", "درجة الحرارة المرتفعة"],
    ...
    <div class="card-body text-center"><img src="<?= base_url("assets/images/Schooldashboard.png") ?>"
        ...
        <?php if (isset($permissions['users_daily_labtests']) && $permissions['users_daily_labtests'] == '1') { ?>
            <h4 class="card-title"
                style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px">
                الفحوصات الطبية <span class="float-right"><a
                            href="<?= base_url("AR/schools/all-labtests-results") ?>"
                            target="_blank" class="text-white"
                            rel="noopener noreferrer">المزيد</a></span></h4>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title text-center">الفحوصات الطبية</h3>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title text-center">الفحص الطبي</h3>
    ...
    <div class="card-body text-center"><img src="<?= base_url("assets/images/Schooldashboard.png") ?>"
        ...
        <?php if (isset($permissions['users_home_quarantine']) && $permissions['users_home_quarantine'] == '1') { ?>
            <h4 class="card-title"
                style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px">
                الحجر الصحي والحجر المنزلي
                <span class="float-right">
                    <a class="text-white" href="<?= base_url("AR/schools/labtestall") ?>"
                       rel="noopener noreferrer">المزيد</a>
                </span>
            </h4>
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">الحجر الصحي والحجر المنزلي</h3>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">نسبة الحجر الصحي والحجر المنزلي</h3>
            ...
            <script>
                var options = {
                    ...
                    xaxis: {
                        categories: ["الموظفين", "المعلمين", "الطلاب"],
                    },
                };
                ...
                var options = {
                    ...
                    labels: ["الحجر المنزلي", "الحجر الصحي"],
                    colors: ["#34c38f", "#5b73e8", "#f1b44c", "#50a5f1"],
                    legend: {
                        show: true,
                        position: 'bottom',
    ...
    <div class="card-body text-center"><img src="<?= base_url("assets/images/Schooldashboard.png") ?>"
        ...
        <?php if (isset($permissions['users_classes_counters']) && $permissions['users_classes_counters'] == '1') { ?>
            <h4 class="card-title"
                style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px">
                مجاميع الفحوصات الطبية <span class="float-right"><a class="text-white"
            ...
            <script>
                var options = {
                    ...
                    xaxis: {
                        categories: ["مجموع الحضور", "مجموع الغياب"],
                    },
                };
        ...
        <div class="col-xl-12">
            <div class="row">
                <?php if (isset($permissions['users_stay_home']) && $permissions['users_stay_home'] == '1') { ?>
                    <div class="col-xl-6">
                        <h4 class="card-title"
                            style="background: #33A2FF; padding: 10px;color: #FFFFFF;border-radius: 4px;">الحجر المنزلي
                            - (المعلمين، الموظفين، الطلاب)</h4>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">
                                    <div class="float-right">
                                        <div class="dropdown"><a class=" dropdown-toggle" href="#"
                                                                 data-toggle="dropdown" aria-haspopup="true"
                                                                  aria-expanded="false"> <span class="text-muted"><b>تحديد الفحص</b><i
                                                            class="mdi mdi-chevron-down ml-1"></i></span> </a>
                                ...
                                <h4 class="card-title mb-4"><img
                                            src="<?= base_url(); ?>assets/images/icons/png_icons/Temp_Counter.png"
                                            style="width: 25px;margin: auto 5px;"> الحجر المنزلي(<span
                                            id="STAYHOMESHOWTESTNAME">درجة الحرارة</span>) <font color=#e13e2b>(المعلمين،
                                        الموظفين، الطلاب)</font></h4>
                ...
                <?php if (isset($permissions['users_quarantine']) && $permissions['users_quarantine'] == '1') { ?>
                    <div class="col-xl-6">
                        <h4 class="card-title"
                            style="background: #FF0000; padding: 10px;color: #FFFFFF;border-radius: 4px;">الحجر الصحي
                            (المعلمين، الموظفين، الطلاب)</h4>
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title mb-4">
                                ...
                                <h4 class="card-title mb-4"><img
                                            src="<?= base_url(); ?>assets/images/icons/png_icons/Temp_Counter.png"
                                            style="width: 25px;margin: auto 5px;"> الحجر الصحي (<span
                                            id="STAYQuarantineNOSHOWTESTNAME">درجة الحرارة</span>)<font color=#e13e2b>
                                        (المعلمين، الموظفين، الطلاب)</font></h4>
                                <div data-simplebar style="height: 350px;overflow: auto;">
  ...
  <?= $result; ?>
        ...
        <td class="Td-Results"><?php if ($result >= 38.500 && $result <= 45.500) { ?>
                <span class="badge font-size-12"
                      style="width: 100%;border-radius: 10px;background: #ff2e00;color: #fff;">مرتفعة</span>
            <?php } elseif ($result >= 37.501 && $result <= 38.500) { ?>
                <span class="badge font-size-12"
                      style="width: 100%;border-radius: 10px;background: #ff8200;color: #fff;">متوسطة</span>
            <?php } elseif ($result >= 36.201 && $result <= 37.500) { ?>
                <span class="badge font-size-12"
                      style="width: 100%;border-radius: 10px;background: #00ab00;color: #fff;">طبيعية</span>
            <?php } elseif ($result <= 36.200) { ?>
                <span class="badge font-size-12"
                      style="width: 100%;border-radius: 10px;background: #cdfc00;color: #fff;">منخفضة</span>
            <?php } elseif ($result >= 45.501) { ?>
                <span class="badge font-size-12"
                      style="width: 100%;border-radius: 10px;background: #272727;color: #fff;">خاطئة</span>
            <?php } ?></td>
        <?php
    }
                ...
                <?php if ($siteResult['Action'] == "School") { ?>
                    <?php if ($siteResult['Result'] == '0') { ?>
                        <td><span class="badge font-size-12"
                                  style="width: 100%;background-color: #00ab00;color: #ffffff;">سلبي (-)</span></td>
                    <?php } else { ?>
                        <td><span class="badge font-size-12"
                                  style="width: 100%;background-color: #ff2e00;color: #F4F4F4;">إيجابي (+)</span></td>
                    <?php } ?>
                <?php } else { ?>
                    <?php if ($siteResult['Result'] == '0') { ?>
                        <td><span class="badge font-size-12"
                                  style="width: 100%;background-color: #047B04;color: #ffffff;">سلبي (-)</span></td>
                    <?php } else { ?>
                        <td><span class="badge font-size-12"
                                  style="width: 100%;background-color: #BC2200;color: #FFFFFF;">إيجابي (+)</span></td>
                    <?php } ?>
                <?php } ?>
    ...
    <tr>
        ...
        <?php if ($siteResult['Action'] == "School") { ?>
            ...
            <?php } else { ?>
                <td><span class="badge font-size-12"
                          style="width: 100%;background-color: #ff2e00;color: #d2d2d2;">إيجابي (+)</span></td>
            <?php } ?>
        <?php } else { ?>
            <?php if ($siteResult['Result'] == '0') { ?>
                <td><span class="badge font-size-12"
                          style="width: 100%;background-color: #008700;color: #ffffff;">سلبي (-)</span></td>
            <?php } else { ?>
                <td><span class="badge font-size-12"
                          style="width: 100%;background-color: #B82100;color: #d2d2d2;">إيجابي (+)</span></td>
            <?php } ?>
        <?php } ?>
