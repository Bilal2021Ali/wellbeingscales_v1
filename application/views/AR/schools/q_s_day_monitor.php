    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <br><h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">MON 042: التقرير اليومي</h4>
                ...
                foreach ($Ourstaffs as $staff) {
                    ...
                    foreach ($getResults as $results) {
                        ...
                        $list[] = array(
                            ...
                            "Blood_pressure_max" => $results['Blood_pressure_max'], "time" => $results['Time'],
                            "Blood_oxygen" => $results['Blood_oxygen'], "Heart_rate" => $results['Heart_rate'],
                            "Blood_pressure_min" => $results['Blood_pressure_min'], "action" => $action,
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                <thead>
                                    <tr>
                                        ...
                                        <th>
                                            <p style="font-size:18px"> إسم الموظف
                                        </th>
                                ...
                                <tbody>
                                    <?php foreach ($Staff_list as $sn => $staffsRes) { ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center result"><?php $avatar = $this->db->query("SELECT * FROM `l2_avatars`
                                                ...
                                                <?php } else { ?>
                                                    <img src="<?= base_url(); ?>uploads/avatars/<?= $avatar[0]['Link']; ?>" class="avatar avatar-lg rounded-circle" alt="...">
                                                <?php } ?>
                                                <h6 class="font-size-15 mb-1 font-weight-normal"><?= $staffsRes['Username']; ?></h6>
                                                <p class="text-muted" style="font-size: 10px;"><?= $staffsRes['action'] ?> </p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center result"><?php $avatar = $this->db->query("SELECT * FROM `l2_avatars`
                                                ...
                                                <?php } else { ?>
                                                    <img src="<?= base_url(); ?>uploads/avatars/<?= $avatar[0]['Link']; ?>" class="avatar avatar-lg rounded-circle" alt="...">
                                                <?php } ?>
                                                <h6 class="font-size-15 mb-1 font-weight-normal"><?= $studentResults['Username']; ?></h6>
                                                <p class="text-muted" style="font-size: 10px;"><?= $studentResults['action'] ?> </p>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center result"><?php $avatar = $this->db->query("SELECT * FROM `l2_avatars`
                                                ...
                                                <?php } else { ?>
                                                    <img src="<?= base_url(); ?>uploads/avatars/<?= $avatar[0]['Link']; ?>" class="avatar avatar-lg rounded-circle" alt="...">
                                                <?php } ?>
                                                <h6 class="font-size-15 mb-1 font-weight-normal"><?= $TeacherResults['Username']; ?></h6>
                                                <p class="text-muted" style="font-size: 10px;"><?= $TeacherResults['action'] ?> </p>
                                            </td>
