...
<body>
  <div class="main-content">
    <div class="page-content">
      ...
      <br>
      <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH P003: Add a New Device - List of Devices</h4>
      <div class="row">
      ...
      <div class="row">
        <div class="col-xl-8"> <br>
          <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 017:
            <?= isset($device_data) ? "Update Device Data" : "Add New Lab, Thermometer, and Gateway Devices" ?>
          </h4>
                  ...
                  <div class="media align-items-center">
                    ...
                    <div class="media-body overflow-hidden">
                      <h5 class="font-size-16 mb-1">
                        <?= isset($device_data) ? "Update Device Data" : "Add a New Device" ?>
                      </h5>
              ...
              <form id="AddDevice">
                <div id="checkout-billinginfo-collapse" class="collapse show">
                    ...
                    <div>
                      <div class="row">
                        <div class="col-lg-6">
						  ...
						  <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Device MAC Address</h4>
                        ...
                        <div class="col-lg-6">
						  ...
						  <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Device Type</h4>
                      ...
                      <div class="row" style="padding-top: 10px;">
                        <div class="col-lg-6">
                          <div class="form-group">
						  <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Site Location English</h4>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
						  <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Descriptions Device English</h4>
                      ...
                      <div class="row" style="padding-top: 10px;">
                        <div class="col-lg-6">
                          <div class="form-group">
                            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Site Location Arabic</h4>
                            <select name="Site_ar" class="form-control custom-select">
                              <?php foreach ($r_sites as $site) { ?>
                                <option value="<?= $site["Description_ar"] ?>" <?= isset($device_data["Description_ar"]) ? ($device_data["Site_ar"] == $site["Description_ar"]  ? "selected" : "") : "" ?>>
                                  <?= $site["Description_ar"] ?>
                                </option>
                              <?php } ?>
                            </select>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Descriptions Device Arabic</h4>
						...
						<h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Device for</h4>
                        ...
                        <?php if (!empty($vehicles)) { ?>
                          <div class="col-6"><br>
						  <h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Select a vehicle</h4>
                  ...
                  <div class="row" style="padding: 10px;">
                    <div class="col"> <a href="<?= base_url(); ?>EN/schools/" class="btn btn-link text-muted"> <i class="uil uil-arrow-right mr-1"></i> Cancel </a> </div>
                    <div class="col">
                      <div class="text-sm-right mt-2 mt-sm-0">
                        ...
                        <button type="Submit" class="btn btn-success"> <i class="uil uil-save mr-1"></i>
                          <?= isset($device_data['Id']) ? "update" : "Add" ?>
                        </button>
                      </div>
                    </div>
                  </div>
          ...
          <div class="card">
            <div class="card-body">
              <div class="p-3 bg-light mb-4">
                ...
                ?>
                <h5 class="font-size-16 mb-0">List of Devices<span class="float-right ml-2"> <a href="<?= base_url(); ?>EN/schools/ListofDevices">
                      <?= sizeof($alldev); ?>
                    </a> </span> </h5>
              </div>
...
<script>
  ...
  $('.update-device').click(function() {
    location.href = '<?= base_url("EN/schools/AddDevice"); ?>/' + $(this).attr('data-device-id');
  });
  ...
  $("#AddDevice").on('submit', function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: '<?= base_url(); ?>EN/schools/startAddDevice',
  ...
  $("#AddBatch").on('submit', function(e) {
    ...
    $.ajax({
      type: 'POST',
      url: '<?= base_url(); ?>EN/schools/startAddBatch',
      data: new FormData(this),
      contentType: false,
      cache: false,
      processData: false,
