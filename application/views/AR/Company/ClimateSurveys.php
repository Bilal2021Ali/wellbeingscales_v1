                                ...
                                <tbody>
                                    <?php foreach ($surveys as $key => $survey) { ?>
                                        <tr id="serv_<?= $survey['survey_id'] ?>">
                                            ...
                                            <td>
                                                <a data-toggle="tooltip" data-placement="top" title="" data-original-title="معاينة" href="<?= base_url("AR/Company/climatePreview/" . $survey['survey_id']); ?>"><i class="uil uil-eye font-size-20"></i></a>
                                                <a data-toggle="tooltip" data-placement="top" title="" data-original-title="استخدام الجو العام" href="<?= base_url("AR/Company/newclimatesurvey/" . $survey['survey_id']); ?>"><i class="uil uil uil-channel font-size-20"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
                                    ...
                                    <?php foreach ($oursurveys as $key => $oursurvey) { ?>
                                        <tr id="serv_<?= $oursurvey['survey_id'] ?>">
                                            ...
                                            <td class="text-center" >
                                                <a data-toggle="tooltip" data-placement="top" title="" data-original-title="معاينة" href="<?= base_url("AR/Company/climatePreview/" . $oursurvey['main_survey_id']); ?>"><i class="uil uil-eye font-size-20"></i></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
