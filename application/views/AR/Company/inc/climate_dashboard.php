    ...
    <div class="main-content">
        ...
        <div class="col-12">
            <?php if (!isset($nofilter)) { ?>
                <h4 class="card-body text-center" style="background: #33a2ff; padding: 10px;color: #fcf9f9;border-radius: 4px;"> WELLNESS CLIMATE SURVEY REPORT</h4>
                <div class="card">
                    <div class="card-body">
                    <?php  } ?>
                                ...
                                <?php foreach ($climate_survyes as $survey) { ?>
                                    <div class="climatesurvey <?= isset($Carousel) ? "item event-list mr-2" : "col-4" ?>" data-category-id="<?= $survey["Cat_id"]; ?>">
                                        <div class="card text-center">
                                            ...
                                            <?php /*?>  <a id="GaugeChart_action_<?= $prefix ?? "" ?>_<?= $survey['survey_id'] ?>" href="<?= base_url('AR/Company/ClimateReports/' . $this->encrypt_url->safe_b64encode($survey['survey_id'])); ?>" class="w-100 btn btn-warning" style="border-radius: 0px;">Show Details <i class="uil uil-arrow-right"></i></a><?php */?>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
