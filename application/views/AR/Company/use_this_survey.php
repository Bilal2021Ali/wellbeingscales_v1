...
<body>
    ...
    <script>
        ...
        $("#use_serv").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url(); ?>AR/Company/start_using_serv',
                ...
                success: function(data) {
                    ...
                    if (data == "ok_enabled") {
                        ...
                        setTimeout(() => {
                            location.href = "<?= base_url("AR/Company/wellness"); ?>";
                        }, 800);
                    } else if (data == "ok_disabled") {
                        Swal.fire({
                            title: 'added successfully',
                            html: 'You can <b>active</b> it ' + '<a href="<?= base_url("AR/Company/wellness"); ?>">here</a> ',
                            icon: 'success',
                            confirmButtonColor: '#5b8ce8',
