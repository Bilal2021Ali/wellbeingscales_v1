...
<a href="<?php echo base_url(); ?>AR/dashboardSystem" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
        </div>
                            ...
                            <div class="card">
                                <div class="card-body p-4"> 
                                   ...
                                   if(!empty($avatarlist)){         
                                    ...
                                    ?>
                                  <a href="<?php echo base_url(); ?>AR/users/changePhoto">
                                  ...
                                  <a href="<?php echo base_url(); ?>AR/users/changePhoto">
                                   ...
                                   <?php } ?>
                                   <h6 class="text-primary" style="position: relative;top: -33px;" id="Toast"> أهلا وسهلا </h6>
                                   <h5 class="font-size-15 mt-3" style="position: relative;top: -42px;margin: 0px;">
                                        <?php echo $sessiondata['username']; ?>
                                   </h5>
                                   </div>
                                      <?php  $Useradta = $this->db->query("SELECT * FROM l0_organization WHERE Id = '".$sessiondata["admin_id"]."' ")->result_array();  
                                        ...
                                        value="<?php echo $admin['EN_Title'] ?>">   
                                        </div> 
                                             
                                        <div class="form-group">
                                        <label>الاسم بالعربي</label>      
                                        <input type="text" class="form-control" name="AR_Title" 
                                        value="<?php echo $admin['AR_Title'] ?>">   
                                        </div> 
                                        ...
                                        <div class="form-group">
                                        <a class="" href="<?php echo base_url(); ?>AR/users/ResetMyPassword">تعديل كلمة المرور</a>      
                                        </div> 
                                        <button class="btn btn-primary w-sm waves-effect waves-light btn-block" type="Submit" id="sub">للتعديل الآن . أضغط هنا</button>                                      
                                        </form> 
                                         <?php } ?>
                                    </div>
                                </div>
...
$( "#ResetUsername" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>AR/users/ResetL1_Org',
