                    ...
                    <form class="row mb-3" method="POST">
                        <div class="col-lg-4">
                            ...
                            <select name="department" class="form-control">
                                <option value="" <?= $department == "" ? "selected" : "" ?>>الكل</option>
                                <?php foreach ($depts as $dept) { ?>
                                    <option value="<?= $dept['Id'] ?>" <?= $department == $dept['Id'] ? "selected" : "" ?>><?= $dept['Dept_Name_AR'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-lg-4">
                        ...
                        <div class="col-lg-4">
                            <label class="form-label"> Trip إسم <span class="text-danger">*</span>:</label>
                            <select name="trip_name" class="form-control">
                                <option value="" <?= $tripName == "" ? "selected" : "" ?>>الكل</option>
...
<script>
    $('select[name="department"]').change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/Company/machenesForDepartment',
            data: {
                dept_id: id,
            },
    ...
    $('select[name="machine"]').change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/Company/tripNames_forthisMachine',
            data: {
                machine_id: id,
            },
            success: function(data) {
