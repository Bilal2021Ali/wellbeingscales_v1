                                                            ...
                                                            <div class="card">
                                                                <div class="card-body quastions-title">
                                                                    <h3 class="card-title"><?= $questions_counter ?> . <?= $question['en_title'] ?>
                                                                        <span class="open_more_q float-right" link="<?= base_url('EN/Company/question_detailed_report/' . $serv_id . "/" . $question['q_id'] . "/" . $group_choices . '/' . md5(time())) ?>" target="_blank" rel="noopener noreferrer"><i class="uil uil-analytics"></i></span>
                                                                    </h3>
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                            ...
                                                                            <div class="card-body">
                                                                                <div class="custom-control custom-radio mr-2">
                                                                                    <label class=""><i class="uil uil-check-circle"></i><?= $choice['title_en'] ?><span class="float-right">( <?= calc_perc($use_count, $all_count); ?>)
                                                                                            <span class="open_moreD" link="<?= base_url('EN/Company/question_choice_report/' . $serv_id . "/" . $choice['Id'] . "/" . $question['q_id'] . "/"  . (calc_perc($use_count, $all_count) ?? 1) . '/' . md5(time())) ?>" target="_blank" rel="noopener noreferrer"><i class="uil uil-arrow-up-right"></i></span>
                                                                                        </span>
                                                                                    </label>
                                                                                </div>
                                                                            </div>
