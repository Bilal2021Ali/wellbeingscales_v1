...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <div class="col-12">
                <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">
                    متابعة حضور وانصراف المستخدمين
                </h4>
            </div>
	  ...
	  WHERE Added_By = '" . $dept['Id'] . "' ")->result_array();
                ...
                <div class="control col-md-12" style="padding: 10px;">
                    <button type="button" form_target="searchbydevice" class="btn btn-primary w-md contr_btn"> <i class="uil uil-search"></i>
                        البحث حسب الجهاز
                    </button>
                    <button type="button" form_target="searchbyname" class="btn w-md contr_btn"> <i class="uil uil-search"></i>
                        البحث حسب الإسم
                    </button>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-xl-12">
                                        <label>إختر الجهاز</label>
                                        <select class="custom-select" id="devices">
                                            <option value="">إختر الجهاز</option>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <label for="name"> أكتب الإسم (بالعربي) </label>
                                        <input type="text" placeholder="إبدأ كتابة الإسم  " id="name" class="form-control">
                                    </div>
                                    <div class="col-lg-4" style="padding-top: 30px;">
                                        <button type="button" onClick="GetDataForUser()" style="width: 100%;" class="btn btn-outline-primary waves-effect waves-light">إبحث</button>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function GetDataForUser() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>AR/Results_company/getResultsbyname_co',
                data: {
                    name: name,
                },
                beforeSend: function() {
