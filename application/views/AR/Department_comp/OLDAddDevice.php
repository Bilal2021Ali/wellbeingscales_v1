...
<div class="col-xl-8">
                              ...
                              <div class="row" style="padding: 10px;">
                                    <div class="col">
                                        <a href="<?php echo base_url(); ?>AR/Company_Departments" 
          ...
          WHERE Added_By = '".$sessiondata['admin_id']."' AND `Comments` = 'Gateway' ")->result_array();
			...
			<h5 class="font-size-16 mb-0">Total Devices
			  <span class="float-right ml-2">
			    <a href="<?php echo base_url(); ?>AR/Company_Departments/ListofDevices">
...
$("#AddDevice").on('submit', function (e) {
     ...
     $.ajax({
          type: 'POST',
          url: '<?php echo base_url(); ?>AR/Company_Departments/startAddDevice',
