...
<body class="authentication-bg">
        ...
        <div class="home-btn d-none d-sm-block">
            <a href="<?php echo base_url(); ?>AR/Company_Departments" class="text-dark">
                                  ...
                                  <a href="<?php echo base_url(); ?>AR/users/changePhoto">
                                   ...
                                   <h5 class="font-size-15 mt-3" style="position: relative;top: -42px;margin: 0px;">
                                      ...
                                      <?php  
                                        ...
                                        <div class="form-group">
                                        <a class="" href="<?php echo base_url(); ?>AR/users/ResetMyPassword">
											تحديث كلمة السر	
										</a>      
                                        </div> 
...
$( "#ResetUsername" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>AR/users/DepUserupdate?type="Company"',
