...
<div class="col-lg-12">
                                    ...
                                    <div class="card text-center">
                                        ...
                                        <div class="btn-group" role="group">
                                            <?php if ($survey['answers_counter'] > 0) { ?>
                                                <a href="<?= base_url("EN/Company_Departments/survey_reports/" . $survey['survey_id']); ?>" class="btn btn-outline-light text-truncate"><i class="uil uil-notes mr-1"></i>Reports</a>
                                            <?php } ?>
                                            <a href="<?= base_url("EN/Company_Departments/survey_preview/" . $survey['survey_id']); ?>" target="_blank" class="btn btn-outline-light text-truncate"><i class="uil uil-eye mr-1"></i> Preview </a>
                                        </div>
                                    </div>
                                </div>
                            <?php } ?>
    ...
    <?php foreach ($supported_types as $type) { ?>
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 045 DATA FREQUENCY OF <?= $type['typeKey'] ?></h4>
