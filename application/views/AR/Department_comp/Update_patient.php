...
<body class="light menu_light logo-white theme-white">
     ...
     <?php $Positions  = $this->db->query("SELECT * FROM `r_positions`")->result_array(); ?>
     </head>
     <style>
          ...
          <div class="page-content">
               <div class="row">
                    <div class="col-xl-12">
                         <div class="">
                              <div class="card-body">
                                   <h4 class="card-title" style="background: #B2F306;padding: 10px;color: #1E1E1E;border-radius: 4px;">تعديل </h4>
                                   ...
                                   <div class="col-md-12 formcontainer" id="staff">
                                                       ...
                                                       <div class="card">
                                                            <div class="card-body">
                                                                 <div class="row">
                                                                      <div class="col-md-2" style="margin-bottom: 11px;">
                                                                           ...
                                                                           <select class="custom-select" id="Prefix" name="Prefix">
                                                                                <option value="<?= $stuffdata['currentType'] ?>"><?= $stuffdata['CurrentTrans_UserType'] ?></option>
                                                                 ...
                                                                 <div class="row">
                                                                      ...
                                                                      <div class="col-sm-4">
                                                                           <div class="form-group">
                                                                                <label for="validationCustom01">الإسم الأول بالعربي</label>
                                                                 ...
                                                                 <div class="row">
                                                                      <div class="col-md-6" style="margin-bottom: 11px;">
                                                                           <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control" id="validationCustom02" placeholder="الرقم الوطني" value="<?= $stuffdata['National_Id'] ?>" placeholder="Sorry You Can't Change The National Id  ): " data-toggle="tooltip" data-placement="top" title="" data-original-title=" نعتذر لا يمكنك تغيير هذا الحقل " readonly>
                                                                                <div class="valid-feedback">
                                                                                     جيد
                                                                                </div>
                                                                           </div>
                                                                      ...
                                                                      <div class="col-md-6" style="margin-bottom: 11px;">
                                                                           <div class="form-group">
                                                                                ...
                                                                                <select class="custom-select" name="Nationality">
                                                                                     ...
                                                                                     <?php $contriesarray = $this->db->query("SELECT * FROM `r_countries`
                                                                      ...
                                                                      <div class="col-md-6" style="margin-bottom: 11px;">
                                                                           <div class="form-group">
                                                                                ...
                                                                                <select name="Position" class="custom-select">
                                                                                     <option value="<?= $stuffdata['Position'] ?>"><?= $stuffdata['CurrentTrans_Position'] ?></option>
                                                                                     <?php foreach ($positions as $position) { ?>
                                                                                          <option value="<?= $position['Position'] ?>" class="option"> <?= $position['AR_Position'] ?> </option>
                                                                                     <?php } ?>
                                                                                </select>
                                                                                <div class="valid-feedback">
                                                                                     جيد
                                                                      ...
                                                                      <div class="col-md-6" style="margin-bottom: 11px;">
                                                                           <div class="form-group">
                                                                                <label> الإيميل </label>
                                                                                <input type="email" class="form-control" id="validationCustom02" placeholder="الإيميل" name="Email" required="" value="<?= $stuffdata['Email'] ?>">
                                                                                <div class="valid-feedback">
                                                                                     جيد
                                                                                </div>
                                                                           </div>
                                        ...
                                        <div style="margin-top: 10px;">
                                             <button class="btn btn-primary" id="staffsub" type="Submit">تعديل</button>
     ...
     <script>
          ...
          $("#UpdateMemberData").on('submit', function(e) {
               ...
               $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>AR/Company_Departments/UpdatePatient',
          ...
          $('#back').click(function() {
               location.href = "<?= base_url() . "AR/Company_Departments"; ?>";
          });
