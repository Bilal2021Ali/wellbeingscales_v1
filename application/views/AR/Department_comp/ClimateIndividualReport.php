    ...
    <div class="page-content">
                        ...
                        <tbody>
                            <?php foreach ($users as $key => $user) { ?>
                                <tr>
                                    ...
                                    <td><?= $user['userName'] ?></td>
                                    <td><?= $user['UserType'] ?></td>
                                    <td><a href="<?= base_url('AR/Company_Departments/ClimateIndividualReport/' . $user['Id']) ?>" class="btn btn-primary">View<i class="uil uil-arrow-right"></i></a></td>
                                </tr>
                            <?php } ?>
                        </tbody>
                    </table>
        ...
        <?php } else { ?>
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0"><img class="avatar-xs rounded-circle mr-1" src="<?= base_url("uploads/co_avatars/") . ($full_user_data['Avatar'] !== "" ? $full_user_data['Avatar'] : 'default_avatar.jpg') ?>" alt=""><span class="userdata"><?= $full_user_data['userName'] ?></span></h4>
                <div class="page-title-right">
                    <a href="<?= base_url("AR/Company_Departments/ClimateIndividualReport"); ?>" class="btn btn-primary">Back <i class="uil uil-arrow-right"></i></a>
                </div>
            </div>
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="card" style="background: url('<?= base_url("assets/images/schoolDashboard/teacher02.png") ?>');background-position: center;background-repeat: no-repeat;background-size: cover;border-color: #ffffff">
                                <div class="card-body">
                                    ...
                                    <div>
                                        ...
                                        <h4 class="mb-1 mt-1 text-white"><span data-plugin="counterup" class="mt-2"><?= $results['calories'] ?></span> Khal</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body pt-3">
                            <div class="row">
                                <div class="col text-center">Weight <p><b><?= $results['weight'] ?></b></p>
                                </div>
                                <div class="col text-center">Height <p><b>100</b></p>
                                </div>
                                <div class="col text-center">Goal <p><b>12</b></p>
                                </div>
                            </div>
                ...
                <div class="col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title">Calories Counter:</h3>
                            <div class="row">
                                <div class="col-4" style="display: grid;justify-items: center;justify-items: center;">
                                    <div style="height: 80px;">
                                        <p class="mb-0"><b>Eaten</b> :</p>
                                        <span>1230 kcal</span>
                                        <p class="mb-0 mt-1"><b>Burned</b> :</p>
                                        <span>430 kcal</span>
                                    </div>
                                </div>
                                <div class="col-8">
