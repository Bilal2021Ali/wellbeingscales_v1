...
<body>
    <div class="main-content">
        <div class="page-content">
            ...
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH P009: Generate Category Report</h4>
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="table-responsive mb-0" data-pattern="priority-columns">
                                <table class="table">
                                    <thead>
                                        ...
                                        <th>Survey Counter</th>
                                        <th class="text-center">List of Surveys</th>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($categorys as $key => $category) : ?>
                                            <tr id="cat_<?= $key; ?>">
                                                <td><?= $key + 1 ?></td>
                                                <td>
                                                    <a href="<?= base_url('EN/Company-Departments/categorys-reports/' . $category['Id']) ?>">
            ...
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 036: Generate Survey Report</h4>
            <?php $this->load->view("EN/Department_comp/inc/question_categories", [
                "link" => "questions_reports",
                "isqreport" => false,
            ]); ?>
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 037: Generate Survey Report</h4>
            <?php $this->load->view("EN/Department_comp/inc/question_categories", [
