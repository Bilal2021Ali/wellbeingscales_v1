                            ...
                            <form id="AddDevice">
                                <div id="checkout-billinginfo-collapse" class="collapse show">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        <div class="col"> <a href="<?= base_url(); ?>AR/Company_Departments/" class="btn btn-link text-muted"> <i class="uil uil-arrow-right mr-1"></i> Cancel </a> </div>
                                        <div class="col">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="p-3 bg-light mb-4">
                                ...
                                ?>
                                <h5 class="font-size-16 mb-0">List of Devices<span class="float-right ml-2"> <a href="<?= base_url(); ?>AR/Company_Departments/ListofDevices"> <?= sizeof($alldev); ?> </a> </span> </h5>
                            </div>
                            <!-- Nav tabs -->
...
<script>
    ...
    $('.update-device').click(function() {
        location.href = '<?= base_url("AR/Company_Departments/AddDevice"); ?>/' + $(this).attr('data-device-id');
    });
    ...
    $('.delete-device').click(function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>AR/Company_Departments/DeletDevice',
                    data: {
                        Conid: theId,
                    },
    ...
    $("#AddDevice").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>AR/Company_Departments/startAddDevice',
    ...
    $("#AddBatch").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>AR/Company_Departments/startAddBatch',
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData: false,
