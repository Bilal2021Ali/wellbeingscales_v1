...
<div class="main-content">
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Climate Survey List</h4>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#navtaprofile" role="tab">
                            ...
                            <span class="d-none d-sm-block">Your surveys</span>
                        </a>
                    </li>
                </ul>
                                    ...
                                    <tr id="serv_<?= $oursurvey['survey_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a data-toggle="tooltip" data-placement="top" title=""
                                               ...
                                               href="<?= base_url("AR/Company_Departments/climatePreview/" . $oursurvey['main_survey_id']); ?>"><i
