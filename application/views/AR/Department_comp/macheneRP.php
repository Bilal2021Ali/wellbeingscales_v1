    ...
    <div class="container-fluid"> 
      <div class="row">
        <div class="col-12">
          <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0"> الوسائط الحرارية </h4>
          </div>
        </div>
      </div>
	  <style>
      ...
      <div class="row formcontainer" id="Staff_list">
        <div class="col-12">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title"> لوحة متابعة الأجهزة </h4>
            </div>
            <div class="card-body">
                    <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#home1" role="tab" aria-selected="true">
                                ...
                                <span class="d-none d-sm-block">أجهزتكم</span> 
                            </a>
                        </li>
                        <li class="nav-item" data-toggle="tooltip" data-placement="top"
                            data-original-title="<?php echo empty($acceses) ? "آسف ليس لديك وصول إلى أي جهاز" : ""; ?>">
                            <a class="nav-link <?php  echo empty($acceses) ? "disabled" : "";  ?>"
                            data-toggle="tab" href="#profile1" role="tab" aria-selected="false">
                                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                <span class="d-none d-sm-block">أجهزة لديكم حق الوصول لها</span> 
                            </a>
                        </li>
                    </ul>
                          ...
                          style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                              ...
                              <tr>
                                ...
                                <td class="standard"><span  class="badge good" style="width: 100%;border-radius: 10px;">
                                    <?php  echo $data['device_type'];  ?><br><p>الطبيعي</p></span></td>
                                </tr>
                              <?php  }  ?>	  
                              </tbody>
                          </table>
                        ...
                        <div class="tab-pane" id="profile1" role="tabpanel">
                                  ...
                                  <tr>
                                    ...
                                    <td class="standard">
                                        <span  class="badge good" style="width: 100%;border-radius: 10px;">
                                            <?php  echo $refrig['device_type'];  ?><br><p>الطبيعي</p>
                                        </span>
                                    </td>
                            ...
                            <?php  }else{  ?>
                                <div class="row text-center">
                                    <h3 style="margin: auto;" class="mt-2">آسف ليس لديك وصول إلى أي جهاز</h3>
                                </div>
                            <?php  }  ?>
                        </div>
                    </div>
