...
WHERE `air_result_gateway`.`User_type` = 'Company_Department' 
...
<body>
            ...
            <?php if (!empty($data)) {  ?>
                <div class="container-fluid">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="uil uil-circuit"></i>معلومات جهاز جودة الهواء التفصيلية</h4>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" data-toggle="tab" href="#home1" role="tab">
                                                    ...
                                                    <span class="d-none d-sm-block">اليوم</span> </a>
                                            </li>
                                            <li class="nav-item" onClick="getweekly()"> <a class="nav-link" data-toggle="tab" href="#getweekly" role="tab"> <span class="d-block d-sm-none"><i class="far fa-user"></i></span> <span class="d-none d-sm-block">هذا الأسبوع</span> </a> </li>
                                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#messages1" role="tab"> <span class="d-block d-sm-none"><i class="far fa-envelope"></i></span> <span class="d-none d-sm-block">تاريخ محدد</span> </a> </li>
                                        </ul>
                                        <div class="tab-content p-3 text-muted">
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                <form id="Daily">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control bs-timepicker" placeholder="من" id="Daily_from" required length="5" autocomplete="off">
                                                        </div>
                                                        <div class="col-lg-6">
                                                            <input type="text" class="form-control bs-timepicker" placeholder="إلى" id="Daily_to" required length="5" autocomplete="off">
                                                        </div>
                                                    </div>
                                                    <div class="row pl-2 pr-2">
                                                        <button type="Submit" class="btn btn-primary waves-effect w-100" data-toggle="tooltip"> إعرض النتائج <i class="uil uil-angle-down"></i></button>
                                                    </div>
                                                </form>
                                            </div>
                                            ...
                                            <div class="tab-pane" id="messages1" role="tabpanel">
                                                <form id="specific_date">
                                                    <div class="input-daterange input-group" data-provide="datepicker" data-date-format="yyyy-mm-dd" data-date-autoclose="true">
                                                        <input type="text" class="form-control" placeholder="من" name="Start" autocomplete="off" id="specific_date_from" required>
                                                        <input type="text" class="form-control" placeholder="إلى" name="End" autocomplete="off" id="specific_date_to" required>
                                                    </div>
                                                    <div class="row pl-2 pr-2">
                                                        <button type="Submit" class="btn btn-primary waves-effect w-100" data-toggle="tooltip" data-placement="bottom" title="" إعرض النتائج <i class="uil uil-angle-down"></i></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-lg-9">
                            <div class="card">
                                <div class="card-body">
                                    <p class="card-title-desc"> الرسم البياني </p>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h3 class="card-title text-center">
                                        ...
                                        الأنواع <i class="uil uil-setting show_settings" style="float:right;" title="الإعدادات"></i>
                                        <hr>
                                    </h3>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-center">
                            ...
                            <h4 class="text-uppercase mt-4"> لاتوجد معلومات </h4>
                            <p class="text-muted"> نعتذر لاتوجد بيانات للعرض </p>
                        </div>
                    </div>
                </div>
            <?php  }  ?>
    ...
    <section>
        <div id="PopoverContent" class="d-none">
            <div class="input-group">
                <input type="number" class="form-control" placeholder="أقصى حد" id="MaxVal" min="3" max="6" onChange="setNewVal(this.value)">
            </div>
        </div>
    </section>
    ...
    <script>
            ...
            tooltip: {
                x: {
                    formatter: function(value, {
                        ...
                        return cotigories[dataPointIndex];
                    }
                }
            },
            /*
            ...
            json_data.map(data_json => {
                switch (val) {
                    case "humidity":
                        ...
                        categories_arr.push(typeOfgatig == 'time' ? data_json.time : formatDate(data_json.TimeStamp));
                        break;
                    case "dewpoint_c":
        ...
        function formatDate(date) {
            var d = new Date(date);
            var f_date = (d.getFullYear().toString().padStart(4, '0')) + '-' + (d.getMonth() + 1).toString().padStart(2, '0') + '-' + (d.getDate().toString().padStart(2, '0')) + ' ' + d.getHours().toString().padStart(2, '0') + ':' + d.getMinutes().toString().padStart(2, '0') + ':' + d.getSeconds().toString().padStart(2, '0');
            console.log('f date is  :' + f_date);
            return f_date;
        }
        ...
        function drawChart() {
            ...
            for (i = 0; i < vals.length; i++) {
                ...
                //2018-09-19T02:30:00
                returned.categories_arr.map(returneddate => {
                    cotigories.push(returneddate);
                });
