                        ...
                        <div>
                            ...
                            <div class="card">
                                <div class="card-body p-4"> 
                                   ...
                                   <?php } ?>
                                   <h6 class="text-primary" style="position: relative;top: -33px;" id="Toast"> مرحبا </h6>
                                   </div>
                                      <form id="AddPhoto" style="margin-top: -50px;">
                                            ...
                                            <div class="mt-3 text-right">
												...
												type="Submit" id="sub"> تحديث </button>
                                            </div>
...
$( "#AddPhoto" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>AR/users/UpladeImgsForMember_Co',
