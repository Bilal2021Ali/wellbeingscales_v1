...
<head>
    ...
    <link href="<?php echo base_url(); ?>assets/css/app-rtl.css" rel="stylesheet" type="text/css" />
</head>
<?php
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">
                            التقرير حسب الفترة الزمنية لكل مستخدم - نتائج فحوصات درجات الحرارة - <?php echo $sessiondata['f_name'] ?>
                        </h4>
                    </div>
                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="control-label">إختر اسم المستخدم</label>
                                                <select class="form-control select2" name="User">
                                                    <?php if (!empty($staffs_of_this_school)) {  ?>
                                                        <optgroup label="الموظفين">
                                                            <?php foreach ($staffs_of_this_school as $staff) { ?>
                                                                <option value="<?php echo $staff['UserType'] ?>,<?php echo $staff['Id'] ?>,<?php echo $staff['F_name_AR'] . " " . $staff['M_name_AR'] . " " . $staff['L_name_AR'] ?>">
...
<script>
    ...
    $("#getData").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/Ajax/GetDataSchoolMonthResults?type="dept"',
