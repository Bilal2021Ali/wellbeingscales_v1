        ...
        <div class="col-lg-8 offset-lg-2 mt-5">
            <div class="card">
                <div class="card-body">
                    ...
                    <button class="btn btn-primary btn-block go" disabled>حفظ(للمعاينة)</button>
                </div>
            </div>
        </div>
    </div>
