        ...
        <div class="card" style="border: 0px">
          <div class="card-body p-4">
            ...
            <form id="servey_creat">
              <h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;"> 0001: Select category name</h4>
              <div class="row">
                <div class="col-lg-12">
              ...
              <h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;"> 0002: Select climate set name</h4>
              <div class="form-group">
              ...
              <h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;"> 0003: Select one question</h4>
              ...
              <h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;"> 0005: Select mobile style</h4>
              <div class="form-group">
              ...
              <h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;"> 0006: Select targeted account type</h4>
              <div class="form-group">
              ...
              <h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;"> 0007: Select targeted account</h4>
              <div class="form-group" id="ministriesAccounts"> <span class="float-right text-primary btn s-all" data-target-select="targetedaccounts[]">Select all</span>
              ...
              <div class="form-group" id="CompaniesAccounts"> <span class="float-right text-primary btn s-all" data-target-select="targetedaccounts[]">Select all</span>
              ...
              <div class="p-2 mt-4">
                ...
                <a href="<?= base_url() . "EN/Dashboard"; ?>" class="btn btn-light btn-sm btn-block waves-effect waves-light" style="display: block">Cancel</a> </div>
            </form>
          </div>
        </div>
      </div>
