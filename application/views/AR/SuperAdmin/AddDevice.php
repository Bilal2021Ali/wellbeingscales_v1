                            ...
                            <form id="AddDevice">
                                <div id="checkout-billinginfo-collapse" class="collapse show">
                                    ...
                                    <div class="row" style="padding: 10px;">
                                        <div class="col">
                                            <a href="<?php echo base_url(); ?>AR/schools/" class="btn btn-link text-muted">
          ...
          WHERE Added_By = '" . $sessiondata['admin_id'] . "' AND `UserType` = 'school' AND `Comments` = 'Gateway' ")->result_array();
                                ...
                                <h5 class="font-size-16 mb-0">List Of Devices
                                    <span class="float-right ml-2">
                                        <a href="<?php echo base_url(); ?>AR/schools/ListofDevices">
...
<script>
    $("#AddDevice").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/schools/startAddDevice',
    ...
    $("#AddBatch").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>AR/schools/startAddBatch',
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData: false,
