...
<div class="main-content">
  <div class="page-content">
    ...
    <br>
	<h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 33333: إضافة جهاز جديد - قائمة الأجهزة</h4>
    <div class="row">
          ...
          <div class="card-body" style="background-color: #3df0f0;padding: 5px">
            <div class="card-body" style="background-color: #022326;">
              <div class="float-right mt-2"> 
                ...
                <img src="<?= base_url(); ?>assets/images/icons/png_icons/adddevicescounter.png" alt="schools" width="64px"> </div>
              <div>
                <?php
...
?>
    ...
    <div class="row">
      <div class="col-xl-8">
        <br>
		<h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 017:
              ...
              <div id="checkout-billinginfo-collapse" class="collapse show">
                <div class="p-4 border-top">
                  <div>
                    <div class="row">
									  <div class="col-lg-6">
										<div class="form-group"><br><h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">عنوان MAC للجهاز</h4>
										  <input id="input-ip" class="form-control input-mask" value="<?=$device_data["D_Id"]??"" ?>" placeholder="عنوان MAC للجهاز" data-inputmask="'alias': 'mac'" name="Device_Id" im-insert="true">
										</div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-lg-6">
                        <div class="form-group mb-4">
                          <label for="billing-name">وصف الموقع بالإنجليزي</label>
                          <input type="text" value="<?=$device_data['Description']??""; ?>" class="form-control" placeholder="وصف الموقع بالإنجليزي" name="Description">
                        </div>
                      </div>
                    </div>
                    <div class="row" style="padding-top: 10px;">
                      <div class="col-lg-6">
                        <div class="form-group mb-4">
                          ...
                          <select name="Site_ar" class="form-control custom-select">
                            <?php foreach ($r_sites as $site) { ?>
                            <option value="<?=$site["Description_ar"] ?>" <?=isset($device_data["Description"]) ? ($device_data["Description"] == $site["Description"] ? "selected" : "") : "" ?>>
                            <?=$site["Description_ar"] ?>
                            </option>
                            <?php
                            }
                      ...
                      <div class="col-6">
                        <label for="car_id">اختيار المركبة</label>
                ...
                <div class="row" style="padding: 10px;">
                  ...
                  <div class="col">
                    <div class="text-sm-right mt-2 mt-sm-0">
                      ...
                      <?=isset($device_data['Id']) ? "تحديث" : "إضاف" ?>
                      </button>
                    </div>
                  </div>
                </div>
      ...
      <div class="col-xl-4">
        <br><h4 class="card-title" style="background: linear-gradient(190deg, #7358a3 0%, #7dbce3 100%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 018: قائمة الأجهزة المضافة / نوع الجهاز</h4>
        <div class="card">
          <div class="card-body">
