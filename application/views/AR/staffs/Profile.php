                    ...
                    <div class="row">
                        <div class="col-lg-3 user_bar">
                            ...
                            <div class="content mt-10 text-center" data-pattern="priority-columns" data-simplebar="init">
                                ...
                                <div class="container">
                                <div class="container">
                                    <button type="button" class="btn btn-link waves-effect font-size-12 float-right showEdite mt-3">التعديل</button>
                                    <hr class="d-block">
                                </div>
                                <form action="" class="needs-validation custom-validation" id="edite_my_data" novalidate>
                                    ...
                                    <div class="form-group">
                                        <label for="m_n" class="float-left">اللاسم الأوسط بالانجليزي:</label>
                                    ...
                                    <div class="form-group group-ar">
                                        <label for="m_n_a" class="float-left">الاسم الأوسط بالعربي:</label>
                                    ...
                                    <div class="form-group">
                                        <label for="lem" class="float-left">الإيميل:</label>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data == "ok") {
                    ...
                    Swal.fire({
                        title: "نعتذر",
                        text: 'المرجو منكم التحقق من المدخلات',
                        icon: 'error',
                        confirmButtonColor: '#5b8ce8'
                    });
                }
            ...
            ajaxError: function() {
                Swal.fire({
                    title: "نعتذر",
                    text: 'لقد واجهنا خطأ غير متوقع في معالجة هذا الطلب',
                    icon: 'error',
                    confirmButtonColor: '#5b8ce8'
                });
            }
