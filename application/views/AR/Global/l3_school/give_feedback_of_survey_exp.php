                        ...
                        <fieldset>
                            ...
                            <div class="fieldset-flex">
                                ...
                                <div class="fieldset-content">
                                    <h2>ما رأيك في الخدمات؟</h2>
                                    <div class="form-flex">
                                        <label for="rating_quanlity">موضوع الاستبيان</label>
                                    ...
                                    <div class="form-flex">
                                        <label for="rating_use">سهولة فهم الأسئلة</label>
                                        <div class="form-rating">
                                    ...
                                    <div class="form-flex">
                                        <label for="rating_features">سهولة فهم الخيارات</label>
                                        <div class="form-rating">
                                    ...
                                    <div class="form-flex">
                                        <label for="rating_features">سهولة التفاعل مع الاستبيان<br> (وضوح الأزرار ...)</label>
                                        <div class="form-rating">
                            ...
                            <div class="fieldset-flex">
                                ...
                                <div class="fieldset-content">
                                    <div class="form-textarea">
                                        <label for="your_review" class="form-label">مراجعتك (خياري)</label>
                                        <textarea name="your_review" id="your_review" placeholder="أكتب تعليقك هنا"></textarea>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <fieldset>
                            ...
                            <div class="fieldset-flex">
                                ...
                                <div class="fieldset-content text-center" style="display: grid;align-items: center;">
                                    <h6>شكرا جزيلا على وقتك </h6>
                                    <p>نحن نقدر الوقت الذي قضيته في إبداء رأيك ، يمكنك الضغط على زر إرسال لتلقي آرائك المحترمة ، أو العودة للتحقق منها وتصحيحها إذا أردت ، خذ وقتك 🖤</p>
                                </div>
                            </div>
                        </fieldset>
                    </form>
