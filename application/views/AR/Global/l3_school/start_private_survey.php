<div class="main-content">
    <div class="page-content">
        ...
        <form id="my_answers" token="<?= md5(time()); ?>" method="post" class="custom-validation">
            <div class="row">
                <div class="container">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <h3><?= $sessiondata['username'] ?></h3><br>
                                        <p class="text-muted col-12 p-0">مرحبا بكم في هذا الاستطلاع</p>
                                        <span>
                                            <div class="custom-control custom-checkbox mb-4">
                                                <input type="checkbox" name="showname" checked class="custom-control-input" id="horizontal-customCheck">
                                                <label class="custom-control-label" for="horizontal-customCheck">أظهر اسمي مع النتائج</label>
                                            </div>
                                        </span>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 ">
                        <div class="card">
                            <div class="card-body">
                                            ...
                                            <?php foreach ($questions as $question_key => $question) { $questions_counter++; ?>
                                                <div class="card">
                                                    <div class="card-body quastions-title">
                                                        <h3 class="card-title"><?= $questions_counter ?> . <?= ucfirst(strtolower($question['ar_title'])) ?></h3>
                                                        <hr>
                                                        <input type="text" autocomplete="off" data-parsley-minlength="3" data-parsley-maxlength="50" name="answers[<?= $question['q_id'] ?>]" required class="form-control" placeholder="الإجابة....">
                                ...
                                <button class="btn btn-primary waves-effect waves-light" type="Submit"> إبعث الأجوبة  </button>
                            </div>
                        </div>
                    </div>
                </div>
