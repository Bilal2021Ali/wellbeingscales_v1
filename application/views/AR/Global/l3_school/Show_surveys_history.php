...
<body>
    <div class="main-content"> 
		...
		<h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">الإستبيانات المنتهية</h4>					  
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="card notstatic">
                        <div class="card-body">
                            <h4 class="card-title mb-5">عرض الإستبيانات</h4>
                                    ...
                                    <div class="privateSurvey">
                                        <ul class="verti-timeline list-unstyled">
                                            ...
                                            <li class="event-list">
                                                ...
                                                <h5><?php echo $survey['Title_ar']; ?><span class="badge rounded-pill bg-soft-danger font-size-12 text-danger ml-2">الإستبيانات الخاصة</span><span class="text-muted font-size-10 float-right"><?php echo $expred ?></h5>
                            ...
                            <?php }else{ ?>
                                ...
                                <h3 class="w-100 text-center">لم تملأ أي استبيانات.</h3>
                            <?php } ?>
                        </div>
                    </div>
                </div>
