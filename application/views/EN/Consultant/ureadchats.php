<div class="main-content">
    <div class="page-content">
        <div class="chat-message-list card">
            <div class="card-body">
                <h3 class="card-title mb-3">Unread Messages :</h3>
                <?php if (!empty($chats)) { ?>
                                ...
                                <a href="<?= base_url("EN/Consultant/chat/") . $chat['Report_Id']; ?>">
                                    <div class="d-flex align-items-start">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden">
                                            ...
                                            <p class="text-truncate mb-0">Replied About <span class="text-primary link" data-link="<?= $chat['link'] ?>">This Report</span></p>
                                        </div>
                ...
                <?php }else{ ?>
                    <div class="container text-center mt-5">
                        ...
                        <h3 class="text-primary mt-4">No Messages Here to show !</h3>
                    </div>
                <?php } ?>
            </div>
        </div>
