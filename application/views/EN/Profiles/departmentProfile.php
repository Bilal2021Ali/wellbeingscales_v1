          ...
          <div class="page-content">
               <div class="row">
                    <div class="col-xl-12">
                         <div class="">
                              <div class="card-body">
                                   <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">Department Profile</h4>
                                   <div class="alert alert-border alert-border-secondary alert-dismissible fade show" role="alert">
                                        <span id="Toast">Check The Data </span>
                                   ...
                                   $schoolData = $this->db->query("SELECT * FROM l1_department 
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom01" placeholder="Deptment Name AR" 
                                                        value="<?php echo $data['Dept_Name_AR'] ?>" name="Dept_Name_AR" required="">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom02" placeholder="Deptment Name EN" name="Dept_Name_EN"
                                                       value="<?php echo $data['Dept_Name_EN'] ?>" required="">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
													    ...
													    placeholder="Manager Arabic Name"
                                                        value="<?php echo $data['Manager_AR'] ?>" name="Manager_AR" required="">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom02" placeholder="Manager English Name" name="Manager_EN"
                                                        value="<?php echo $data['Manager_EN'] ?>" required="">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
...
<?php $citiesarray = $this->db->query('SELECT * FROM `r_cities` ORDER BY `Name_EN` ASC')->result_array();     ?>
                                             ...
                                             <div class="col-md-6">
                                               ...
                                               <select name="Type" class="custom-select">
                                                 <option value="Privat" class="option" >privat</option>
     ...
     <input type="text" class="form-control" id="validationCustom02" placeholder="Write User Nam" name="Username" required="" value="<?php echo $data['Username'] ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <tbody>
                                                  <?php foreach($Patients as $patient){ ?>   
                                                    <tr id="PERM<?php echo $patient['Id']; ?>">
                                                        ...
                                                        <td>                                                           
                                             <i class=" bx bxs-trash-alt delet" theId="<?php echo $patient['Id'];  ?>" TypeOfuser="Stuff"></i></td>
                                                    </tr>
                                                     <?php } ?>
                                                </tbody>
                                            </table>                                             
...
$("#UpdateSchool").on('submit', function (e) {
     ...
     $.ajax({
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Departments/startUpdatingdepartment',
...
$("#addpermition").on('submit', function (e) {
     ...
     $.ajax({
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Departments/startAddPermition',
          data: new FormData(this),
          contentType: false,
          cache: false,
          processData: false,
...
Swal.fire({
 ...
 $.ajax({
     type: 'POST',
     url: '<?php echo base_url(); ?>EN/Departments/DeletPermition',
     data: {
      Conid: theId,
