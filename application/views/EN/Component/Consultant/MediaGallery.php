<div class="main-content">
    <div class="page-content">
        ...
        <div class="col-lg-12">
            <br>
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 059 WELLNESS EDUCATION RESOURCES </h4>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
