...
<style>
          ...
          <div class="page-content">
               <div class="row">
                    <div class="col-xl-12">
                         <div class="">
                              <div class="card-body">
                                   <h4 class="card-title" 
								   style="background: #B2F306;padding: 10px;color: #1E1E1E;border-radius: 4px;">Update</h4>
                                   <div class="alert alert-border alert-border-secondary alert-dismissible fade show" role="alert">
                                        <span id="Toast">Modify Information </span>
              ...
              <input type="text" value="<?php echo $code['Site_Code']." - ".$Site_name; ?>" readonly class="form-control" >              
               <?php   }  ?>
                                        ...
                                        <button class="btn btn-primary" id="StudentSub" type="Submit">Update</button>
     ...
     <script>
          ...
          $( "#UpdateSiteData" ).on( 'submit', function ( e ) {
               ...
               $.ajax( {
                    type: 'POST',
                    url: '<?php echo base_url(); ?>EN/Company_Departments/StartUpdateSite',
