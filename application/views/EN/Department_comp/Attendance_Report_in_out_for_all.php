...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">
                            Report by time period for all users - attendance and departure - <?php echo $sessiondata['f_name'] ?>
                        </h4>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label>Choose the search date from - to</label>
                                    <div>
    ...
    <script>
        $("#getData").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>EN/Ajax/Attendence_in_of_all_co',
