...
<div class="row">
    ...
    <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">
						          Attendance Report -  <?php echo $sessiondata['f_name'] ?>
							</h4>
    </div>
</div>
...
?>
                                   <div class="control col-md-12" style="padding: 10px;">
                                        <button type="button" form_target="searchbydevice" class="btn btn-primary w-md contr_btn">
                                             </i>Search by Device / Site of Temperature Measurement
                                        </button>
				...
				<div class="container formcontainer" id="searchbydevice">
                    ...
                    <div class="card">
                         ...
                         <div class="row">
                         <div class="col-xl-12">
                         <label>Choose Temperature Device / Site</label>
...
function GetDataForUser(){
	var name = $('#name').val();
      $.ajax({
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Results/getResultsbyname_co',
          data: {
            name : name,    
          },
          beforeSend: function() {
