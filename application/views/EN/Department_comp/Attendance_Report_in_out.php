...
<body>
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">
                            Report by Time Period for Each User - Attendance and Departure <?php echo $sessiondata['f_name'] ?>
                        </h4>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label>Choose Date Range From - To </label>
                                    <div>
    ...
    <script>
        $("#getData").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>EN/Ajax/Attendence_in_of',
