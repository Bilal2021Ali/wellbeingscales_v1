...
<body class="light menu_light logo-white theme-white">
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;">
                Add System Users, Sites to be Monitored, and Thermal Tracking Devices - <?= $sessiondata['f_name'] ?>
            </h4>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="float-right">
                                                    <a href="<?= base_url(); ?>EN/Company_Departments/LoadFromCsv">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" class="form-control" data-provide="datepicker" data-date-autoclose="true" data-date-format="dd-m-yyyy" placeholder="DD-MM-YYYY" name="DOP">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <select style="width: 100%;display: block;height: 50px;" class="form-control select2" name="Site">
                                                                ...
                                                                ?>
                                                                    <option value="<?= $site['Site_Name'];  ?>"> <?= $site['Site_Code'] . ' - ' . $site['Site_Name']; ?> </option>
                                                                <?php  } ?>
                                                            </select>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <input type="text" data-inputmask="'alias': 'mac'" class="form-control input-mask" placeholder="Mac Adress" name="name">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group mb-4">
                                                            ...
                                                            <select name="type" class="form-control">
                                                                <?php foreach ($types as $type) { ?>
                                                                    <option value="<?= $type['Id'] ?>">
                                                                        <?= $type['device_name'] . "  (" . $type['min_temp'] . "," . $type['max_temp'] . ")" ?>
                                                                    </option>
                                                                <?php } ?>
                                                            </select>
                                                        </div>
    ...
    <script>
        ...
        $("#Addpatient").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url(); ?>EN/Company_Departments/startAddpatient',
        ...
        $("#AddSite").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url(); ?>EN/Company_Departments/startAddSite',
                data: new FormData(this),
                contentType: false,
                cache: false,
                processData: false,
        ...
        $("#Addmachine").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url(); ?>EN/Company_Departments/startAddMachine',
                data: new FormData(this),
                contentType: false,
                cache: false,
                processData: false,
        ...
        <?php if (!empty($prms)) {  ?>
            $("#AddArea").on('submit', function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>EN/Company_Departments/startAddArea',
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
                    processData: false,
