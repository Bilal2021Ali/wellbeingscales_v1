                ...
                <div class="card">
                    ...
                    <?php if (!empty($climate_survyes)) {  ?>
                        ...
                        <div class="container-fluid mt-5">
                            <div class="row w-100 climate_survyes_list">
                                <?php foreach ($climate_survyes as $survey) { ?>
                                    <div class="climatesurvey <?= isset($Carousel) ? "item event-list mr-2" : "col-4" ?>" data-category-id="<?= $survey["Cat_id"]; ?>">
                                        <div class="card text-center">
                                            ...
                                            <a id="GaugeChart_action_<?= $prefix ?? "" ?>_<?= $survey['survey_id'] ?>" href="<?= base_url('EN/Company-Departments/climate-results-chart/' .$survey['survey_id']); ?>" class="w-100 btn btn-warning" style="border-radius: 0px;">Show Details <i class="uil uil-arrow-right"></i></a>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
