...
<body>
    ...
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 039: List of Results for Air Quality Devices
            </h4>
                        ...
                        ?>
                                <div class="tab-pane col-xl-12 col-xl-auto" id="Device<?=  $devices['device_id']  ?>" role="tabpanel">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4">
                                            <a href="<?= base_url() ?>EN/Company_Departments/Realtime_Dashboard/<?= $devices['Device_Mac']  ?>">
