...
ORDER BY `air_result_gateway`.`Id` ASC ")->result_array();
//print_r($data);	
?>
        ...
        <div class="page-content">
            <?php if (!empty($data)) {  ?>
                <div class="container-fluid">
                    ...
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="card">
                            <div class="card-body" style="background: #e6f9ff;border: 1px solid #0eacd8;border-radius: 5px;">
                                <div class="row">
                                    <div class="col-lg-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-types" data-simplebar="init">
                                        ...
                                        <div class="type" value="pm10">PM10</div>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        function getweekly() {
            json_data = $.parseJSON($.ajax({
                url: '<?php echo base_url() ?>EN/Ajax/gitDeviceResults',
                dataType: "json",
                async: false,
                type: 'POST',
                data: {
        ...
        $(".type").click(selected_types = selected_types, function() {
            ...
            if (selected_types.length <= (max - 1)) {
                ...
                Swal.fire({
                    position: 'top-end',
                    icon: 'error',
                    title: 'You have reached the maximum number of types per graph.',
