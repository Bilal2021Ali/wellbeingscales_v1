<!doctype html>
                                                ...
                                                <table class="table table-nowrap table-centered">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <label class="switch">
                                                                    <input type="checkbox" Perm="see_air_quality" class="give_permission" <?php echo $user['see_air_quality'] ? 'checked' : "" ?>>
                                                        ...
                                                        <tr class="hr">
                                                            ...
                                                            <td>
                                                                <h5 class="font-size-16 mb-1">Refrigerator</h5>
                                                                <p class="text-muted mb-2">For Showing Refrigerator Results</p>
                                                            </td>
                                                            <td>
                                                                <label class="switch">
                                                                    <input type="checkbox" Perm="see_refrigerator" class="give_permission" <?php echo $user['see_refrigerator'] ? 'checked' : "" ?>>
                                                                    <span class="slider round"></span>
                                                                </label>
                                                            </td>
                                                        </tr>
                            ...
                            <div class="col-lg-6 justify-content-center">
                                <div class="card ">
                                    <div class="card-body text-center __userData">
                                        <div class="">
                                            <img src="<?php echo base_url() . "uploads/co_avatars/" . ($avater !== "" ? $avater : 'default_avatar.jpg'); ?>" alt="" class="rounded-circle img-thumbnail avatar-lg">
                                            <h3 class="text-primary">
                                                <?php echo $user['F_name_EN'] . ' ' . $user['L_name_EN']  ?>
                                            </h3>
    ...
    <script>
        ...
        $('.give_permission').change(function() {
            var perm = $(this).attr('Perm');
            var status = $(this).val();
            changeThePermission(perm);
        });
        ...
        function changeThePermission(perm) {
            $.ajax({
                ...
                url: '<?php echo base_url(); ?>EN/Company_Departments/Permissions_user_edit',
                success: function(data) {
                    if (data == "ok") {
                        ...
                        Command: toastr["success"]('permition updated successfully', "success")
                    } else {
                        toastr.options = {
                            "closeButton": false,
                            "debug": false,
                        ...
                        Command: toastr["error"]('sorry we have error in Processing this request !!', "sorry !")
                    }
                }
            });
        }
