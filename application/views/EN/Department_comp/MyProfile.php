...
<body class="authentication-bg">
        ...
        <div class="home-btn d-none d-sm-block">
            <a href="<?php echo base_url(); ?>EN/Company_Departments" class="text-dark">
                                ...
                                <div class="card-body p-4"> 
                                  ...
                                  <a href="<?php echo base_url(); ?>EN/Users/changePhoto">
                                   ...
                                   <h5 class="font-size-15 mt-3" style="position: relative;top: -42px;margin: 0px;">
                                      ...
                                      <?php  
                                        $Useradta = $this->db->query("SELECT * FROM l1_co_department
										WHERE Id = '".$sessiondata["admin_id"]."' ")->result_array();  
                                        ...
                                        <div class="form-group">
                                        <a class="" href="<?php echo base_url(); ?>EN/Users/ResetMyPassword">
											Update password	
										</a>      
                                        </div> 
                                        <button class="btn btn-primary w-sm waves-effect waves-light btn-block"
										type="Submit" id="sub">update</button>                                      
                                        </form> 
                                         <?php } ?>
                                    </div>
                                </div>
...
$( "#ResetUsername" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Users/DepUserupdate?type="Company"',
          ...
          ajaxError: function () {
               ...
               $( '#Toast' ).html( "We apologize, we have a problem" );
          }
     } );
} );
</script>
