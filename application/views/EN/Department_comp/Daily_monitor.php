    ...
    <div class="main-content">
        <div class="page-content">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                    <h4 class="card-title" style="background: #07BFF3;padding: 10px;color: #1E1E1E;border-radius: 4px;"> Daily Monitor</h4>
                    </div>
                </div>
                <?php
                ...
                foreach ($tbl_prefix as $pref) {
                    $Staff_list[] = data_of_user($pref['Id'], $sessiondata);
                }
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <?php Blood_pressure($staffsRes['Blood_pressure_max'], $staffsRes['Blood_pressure_min'], $dialostics[1], $dialostics[2], "BloodPressure02.png" , $staffsRes['Blood_pressure_Date']); ?>
