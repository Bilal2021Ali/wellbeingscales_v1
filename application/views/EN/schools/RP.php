                                        ...
                                        <?php foreach ($Teacher_list as $TeacherResults) { ?>
                                            <tr>
											 ...
											 WHERE `For_User` = '" . $TeacherResults['Id'] . "' AND `Type_Of_User` = 'Teacher' LIMIT 1 ")->result_array();
                                                ...
                                                <td data-toggle="modal" data-target="#myModal" class="showmoreinfos" onClick="GetUserData('Teacher','<?php echo $TeacherResults['Id'] ?>')">
                                                    <h6 class="font-size-15 mb-1 font-weight-normal"> <?php echo $TeacherResults['Username']; ?></h6>
                                                    <p class="text-muted font-size-13 mb-0"><i class="mdi mdi-user"></i> <?= $this->schoolHelper->teacherClasses($TeacherResults['Id'] , true)  ?></p>
                                                </td>
