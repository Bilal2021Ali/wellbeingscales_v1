...
<div class="main-content">
    <div class="page-content">
        <div id="publish" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="publishLabel"
             aria-hidden="true">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select-survey-respondents select2 form-control select2-multiple"
                                        ...
                                        <div class="col-lg-12 mb-1">
                                            <label for="theme">Survey Theme:</label><span
        ...
        <div id="Fillable_publish" class="modal fade" tabindex="-1" role="dialog"
             aria-labelledby="Fillable_publishLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    <div class="modal-header">
                            ...
                            <div class="card-body">
                                <form id="fillablesurveyForm">
                                    <div class="row">
                                                ...
                                                <select class="select2 form-control select2-multiple"
                                                    ...
                                                    <optgroup label="Staff">
                                                        <?php foreach ($our_staff as $staff) { ?>
                                                            <option value="staff:<?= $staff['Id'] ?>"><?= $staff['F_name_EN'] . " " . $staff['L_name_EN'] ?>
                                                                (staff)
                                                            </option>
                                                        <?php } ?>
                                                    </optgroup>
                                                    <optgroup label="Teachers">
                                                        <?php foreach ($our_teachers as $teacher) { ?>
                                                            <option value="teacher:<?= $teacher['Id'] ?>"><?= $teacher['F_name_EN'] . " " . $teacher['L_name_EN'] ?>
                                                                (teacher)
                                                            </option>
                                                        <?php } ?>
                                                    </optgroup>
                                                    <optgroup label="Students">
                                                        <?php foreach ($our_student as $student) { ?>
                                                            <option value="student:<?= $student['Id'] ?>"><?= $student['F_name_EN'] . " " . $student['L_name_EN'] ?>
                                                                (student)
                                                            </option>
                                                        <?php } ?>
                                                    </optgroup>
                                                    <optgroup label="Parents">
                                                        <?php foreach ($our_parents as $parent) { ?>
                                                            <option value="parent:<?= $parent['Id'] ?>"><?= $parent['name_en'] ?>
                                                                (parent)
                                                            </option>
                                                        <?php } ?>
                                                    </optgroup>
                                        ...
                                        <div class="col-lg-12 mb-1">
                                            <label for="theme">select the theme please : </label><span
                                                    class="float-right badge badge-pill badge-primary btn noti-icon right-bar-toggle waves-effect">from here</span>
                                            <input type="text" value="not selected" class="form-control"
                                                   id="fillable_theme_title" readonly>
        ...
        <h4 class="card-title"
            ...
            CH P008: Wellbeing Management</h4>
        <div class="row mb-3">
        ...
        <div class="row mt2 real_wellness" id="home">
            <div class="col-lg-12"><br>
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CHW 035 School Wellbeing Home Page</h4>
                <div class="row">
                    <div class="col-12">
                            ...
                            <?php for ($i = 1; $i < 2; $i++) { ?>
                                <div class="col-lg-12 mt-1 <?= $i == 1 ? "" : "hidden" ?>" id="Home_img_<?= $i ?>">
                                    <div class="img-fluid" class="center">
                                        <img src="<?= base_url('assets/images/homeimages/S' . $i . '.png'); ?>" alt=""
                                             style="width: 75%;">
        ...
        <div class="row mt2 real_wellness" id="wellness">
            <?php $this->load->view('EN/schools/inc/wellness_tab') ?>
        </div>
        <div class="row mt2 real_wellness" id="manage_surveys">
            <div class="col-12">
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 055 Manage Surveys-Questionnaires and Assessments</h4>
            </div>
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <tr id="serv_<?= $st_survey['survey_id']; ?>">
                                        ...
                                        <td class="text-center">
                                                    <span data-toggle="tooltip" data-placement="top"
                                                          data-original-title="Show the survey questions">
                                                        <i class="uil uil-notes questions" data-toggle="modal"
                                                           data-target="#myModal"
                                                           group="<?= $st_survey['main_survey_id']; ?>"></i>
                                                    </span>
                                            <span data-toggle="tooltip" data-placement="top"
                                                  data-original-title="Publish this survey">
                                                        <i class="uil uil-eye-slash publish" data-toggle="modal"
                                                           data-target="#publish"
                                                           for_serv="<?= $st_survey['survey_id']; ?>"></i>
                                                    </span>
                                        </td>
                                    </tr>
                                <?php } ?>
                ...
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 056 Manage Surveys-Interview Guide</h4>
                <div class="card">
                    <div class="card-body">
                        <div class="table-responsive mb-0" data-pattern="priority-columns" data-simplebar="init">
                                        ...
                                        <td class="text-center">
                                                    <span data-toggle="tooltip" data-placement="top"
                                                        ...
                                                        <i class="uil uil-notes questions" data-toggle="modal"
                                                           ...
                                                           group="<?= $avalaible_fillable_survey['main_survey_id']; ?>"></i>
                                                    </span>
                                            <span data-toggle="tooltip" data-placement="top"
                                                  data-original-title="Publish this survey">
                                                        <i class="uil uil-eye-slash Fillable_publish"
                                                           data-toggle="modal" data-target="#Fillable_publish"
                                                           for_serv="<?= $avalaible_fillable_survey['survey_id']; ?>"></i>
                                                    </span>
                                        </td>
                                    </tr>
                                <?php } ?>
                                    ...
                                    <table class="table dt-responsive nowrap" id="sur_lib">
                                        ...
                                        <?php foreach ($expired_surveys as $key => $exp_survey) { ?>
                                            ...
                                            <tr id="serv_<?= $exp_survey['survey_id']; ?>">
                                                ...
                                                <td><?= $exp_survey["answers_counter"] ?></td>
                                                <td><?= $answers_count; ?></td>
                                                <td><?= $choices_count ?></td>
                                                <td class="text-center">
                                                            <span data-toggle="tooltip" data-placement="top"
                                                                ...
                                                                <i class="uil uil-notes questions" data-toggle="modal"
                                                                   data-target="#myModal"
                                                                   group="<?= $exp_survey['main_survey_id']; ?>"></i>
                                                            </span>
                                                </td>
                                            </tr>
                                        <?php } ?>
        ...
        <div class="row mt3 real_wellness" id="our_published_surveys">
            <div class="col-lg-12">
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 057 PUBLISHED SURVEYS </h4>
                <div class="row">
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="d-flex float-right justify-content-end p-2">
                            ...
                            <div class="card-body" id="surveys-list">
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                        ...
                                        foreach ($published_surveys_fillable as $i => $fillable_published_survey) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center"><i
                                                            class="uil uil-user showanswereuser btn font-size-20 text-primary"
                                                            title="show targeted users " data-toggle="modal"
                                                            data-target="#userspassedsurvey"
                                                            data-survey-id="<?= $fillable_published_survey['survey_id'] ?>"></i>
                                                </td>
                                                ...
                                                <td class="text-center"><?= $answers_count ?>
                                                    <span data-toggle="tooltip" data-placement="top"
                                                          data-original-title="Show the survey questions">
                                                                <i class="uil uil-notes questions" data-toggle="modal"
                                                                   data-survey-type="fillable" data-target="#myModal"
                                                                   group="<?= $fillable_published_survey['main_survey_id'] ?>"></i>
                                                            </span>
                                                </td>
                                                <td>
                                                    <input type="checkbox" id="pub_sur_unfi_<?= $i ?>"
                                                           onchange="publishedsurveyStatusChanger(<?= $fillable_published_survey['survey_id'] ?>)"
                                                           switch="success" <?= $published_survey['status'] == 1 ? "checked" : "" ?> />
                                                    <label for="pub_sur_unfi_<?= $i ?>" data-on-label="on"
        ...
        <div class="modal fade zoom-in" id="userspassedsurvey" tabindex="-1" role="dialog"
             aria-labelledby="userspassedsurveyModalLabel" aria-hidden="true">
        ...
        <script>
            $('body').on('click', '.showanswereuser', function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>EN/schools/published_surveys_control',
                    data: {
                        survey_id: survey_id,
        ...
        <div class="row mt3 real_wellness" id="action_planes">
            ...
            <div class="col-lg-12">
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 059 WELLNESS EDUCATION RESOURCES </h4>
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <?php foreach ($used_categorys as $category) { ?>
                                        ...
                                        <?php if (!empty($media)) {
                                            $this->load->view('EN/Component/CategoryMedia', ["media" => $media, "category" => $category]);
                                        } ?>
                                    <?php } ?>
                                </div>
                            </div>
                                                        ...
                                                        <div class="linkslist">
                                                            <?php foreach ($links as $link) { ?>
                                                                ...
                                                                <a href="<?= $link['link'] ?>" target="_blank"
                                                                   ...
                                                                   class="btn btn-primary waves-effect waves-light w-100 mb-2 mt-1"><?= strlen($link['title']) > 30 ? substr($link['title'], 0, 30) . "....." : $link['title']; ?></a>
                                                            <?php } ?>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div class="row mt3 real_wellness" id="well_edu">
            <?php $this->load->view('EN/schools/inc/WELLNESS_EDUCATION_RESOURCES'); ?>
        </div>
                                                            ...
                                                            <?php foreach ($media as $link) { ?>
                                                                <?php if ($link['file_type'] == "1") { ?>
                                                                    <a href="<?= base_url('uploads/Category_resources/' . $link['file_language'] . "/" . $link["file_url"]) ?>"
                                                                       ...
                                                                       class="btn btn-primary waves-effect waves-light w-100 mb-2 mt-1"><?= strlen($link['file_name_en']) > 30 ? substr($link['file_name_en'], 0, 30) . "....." : $link['file_name_en']; ?></a>
                                                                <?php } else { ?>
    ...
    <div data-simplebar class="h-100">
        ...
        <?php foreach ($themes as $theme) { ?>
            <div class="p-4 btn w-100 waves-effect waves-light"
                 onclick="setTheme(<?= $theme['Id'] ?>,'<?= $theme['title_an']; ?>')">
                <div class="mb-2">
...
<script>
    ...
    function getquestions(roupid, typeOfSUrvey = "notFillable") {
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>EN/schools/get_questions_of_avalaible_surveys',
            data: {
    ...
    $("#publish_this_serv").on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>EN/schools/publish_serv',
            ...
            success: function (data) {
                if (data.status == "ok") {
                    ...
                    toastr["success"]("The survey has been created successfully.");
                    setTimeout(() => {
                        $('#publish').modal('hide');
                        location.reload();
                    }, 800);
    ...
    function publishedsurveyStatusChanger(surveyId) {
        $.ajax({
            ...
            success: function (data) {
                if (data == "ok") {
                    toastr["success"]("The survey status is updated.");
                    fetchSurveys($(".status-filter.active").data("status") === 1);
                } else {
                    toastr["error"](" we have error in this request , please try again later ");
                }
            },
        });
    }
    ...
    $("#fillablesurveyForm").on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>EN/schools/publish_fillable_serv',
            data: new FormData(this),
            contentType: false,
            cache: false,
            processData: false,
    ...
    function update_status(Id) {
        $.ajax({
            ...
            success: function (data) {
                if (data === "ok") {
                    toastr["success"]("The survey status was updated. " + status);
                } else {
                    Swal.fire(
                        'error',
    ...
    function fetchSurveys(status = true) {
        $.ajax({
            type: "GET",
            url: "<?= base_url("EN/schools/published-surveys-list/") ?>?status=" + (status ? 1 : 0),
            beforeSend: function () {
