...
<div class="home-btn d-none d-sm-block">
  ...
  if ( $sessiondata[ 'type' ] == 'super' ) {
      ...
      $link = "EN/School_Permition";
  } elseif ( $sessiondata[ 'type' ] == 'Patient' ) {
      $link = "EN/Departments_Permition";
  } elseif ( $sessiondata[ 'type' ] == 'Parent' ) {
      $link = "EN/Results/Select_Child";
  }
  ?>
  <a href="<?php echo base_url().$link; ?>" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a> </div>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-8 col-lg-6 col-xl-5">
		  	<h4 class="card-title" style="background: #abd034;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 045 Upload Avatar for Staff, Teachers, and Students</h4>
        <div> <a href="<?php echo base_url(); ?>" class="mb-5 d-block auth-logo"> <img src="<?php echo base_url(); ?>assets/images/qlick-health-logo.png" alt="" height="50" class="logo logo-dark"> <img src="<?php echo base_url(); ?>assets/images/qlick-health-logo.png" alt="" height="50" class="logo logo-light"> </a>
          <div class="card">
            <div class="card-body p-4">
              <div class="p-2 mt-4" id="DropZon">
                <div class="user-thumb text-center mb-4">
                  ...
                  <div class="changePic"> <i class="uil uil-camera"></i> </div>
                  <?php } }else{ ?>
                ...
                <form id="AddPhoto" style="margin-top: -50px;">
                  ...
                  <?php if(isset($Comm_From_List) && isset($StudentId)){ ?>
...
$( "#AddPhoto" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Users/UpladeImgsForMember',
          data: new FormData(this),
          contentType: false,
          cache: false,
          processData: false,
...
<?php /*$("#DropZon").dropzone(
     { 
          url: " echo base_url();EN/Users/UpladeImgs" ,
