...
<body>
    ...
    <div class="main-content">
        <div class="page-content">
            ...
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">REP 044: SITES’ REPORTS</h4>
...
function get_site_of_test($sitesForThisUser, $testType)
{
    ...
    foreach ($listSites as $count=>$siteResult) { ?>
        <tr>
            <td><?= $count+1; ?></td>
