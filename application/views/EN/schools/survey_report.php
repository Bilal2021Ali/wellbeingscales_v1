    ...
    <div class="page-content">
        <div class="row">
            <div class="col-12"><br>
                <h4 class="card-title"
                    ...
                    CH 068 Survey Report</h4>
            </div>
            <div class="col-lg-4"><br><br>
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 069 Recent Activity</h4>
                <div class="card">
                    <div class="card-body">
                        <div class="float-right">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton3">
                                    ...
                                    <a class="dropdown-item" onclick="show_type_of('teachers')">By Teachers</a>
                                    <a class="dropdown-item" onclick="show_type_of('Students')">By Students</a>
                                    <a class="dropdown-item" onclick="show_type_of('staffs')">By Staff</a>
                                    <a class="dropdown-item" onclick="show_type_of('Parents')">By Parents</a>
                                </div>
                            </div>
                        </div>
                ...
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 070 More Detailed Live View</h4>
                <div class="card bg-primary">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-sm-8">
                                <p class="text-white font-size-18">Show reports <b>as LIVE VIEW </b> for better tracking
                                    of results <i class="mdi mdi-arrow-right"></i></p>
                                <div class="mt-4">
                                    <a href="<?= base_url("EN/" . (isset($fromMinistry) ? "DashboardSystem/school-survey-report-view/" : "schools/survey_report_view/") . $serv_id); ?>"
                                       class="btn btn-success waves-effect waves-light">Let’s go!</a>
                                </div>
                            </div>
                            <div class="col-sm-4">
            ...
            <div class="col-lg-4">
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item text-center active">
                                    ...
                                    <p class="text-muted">User Respondent Counter</p>
                                </div>
                                <div class="carousel-item text-center">
                                    ...
                                    <p class="text-muted">Staff Respondent Counter</p>
                                </div>
                                <div class="carousel-item text-center">
                                    <div class="avatar-sm mx-auto mb-4">
                                        <div class="avatar-title rounded-circle bg-soft-primary text-primary font-size-20">
                                    ...
                                    <p class="font-size-15">Teacher Respondent Counter</p>
                                </div>
                                <div class="carousel-item text-center">
                                    <div class="avatar-sm mx-auto mb-4">
                                        <div class="avatar-title rounded-circle bg-soft-primary text-primary font-size-20">
                                    ...
                                    <p class="font-size-15">Student Respondent Counter</p>
                                </div>
                                <div class="carousel-item text-center">
                                    <div class="avatar-sm mx-auto mb-4">
                                        <div class="avatar-title rounded-circle bg-soft-primary text-primary font-size-20">
                                    ...
                                    <p class="font-size-15">Parent Respondent Counter</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 072 Percentage by Survey Response</h4>
            ...
            <div class="col-xl-4">
                ...
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 073 User Type Charts</h4>
                <div class="card" id="radial_chart_card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">User Type Charts<i class="uil uil-download-alt float-right"
                ...
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 074 Percentage by Gender</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 075 Percentage Report According to Questions</h4>
                <div class="card">
                    <div class="card-body">
                        <table class="table">
                            <thead>
