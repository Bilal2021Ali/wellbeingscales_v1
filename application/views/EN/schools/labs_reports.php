                    ...
                    <form method="post" id="search">
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <select name="classes[]" id="" class="select2 form-control select2-multiple" multiple="multiple" data-placeholder="Select Classes">
...
<script>
    ...
    $("#search").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url("EN/schools/labs_report"); ?>',
