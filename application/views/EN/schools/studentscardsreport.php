...
<div class="main-content">
	...
	<br>
        <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 048:Student Cards</h4>
        <div class="col-12">
            <div class="card">
                <form class="card-body" method="post">
                    <label for="">Please select a class:</label>
                    ...
                    <button class="btn btn-primary w-100 mt-1" type="submit" style="display: <?= $activeclass == "0" ? "none" : "block" ?>;">Generate</button>
                </form>
            </div>
        </div>
                                        ...
                                        <div class="card studentcard">
                                            <div class="card-body studentheader bg-<?= $count ?>">
                                                <div class="d-flex justify-content-around">
                                                    ...
                                                    <h3 class="card-title text-white">Age: <?= get_age($student->DOP) ?></h3>
                                                </div>
                                            </div>
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-3 text-center" style="display: grid;align-items: center;">
                                                        <div>
                                                            <img src="<?= base_url("uploads/avatars/" . ($student->useravatar ?? "default_avatar.jpg")) ?>" class="avatar img-thumbnail avatar-lg rounded-circle mb-1" alt="..."><br>
                                                            <span><?= $student->Created ?></span>
                                                            <p class="text-center"><?= $student->Time ?></p>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                        <span style="color: #656257;"><img src="<?= base_url("assets/images/icons/studentscards/03.png") ?>" alt="">BP:</span><br>
                                                        <span style="color: #d5a423;"><img src="<?= base_url("assets/images/icons/studentscards/08.png") ?>" alt="">SpO2:</span><br>
                                                        <span style="color: #1c468c;"><img src="<?= base_url("assets/images/icons/studentscards/06.png") ?>" alt="">HR:</span><br>
                                                        <span style="color: #9c884f;"><img src="<?= base_url("assets/images/icons/studentscards/01.png") ?>" alt="">Glucose:</span><br>
                                                        <span style="color: #dc5c95;"><img src="<?= base_url("assets/images/icons/studentscards/07.png") ?>" alt="">Temp:</span><br>
                                                        <span style="color: #9c6300;"><img src="<?= base_url("assets/images/icons/studentscards/04.png") ?>" alt="">Steps:</span><br>
                                                        <span style="color: #3c4054;"><img src="<?= base_url("assets/images/icons/studentscards/05.png") ?>" alt="">Calories:</span><br>
                                                        <span style="color: #616e9c;"><img src="<?= base_url("assets/images/icons/studentscards/02.png") ?>" alt="">Weight:</span><br>
                                                    </div>
                                                    <div class="col-2">
                                                        <span class="value"><?= $student->Blood_pressure_max ?>/<?= $student->Blood_pressure_min ?? 0 ?></span> mmHg <br>
                                                        <span class="value"><?= $student->Blood_oxygen ?? 0 ?></span> %<br>
                                                        <span class="value"><?= $student->Heart_rate ?? 0 ?></span> bpm<br>
                                                        <span class="value"><?= $student->Glucose ?? 0 ?></span> mmol/L<br>
                                                        <span class="value"><?= $student->Result ?? 0 ?></span> C°<br>
                                                        <span class="value"><?= $student->Steps ?? 0 ?></span>Step<br>
                                                        <span class="value"><?= $student->calories ?? 0 ?></span> Kcal</i><br>
