...
<body>
    ...
    <div class="main-content">
		...
		<div class="row">
            ...
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH P012: List of Results for Air Quality Devices
            </h4>
            ...
            <div class="container-fluid">
                <div class="row">
					...
					<br><br>
					<br>
						<img src="<?= base_url("assets/images/legendaqen.png"); ?>" class="img-responsive w-100" alt="" srcset="">
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-4">
											<div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['aq'], 'AQI', 1, "1000.png", $devices['aq_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['humidity'], 'Humidity', 4, "1005.png", $devices['humidity_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['Temperature_c'], 'Temperature C', 5, "1008.png", $devices['Temperature_c_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <div class="card infosCard">
                                                <div class="card-body">
                                                    <div class="row">
                                                        <?php showCircle($devices['device_id'] . "_" . rand(1000, 50000), $devices['pm2_5'], 'PM2.5', 6, "1019.png", $devices['pm2_5_time']);  ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xl-4">
                                            <a href="<?= base_url() ?>EN/schools/Realtime_Dashboard/<?= $devices['Device_Mac']  ?>">
...
<script>
    ...
    function go_addData(device_return) {
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>EN/Ajax/sync_device',
            data: {
