...
<body>
    ...
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 028032037 QR Code Card</h4>
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="mb-0"><img src="<?php echo base_url(); ?>assets/images/icons/png_icons/student_card.png" style="width: 25px;margin: auto 5px;">Card</h4>
            ...
            <div class="row pagecon">
                <div class="col-12">
                    ...
                    ?>
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title">Card For <?php echo $student['F_name_EN'] . ' ' . $student['L_name_EN'] ?></div>
                                <div class="row">
                                    <div class="fOR8pRINT col-lg-8 " id="fOR8pRINT">
                                        <div class="col-lg-8" style="padding-top: 40px;">
                                            <h4> Full Name : <?php echo $student['F_name_EN'] . ' ' . $student['M_name_EN'] . ' ' . $student['L_name_EN'] ?></h4>
                                            <h4> Gender : <?php echo $gender; ?></h4>
                                            <h4> DOB : <?php echo $student['DOP']; ?></h4>
                                            <h4> Nationality : <?php echo $student['Nationality']; ?></h4>
                                            <h4> National ID : <?php echo $student['National_Id']; ?></h4>
                                            <h4> School Name : <?php echo $sessiondata['username']; ?></h4>
                                        </div>
                                    </div>
