            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12"><br><br>
                        <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH-MO002: <?= $Action ?> Report</h4>
                    </div>
                </div>
            </div>
            <?php
                                    ...
                                    <?php foreach ($Staff_list as $staffsRes) { ?>
                                        <tr>
                                            ...
                                            <?php boxes_Colors(
                                                ...
                                                "-26px",
                                                "Temperature.png",
                                                $staffsRes['Result_Time']
                                            ); ?>

                                            <?php Blood_pressure(
                                                $staffsRes['Blood_pressure_max'],
                                                $staffsRes['Blood_pressure_min'],
                                                $dialostics[2],
                                                $dialostics[1],
                                                "BloodPressure02.png",
                                                $staffsRes['Blood_pressure_Date']
                                            ); ?>

                                            <?php boxes_Colors(
                                                $staffsRes['Blood_oxygen'],
                                                $dialostics[3],
                                                "",
                                                "%",
                                                "-46px",
                                                "Oxygen.png",
                                                $staffsRes['Blood_oxygen_Date']
                                            ); ?>

                                            <?php boxes_Colors(
                                                $staffsRes['Heart_rate'],
                                                $dialostics[4],
                                                " ",
                                                "bpm",
                                                "-26px",
                                                "Puls.png",
                                                $staffsRes['Heart_rate_Date']
                                            ); ?>
                                ...
                                <tbody>
                                    <?php foreach ($Student_list as $studentResults) { ?>
                                        <tr>
                                            ...
                                            <?php Blood_pressure($studentResults['Blood_pressure_max'], $studentResults['Blood_pressure_min'], $dialostics[2], $dialostics[1], "BloodPressure02.png", $studentResults['Blood_pressure_Date']); ?>
                                ...
                                <tbody>
                                    <?php foreach ($Teacher_list as $TeacherResults) { ?>
                                        <tr>
                                            ...
                                            <?php Blood_pressure($TeacherResults['Blood_pressure_max'], $TeacherResults['Blood_pressure_min'], $dialostics[2], $dialostics[1], "BloodPressure02.png", $TeacherResults['Blood_pressure_Date']); ?>
