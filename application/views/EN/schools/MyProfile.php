...
<body class="authentication-bg">
    ...
    <div class="home-btn d-none d-sm-block">
        <a href="<?php echo base_url(); ?>EN/Schools" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
    </div>
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="p-2 mt-4" id="DropZon">
                                    ...
                                    <?php $Useradta = $this->db->query("SELECT * FROM l1_school WHERE Id = '" . $sessiondata["admin_id"] . "' ")->result_array();
                                    foreach ($Useradta as $admin) {
                                    ?>
                                        <form id="ResetUsername" style="margin-top: -50px;">
                                            <div class="form-group">
                                                <label>School Name AR :</label>
                                                <input type="text" class="form-control" name="School_Name_AR" value="<?php echo $admin['School_Name_AR'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label>School Name EN :</label>
                                                <input type="text" class="form-control" name="School_Name_EN" value="<?php echo $admin['School_Name_EN'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label>Manager EN :</label>
                                                <input type="text" class="form-control" name="Manager_EN" value="<?php echo $admin['Manager_EN'] ?>">
                                            </div>

                                            <div class="form-group">
                                                <label>Manager AR :</label>
                                                <input type="text" class="form-control" name="Manager_AR" value="<?php echo $admin['Manager_AR'] ?>">
                                            </div>
                                            ...
                                            <button class="btn btn-primary w-sm waves-effect waves-light btn-block" type="Submit" name="Submit" id="sub">Change it.</button>
                                        </form>
                                    <?php } ?>
                                </div>
                            </div>
    ...
    <script>
        $("#ResetUsername").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>EN/Users/SchoolUserupdate',
