...
<script>
    ...
    $("#Addclasses").on('submit', function (e) {
        ...
        if (classekeys.length > 0) {
            $.ajax({
                ...
                success: function (data) {
                    if (data == "ok") {
                        Swal.fire({
                            title: 'Success',
                            text: 'Your classes have been updated successfully.',
                            icon: 'success'
                        });
                        setTimeout(() => {
                            location.reload();
                        ...
                        Swal.fire({
                            title: 'error',
                            text: 'sorry we have unexpected error',
                            icon: 'error'
                        });
                    }
                },
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: "You didnt select any classes , that's mean you want to reset the classes ?",
                icon: 'warning',
                showCancelButton: true,
    ...
    function ipLookUp() {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('.setTheLocation').html('<i class="uil uil-check"></i> Thank you! You can turn on the ad-blocker now.');
            ...
            error: function (data) {
                Swal.fire({
                    title: ` Maybe You are using an ad blocker Please turn off that For Use this button ,
                        If you alredy turned off the ad blocker Please try again later`,
                    showCancelButton: true,
