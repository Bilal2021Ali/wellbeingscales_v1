...
<div class="main-content">
    <div class="page-content">
        <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 031
                        ...
                        <div class="col-md-12 formcontainer" id="staff">
                            <div class="row">
                                ...
                                <form class="needs-validation InputForm col-md-12" novalidate=""
                                      style="margin-bottom: 27px;" id="UpdateTeacherData">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-2" style="margin-bottom: 11px;">
                                                    ...
                                                    <select class="custom-select" id="Prefix" name="Prefix">
                                                        ...
                                                        <?php foreach ($tbl_prefix as $pref) : ?>
                                                            <option
                                                                value="<?= $pref['Prefix']; ?>" <?= $Teacher['Prefix'] == $pref['Prefix'] ? "selected" : ""; ?>>
                                                                <?= $pref['Prefix']; ?>.
                                                            </option>
                                                        <?php endforeach ?>
                                                    </select>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom02"
                                                               ...
                                                               required="" value="<?= $Teacher['F_name_EN'] ?>">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom01"
                                                               ...
                                                               required="" value="<?= $Teacher['M_name_EN'] ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom01"
                                                               ...
                                                               required="" value="<?= $Teacher['L_name_EN'] ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom02"
                                                               ...
                                                               required="" value="<?= $Teacher['F_name_AR'] ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom01"
                                                               ...
                                                               required="" value="<?= $Teacher['M_name_AR'] ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="validationCustom01"
                                                               ...
                                                               required="" value="<?= $Teacher['L_name_AR'] ?>">
                                                        <div class="valid-feedback">
                                                            Looks good!
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select class="custom-select" name="Gender">
                                                        <option
                                                            value="M" <?= $Teacher['Gender'] == 'M' ? "selected" : "" ?>>
                                                            Male
                                                        </option>
                                                        <option
                                                            value="F" <?= $Teacher['Gender'] == 'F' ? "selected" : "" ?>>
                                                            Female
                                                        </option>
                                                    </select>
                                                </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="Nationality">
                                                            <?php foreach ($contriesarray as $contries) { ?>
                                                                <option
                                                                    value="<?= $contries['name']; ?>" <?= $Teacher['Nationality'] == $contries['name'] ? "selected" : "" ?>
                                                                    class="option">
                                                                    <?= $contries['name']; ?>
                                                                </option>
                                                            <?php } ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="relationship">
                                                            <?php foreach ($av_relationships as $av_relationship) { ?>
                                                                <option
                                                                    value="<?= $av_relationship['Id'] ?>" <?= $av_relationship['Id'] == $Teacher['martial_status'] ? "selected" : "" ?>>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="Position">
                                                            <?php foreach ($Positions as $Position) { ?>
                                                                <option
                                                                    value="<?= $Position['Id'] ?>" <?= $Teacher['Position'] == $Position['Id'] ? "selected" : "" ?>>
                                                                    <?= $Position['Position'] ?>
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <label>Classes
                                                        ...
                                                        <span class="float-right text-white btn s-all"
                                                              data-target-select="Classes[]" style="margin-top: -9px;">Select all</span>
                                                    </label>
                                                    <div class="form-group">
                                                        ...
                                                        <?php if (!empty($classes)) { ?>
                                                            ...
                                                            <select name="Classes[]"
                                                                ...
                                                                <?php foreach ($classes as $class) { ?>
                                                                    <option <?= in_array($class['Id'], $teacherClasses) ? "selected" : "" ?>
                                                                        value="<?= $class['Id'] ?>"><?= $class['Class'] ?></option>
                                                                <?php } ?>
                                                            </select>
                                                        <?php } else { ?>
                                                            <p>You do not have any class registered yet. Please edit
                                                                school<a href="<?= base_url() ?>EN/schools/Profile">Profile</a>
                                                            </p>
                                                        <?php } ?>
                                                    </div>
                                                </div>
...
<script>
    ...
    $("#UpdateTeacherData").on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?= base_url(); ?>EN/schools/UpdateTeacherData',
