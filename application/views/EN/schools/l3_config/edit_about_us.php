...
<div class="main-content">
    <div class="page-content">
        <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">Add New “My Resources” with Images</h4>
        <div class="container">
            <div class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body fullarticle"></div>
                    </div>
                </div>
            </div>
            ...
            <form class="row" id="newarticles">
                ...
                <div class="col-lg-6 articles">
                    <div class="card">
                        <div class="card-body"> <br>
                            <h3 class="card-title">Add New “My Resources” with Images</h3>
                            <hr>
                            ...
                            <div class="tab-content p-3 text-muted">
                                <div class="tab-pane active" id="en" role="tabpanel">
                                    <label for="en_title">“My Resources” Title</label>
                                    <input type="text" name="en_title" id="en_title" value="<?= $data['En_title'] ?>" class="form-control" placeholder="Title for EN version users">
                                    <label for="en_article" class="mt-1">Article text EN</label>
                                    <textarea name="en_article" id="en_article" cols="30" rows="10"><?= $data['En_article'] ?></textarea>
                                </div>
                                <div class="tab-pane" id="ar" role="tabpanel">
                                    <label for="ar_title">My Resources Title</label>
                                    <input type="text" name="ar_title" id="ar_title" value="<?= $data['Ar_title'] ?>" class="form-control" placeholder="Title for AR version users">
                                    <label for="ar_article" class="mt-1">Article text AR</label>
                                    <textarea name="ar_article" id="ar_article" cols="30" rows="10"><?= $data['Ar_article'] ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 images">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="card-title"> “My Resources” Image</h3>
                            <hr>
                            <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                <li class="nav-item">
                                ...
                                <div class="tab-pane active" id="enimg" role="tabpanel">
                                    <div class="choose_file">
                                        <label for="choose_file">
                                            ...
                                            <span>Select new file (EN)</span>
                                        </label>
                                    </div>
                                    <div class="col-12">
                                        <img id="en_image_preview" src="<?= base_url("uploads/l3_about_us/" . $data['en_image']) ?>" class="w-100 placeholder-image" alt="" srcset="">
                                    </div>
                                </div>
                                <div class="tab-pane" id="arimg" role="tabpanel">
                                    <div class="choose_file">
                                        <label for="choose_file1">
                                            ...
                                            <span>Select new file (AR)</span>
                                        </label>
                                    </div>
                                    <div class="col-12">
                                        <img id="ar_image_preview" src="<?= base_url("uploads/l3_about_us/" . $data['ar_image']) ?>" class="w-100 placeholder-image" alt="" srcset="">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary btn-lg btn-block waves-effect waves-light mb-1">Update My Resources</button>
                </div>
            </form>
        </div>
    </div>
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data == "ok") {
                            ...
                            setTimeout(function() {
                                location.href = '<?= base_url("EN/schools/L3_config"); ?>'
                            }, 1000);
                        } else {
                            $('.alert-danger').show();
