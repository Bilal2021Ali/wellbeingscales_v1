                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php } else { ?>
                                        <p>You don't have any class, Please edit the school profile <a href="<?= base_url() ?>EN/schools/Profile">Profile</a> </p>
                                    <?php } ?>
                                </div>
                            </div>
                ...
                if (data.status == "ok") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            setTimeout(() => {
                                location.href = "<?= base_url("EN/schools/Public_Visitors") ?>"
                            }, 500);
                        }
                    });
                } else {
