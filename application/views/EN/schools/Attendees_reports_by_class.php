...
<div class='main-content'>
    <div class='page-content'><br>
        <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 047: ATTENDEES BY CLASS</h4>
        <div class="container">
            <div class="card">
                <div class="card-body">
                                    ...
                                    <div class="card text-center">
                                        <div class="card-body">
                                            ...
                                            <?php if ($student['Attendees_status'] == "present") { ?>
                                                <button type="button" class="btn btn-success btn-rounded waves-effect waves-light">P</button>
                                                <button type="button" class="btn btn-outline-danger btn-rounded waves-effect waves-light">A</button>
                                                <button type="button" class="btn btn-outline-warning btn-rounded waves-effect waves-light">L</button>
                                            <?php } else { ?>
                                                <button type="button" class="btn btn-outline-success btn-rounded waves-effect waves-light">P</button>
                                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light">A</button>
                                                <button type="button" class="btn btn-outline-warning btn-rounded waves-effect waves-light">L</button>
                                            <?php } ?>
                                        </div>
                                    </div>
...
<script>
    ...
    $('.link').click(function() {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url("EN/schools/Vehicles_list") ?>",
            data: {
    ...
    $('.staffs').click(function() {
        ...
        $.ajax({
            type: "post",
            url: "<?= base_url("EN/schools/Vehicles_staff_control") ?>",
            data: {
