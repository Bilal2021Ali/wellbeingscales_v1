...
<body>
    ...
    <div class="main-content">
        <div class="page-content">
            ...
            <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">REP 043: Attendance by Date for All Users</h4>
    ...
    <script>
        $("#getData").on('submit', function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url(); ?>EN/Ajax/Attendence_in_of_all',
