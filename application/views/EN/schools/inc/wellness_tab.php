...
<div class="col-lg-12"><br>
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--blue);"><img
                            src="<?= base_url('assets/images/icons/PUBLISHEDSURVEYS.png'); ?>" class="ic_img" alt="">
                    <h4>TOTAL EXPIRED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= sizeof($expired_surveys) ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--green);"><img
                            src="<?= base_url('assets/images/icons/PUBLISHEDSURVEYS.png'); ?>" class="ic_img" alt="">
                    <h4>TOTAL COMPLETED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= sizeof($completed_surveys) ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-3">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--pink);"><img
                            src="<?= base_url('assets/images/icons/PUBLISHEDSURVEYS.png'); ?>" class="ic_img" alt="">
                    <h4>TOTAL CATEGORIES</h4>
                    <h1 data-plugin="counterup">
                        <?= sizeof($used_categorys) ?>
                    </h1>
                </div>
            </div>
        </div>
    </div>
    <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 037 Detailed
        Reports</h4>
    <div class="row cardsoflinks">
        <div class="col-lg-3"><a href="<?= base_url('EN/schools/specific_surveys_reports/Students') ?>">
                <div class="card border-ronded">
                    <div class="card-body firstCard text-center" style="background: var(--purple);"><img
                                src="<?= base_url('assets/images/icons/Students.png') ?>" alt="">
                        <h4 class="text-white">Students <i class="uil uil-arrow-right"></i></h4>
                    </div>
                </div>
            </a></div>
        <div class="col-lg-3"><a href="<?= base_url('EN/schools/specific_surveys_reports/teachers') ?>">
                <div class="card border-ronded">
                    <div class="card-body firstCard text-center" style="background: var(--cyan);"><img
                                src="<?= base_url('assets/images/icons/teachers.png') ?>" alt="">
                        <h4 class="text-white">Teachers <i class="uil uil-arrow-right"></i></h4>
                    </div>
                </div>
            </a></div>
        <div class="col-lg-3"><a href="<?= base_url('EN/schools/specific_surveys_reports/Staff') ?>">
                <div class="card border-ronded">
                    <div class="card-body firstCard text-center" style="background: var(--red);"><img
                                src="<?= base_url('assets/images/icons/Staffs.png') ?>" alt="">
                        <h4 class="text-white">Staff <i class="uil uil-arrow-right"></i></h4>
                    </div>
                </div>
            </a></div>
        <div class="col-lg-3"><a href="<?= base_url('EN/schools/specific_surveys_reports/Parents') ?>">
                <div class="card border-ronded">
                    <div class="card-body firstCard text-center" style="background: var(--gray);"><img
                                src="<?= base_url('assets/images/icons/Parents.png') ?>" alt="">
                        <h4 class="text-white">Parents <i class="uil uil-arrow-right"></i></h4>
                    </div>
                </div>
            </a></div>
    </div>
    <div class="row">
        <div class="col-12">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 038
                SUMMARY OF RESPONDENTS BASED ON PUBLISHED RESEARCH SURVEYS</h4>
            <h4 class="card-title bordred_title"
                style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> SUMMARY OF
                RESPONDENTS BASED ON PUBLISHED RESEARCH SURVEYS</h4>
            <div class="card">
                <div class="card-body">
                    <div class="hori-timeline mt-5" dir="ltr">
                        <div class="owl-carousel owl-theme navs-carousel events" id="our_surveys_list">
                            <?php if (!empty($our_surveys)) { ?>
                                        ...
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <p class="text-muted mb-2">
                                                    <?= 'From :' . $survey['From_date'] . ' <br> To :' . $survey['To_date'] ?>
                                                </p>
                                            </div>
                                            <div class="btn-group" role="group">
                                                <?php if ($survey['answers_counter'] > 0) { ?>
                                                    <a href="<?= base_url("EN/schools/survey-reports/" . $survey['survey_id']); ?>"
                                                       class="btn btn-outline-light text-truncate"><i
                                                                class="uil uil-notes mr-1"></i>Reports</a>
                                                <?php } ?>
                                                <a href="<?= base_url("EN/schools/survey-preview/" . $survey['survey_id']); ?>"
                                                   target="_blank" class="btn btn-outline-light text-truncate"><i
                                                            class="uil uil-eye mr-1"></i> Preview </a></div>
                                        </div>
                                    </div>
                                <?php } ?>
                            <?php } else { ?>
							
                                <img src="<?= base_url("assets/images/no_surveys_found.svg") ?>"
                             class="img-responsive w-100 p-1">
                            <?php } ?>
                        </div>
                    </div>
                </div>
    ...
    <div class="row">
        <?php foreach (['active', 'expired'] as $type) { ?>
            <div class="col-12">
                <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW
                    039 SUMMARY OF USER TYPES BASED ON
                    <?= $type == "active" ? "PUBLISHED" : "EXPIRED" ?>
                    RESEARCH SURVEYS</h4>
                <h4 class="card-title bordred_title"
                    style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> SUMMARY OF
                    USER TYPES BASED ON
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="card genders_dunat_card">
                            <div class="card-body text-center">
                                <h3 class="card-title">Graphical Presentation of Published Surveys According to
                                    Gender</h3>
                                <h3 class="card-title "><img src="<?= base_url(); ?>assets/images/icons/both.png" alt=""
                                                             srcset="" width="200px"></h3>
                    ...
                    <div class="col-sm-6">
                        <div class="card basic_type_chart_card">
                            <div class="card-body">
                                <h3 class="card-title">Graphical Presentation of Published Surveys According to User
                                    Types</h3>
                                <h3 class="card-title text-center"><img
                                            src="<?= base_url(); ?>assets/images/icons/both.png" alt="" srcset=""
                                            width="200px"></h3>
...
<div class="col-lg-12">
    <div class="card">
        <div class="card-body">
            <h3 class="card-title"> Graphical Presentation of Responses According to Age for All User Used Surveys in All Schools</h3>
...
<div class="col-12">
  ...
  <?php */ ?>
    <div class="row">
        <div class="col-12">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 040
                DATA FREQUENCY OF STUDENTS</h4>
            <h4 class="card-title bordred_title"
                style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> DATA FREQUENCY OF
                STUDENTS </h4>
        </div>
    </div>
    <div class="row ">
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body text-center">
                    <h3 class="card-title">Graphical Distribution of Published Survey According to Gender</h3>
    ...
    <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 041 STUDENT
        COUNTERS</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--yellow);"><i
                            class="uil uil-clipboard-notes font-size-70"></i>
                    <h4>TOTAL PUBLISHED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_published_surveys['students'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--blue);"><i
                            class="uil uil-calendar-slash font-size-70"></i>
                    <h4>TOTAL EXPIRED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_expired_surveys['students'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--green);"><i
                            class="uil uil-check font-size-70"></i>
                    <h4>TOTAL COMPLETED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_completed_surveys['students']; ?>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="row ontypecard">
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body text-center" style="background: var(--orange);"><i
                            class="uil uil-comment-alt-question font-size-70"></i>
                    <h4> TOTAL QUESTIONS OF SURVEYS </h4>
                    <h1 data-plugin="counterup">
                        <?= sizeof($students_quastions) ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="card">
                <div class="card-body text-center" style="background: var(--orange);"><i
                            class="uil uil-clock-eight font-size-70"></i>
                    <h4> AVERAGE TIME RESPONSE </h4>
                    <h1>
                        <?= $finishing_time_students; ?>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 041
                DATA FREQUENCY OF TEACHERS</h4>
            <h4 class="card-title bordred_title"
                style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> DATA FREQUENCY OF
                TEACHERS </h4>
        </div>
    ...
    <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 042 TEACHER
        COUNTERS</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--yellow);"><i
                    ...
                    <h4>TOTAL PUBLISHED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_published_surveys['teachers'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--blue);"><i
                    ...
                    <h4>TOTAL EXPIRED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_expired_surveys['teachers'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--green);"><i
                    ...
                    <h4>TOTAL COMPLETED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_completed_surveys['teachers']; ?>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 043
                DATA FREQUENCY OF STAFF</h4>
            <h4 class="card-title bordred_title"
                style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> DATA FREQUENCY OF
                STAFF </h4>
        </div>
    ...
    <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 044 STAFF
        COUNTERS</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--yellow);"><i
                    ...
                    <h4>TOTAL PUBLISHED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_published_surveys['staffs'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--blue);"><i
                    ...
                    <h4>TOTAL EXPIRED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_expired_surveys['staffs'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--green);"><i
                    ...
                    <h4>TOTAL COMPLETED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_completed_surveys['staffs']; ?>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 045
                DATA FREQUENCY OF PARENTS</h4>
            <h4 class="card-title bordred_title"
                style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> DATA FREQUENCY OF
                PARENTS </h4>
        </div>
    ...
    <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 046 PARENT
        COUNTERS</h4>
    <div class="row">
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--yellow);"><i
                    ...
                    <h4>TOTAL PUBLISHED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_published_surveys['Parents'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--blue);"><i
                    ...
                    <h4>TOTAL EXPIRED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_expired_surveys['Parents'] ?>
                    </h1>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card border-ronded">
                <div class="card-body firstCard text-center" style="background: var(--green);"><i
                    ...
                    <h4>TOTAL COMPLETED SURVEYS</h4>
                    <h1 data-plugin="counterup">
                        <?= $counter_of_completed_surveys['Parents']; ?>
                    </h1>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CHW 047
                AVERAGE TIME RESPONSE FOR ALL USERS</h4>
            <div class="card p-4">
                <div class="card-body text-center"><i class="uil uil-clock-eight font-size-70"></i>
                    <h4> AVERAGE TIME RESPONSE </h4>
                    <h1>
                        <?= $finishing_time_all; ?>
                    </h1>
...
<script>
  ...
  const options = {
    ...
    series: Object.entries(ages).map(([key, value]) => ({
      name: key,
      data: [value],
    })),
    xaxis: {
      categories: Object.keys(ages),
      labels: {
        show: false,
      },
      crosshairs: {
  ...
  const chart = new ApexCharts(
    document.querySelector('#bilal_basic_ages_chart'),
    options
  );
  chart.render();
}
