            ...
            <?php if (!empty($data)) {  ?>
                <div class="container-fluid">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="uil uil-circuit"></i>The Area Details </h4>
                            </div>
                        </div>
                    </div>
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="tab-pane active" id="home1" role="tabpanel">
                                                <form id="Daily">
                                                    ...
                                                    <div class="row pl-2 pr-2">
                                                        <button type="Submit" class="btn btn-primary waves-effect w-100 mt-2"> Show Results <i class="uil uil-angle-down"></i></button>
                                                    </div>
                                                </form>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card-types" data-simplebar="init">
                                        <div class="type" id="typeTab_id_1" value="aq">Air Quality</div>
                                        <div class="type" id="typeTab_id_2" value="ch2o">Ch2O</div>
                                        <div class="type" id="typeTab_id_3" value="co2">CO2</div>

                                        <div class="type" id="typeTab_id_6" value="humidity">Humidity</div>
                        
                            
                                        <div class="type" id="typeTab_id_9" value="Temperature_c">Temperature c</div>
                 
                     
                                 
                                      
                                        <div class="type" id="typeTab_id_19" value="pm2_5">PM2.5</div>
    ...
    <script>
        ...
        function getweekly() {
            json_data = $.parseJSON($.ajax({
                url: '<?= base_url() ?>EN/Ajax/gitDeviceResults',
                dataType: "json",
                async: false,
                type: 'POST',
                data: {
        ...
        $(".type").click(selected_types = selected_types, function() {
            ...
            if (selected_types.length < (max)) {
                ...
                $('.type').removeAttr('index');
                for (let indexSelector = 0; indexSelector < ($('.active_type').length); indexSelector++) {
                    $('#typeTab_id_' + (indexSelector + 1)).attr("index", indexSelector);
                }
                console.log("length :" + selected_types.length);
                console.log("max :" + max);
