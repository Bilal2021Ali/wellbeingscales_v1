...
<head>
    ...
    <link href="<?= base_url(); ?>assets/libs/datatables.net-as-bs4/css/as.bootstrap4.min.css" rel="stylesheet" type="text/css" />
...
<body>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a class="image-popup-no-margins" href="<?= base_url("Proxy/get_image?img_url=") . $results['img_uri']; ?>">
                                                        <img class="img-fluid mr-2" alt="" src="<?= base_url("Proxy/get_image?img_url=") . $results['img_uri']; ?>" width=" 75">
                                                    </a>
                                                </td>
                                                <?php boxes_Colors($results['Result'], $dialostics[0], "Temperature", "C°", "-59px", "Temperature.png"); ?>
                                                <td class="text-center result">
                                                    <h6 class="font-size-15 mb-1 font-weight-normal"><?= $user_name ?></h6>
                                                    <p class="text-muted" style="font-size: 10px;"><?= $results['result_time'] ?> </p>
                                                </td>
                                                <td class="text-center flex justify-content-center">
                                                    <a href="<?= base_url("EN/schools/update_visitor/" . $results['UserId']); ?>" class="btn btn-primary btn-rounded waves-effect waves-light">Update User Data</a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
    ...
    <script src="<?= base_url(); ?>assets/libs/datatables.net-as/js/dataTables.as.min.js"></script>
    <script src="<?= base_url(); ?>assets/libs/datatables.net-as-bs4/js/as.bootstrap4.min.js"></script>
    <script src="<?= base_url(); ?>assets/libs/jszip/jszip.min.js"></script>
    <script src="<?= base_url(); ?>assets/libs/pdfmake/build/pdfmake.min.js"></script>
    <script src="<?= base_url(); ?>assets/libs/pdfmake/build/vfs_fonts.js"></script>
    <script src="<?= base_url(); ?>assets/libs/datatables.net-as/js/as.html5.min.js"></script>
    <script src="<?= base_url(); ?>assets/libs/datatables.net-as/js/as.print.min.js"></script>
    <script src="<?= base_url(); ?>assets/libs/datatables.net-as/js/as.colVis.min.js"></script>
