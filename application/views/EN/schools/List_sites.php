            ...
            <section class="content">
                <div class="main-content">
                    <div class="page-content">
                        <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 037 Sites</h4>
                        <div class="row">
                                    ...
                                    <div class="card-body" style="background-color: #3df0f0;padding: 5px">
                                        <div class="card-body" style="background-color: #022326;">
                                            <div class="float-right mt-2">
                                                ...
                                                <img src="<?= base_url(); ?>assets/images/icons/png_icons/sites.png" alt="schools" width="64px">
                                            </div>
                                            <div>
                                                <?php
                                                ...
                                                ?>
                                                <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?= $allResurs ?></span></h4>
                                                <p class="mb-0">Total of General Sites </p>
                                            </div>
                                    ...
                                    <div class="card-body" style="background-color: #ff26be;padding: 5px">
                                        <div class="card-body" style="background-color: #2e001f;">
                                            ...
                                            <div>
                                                ...
                                                ?>
                                                <h4 class="mb-1 mt-1">
                                                    <span data-plugin="counterup"><?= $allarea ?></span>
                                                </h4>
                                                <p class="mb-0">Total of Site Locations </p>
                                            </div>
                        ...
                        <h4 class="card-title" style="background: #add138;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 038 List of Sites</h4>
                        ...
                        <div class="container-fluid" style="overflow: auto;">
                            <div class="page-title-right">
                                <ol class="breadcrumb m-0">
                                    ...
                                    <a href="<?= base_url(); ?>EN/Schools/infos_Card/SitesList" style="position: absolute;right: 10px;">
                                        Show All List of Sites
                                        ...
                                        <tbody>
                                            <?php foreach ($listofaStaffs as $key => $admin) { ?>
                                                <tr>
                                                    ...
                                                    <td><?php foreach ($sitecodes as $code) {
                                                            echo $code['Site_Code'] . " - " . $Site_name;
                                                        }  ?></td>
                                                    <td><?= $admin['Description']; ?></td>
                                                    <td style="text-align: center;">
                                                        <a href="<?= base_url() ?>EN/schools/UpdateSite/<?= $admin['Id']; ?>">
                                                            <i class="uil-pen" style="font-size: 25px;" title="Edit'"></i>
                                                        </a>
                                                        <a href="<?= base_url() ?>EN/schools/infos_Card/Site/<?= $admin['Id']; ?>">
