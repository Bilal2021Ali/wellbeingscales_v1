...
<style>
     ...
     <div class="main-content">
          <div class="page-content">
			  <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 040 Update Site Description </h4>
               <div class="row">
                         ...
                         <div class="">
                              <div class="card-body">
                                   <div class="alert alert-border alert-border-secondary alert-dismissible fade show" role="alert">
                                        <span id="Toast">Please Update Site Description</span>
                                             ...
                                             <form class="needs-validation InputForm col-md-12" novalidate="" style="margin-bottom: 27px;" id="UpdateSiteData">
                                                  <div class="card" style="width: 100%;">
                                                       <div class="card-body">
                                                        ...
                                                        <label class="control-label">Site Type | Protected| </label> 
               <?php 
     ...
     <script>
          ...
          $( "#UpdateSiteData" ).on( 'submit', function ( e ) {
               ...
               $.ajax( {
                    type: 'POST',
                    url: '<?php echo base_url(); ?>EN/schools/StartUpdateSite',
