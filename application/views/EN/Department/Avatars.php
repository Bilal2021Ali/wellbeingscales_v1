              ...
              <div class="col-lg-4 showInPageCard hide-card"  > 
               <div class="card bg-primary text-white-50" style="border: 0px;">
                                    <div class="card-body">
                                        ...
                                        <a href="<?php echo base_url(); ?>EN/Schools/SchowStudentsFromClass" id="Students_Link"><button type="button" class="btn btn-light waves-effect"  >Go To The Page !!</button></a> 
                                    </div>
                                </div> 
                                </div> 
...
$("table").DataTable();
    ...
    $('.close').click(function(){
      ...
      var href = "<?php echo base_url() ?>EN/Schools/Class_Avatars/"+selectedclass;
      $('#Students_Link').attr('href',href);
      $.ajax({
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Departments/ChangeAvatarList',
          data: {
