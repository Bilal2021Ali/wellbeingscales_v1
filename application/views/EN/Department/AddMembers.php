...
<body class="light menu_light logo-white theme-white">
                              ...
                              <div class="card-body" style="background-color: #3df0f0;padding: 5px">
                                   <div class="card-body" style="background-color: #022326;">
                                        <div class="float-right mt-2">
                                             ...
                                             <img src="<?= base_url(); ?>assets/images/icons/D100.png" alt="schools" width="50px"></i>
                                        </div>
                                        <div>
                                             <?php
                         ...
                         <div class="card">
                              <div class="card-body" style="background-color: #ff26be;padding: 5px">
                                   <div class="card-body" style="background-color: #2e001f;">
                                        <div class="float-right mt-2">
                                             <img src="<?= base_url(); ?>assets/images/icons/D300.png" alt="department" width="50px">
                                        </div>
                                        <div>
                                             <?php
                         ...
                         <div class="card">
                              <div class="card-body" style="background-color: #3cf2a6;padding: 5px">
                                   <div class="card-body" style="background-color: #00261a;">
                                        <div class="float-right mt-2">
                                             <img src="<?= base_url(); ?>assets/images/icons/D200.png" alt="department" width="50px">
                                        </div>
                                        <div>
                                             <?php
                                             ...
                                             ?>
                                             <h4 class="mb-1 mt-1">
                                                  <span data-plugin="counterup"><?= $allstudents ?></span>
                                             </h4>
     ...
     <script>
          ...
          $("#Addpatient").on('submit', function(e) {
               ...
               $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>EN/Departments/startAddpatient',
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
                    processData: false,
          ...
          $("#AddStudent").on('submit', function(e) {
               ...
               $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>EN/Departments/startAddStudent',
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
                    processData: false,
          ...
          $("#AddSite").on('submit', function(e) {
               ...
               $.ajax({
                    type: 'POST',
                    url: '<?= base_url(); ?>EN/Departments/startAddSite',
                    data: new FormData(this),
                    contentType: false,
                    cache: false,
                    processData: false,
