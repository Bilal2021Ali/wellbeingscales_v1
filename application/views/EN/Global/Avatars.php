...
<body>
    <div class="main-content">
        <div class="page-content">
            <h4 class="card-title" style="background: #07bff3;padding: 10px;color: #1E1E1E;border-radius: 4px;">CH 041 Upload Avatar for Staff, Teachers, and Students</h4>
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <select class="custom-select" id="List">
                                        <option value="Staffs" selected="">For Staff </option>
                                        <option value="Techers">For Teachers</option>
                                        ...
                                        <tr id="TrStafffId<?= $admin['Id']; ?>">
                                            <th scope="row" class="Avatar" style="text-align: center;">
                                                ...
                                                <?php if (empty($avatar_teach)) {  ?>
                                                    <a href="<?= base_url(); ?>uploads/avatars/default_avatar.jpg" class="image-popup-no-margins">
                                                        <img src="<?= base_url(); ?>uploads/avatars/default_avatar.jpg" class="avatar-xs rounded-circle " alt="...">
                                                    </a>
                                                <?php } else { ?>
                                                    <a href="<?= base_url(); ?>uploads/avatars/<?= $avatar_teach[0]['Link']; ?>" class="image-popup-no-margins">
                                                        <img src="<?= base_url(); ?>uploads/avatars/<?= $avatar_teach[0]['Link']; ?>" class="avatar-xs rounded-circle " alt="...">
                                                    </a>
                                                <?php } ?>
                                            </th>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url(); ?>EN/Schools/ChangeMemberAvatar/Staff/<?= $admin['Id']; ?>/<?= $admin['National_Id'] ?>">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ($listofteachers as $admin_Teacher) { ?>
                                        <tr id="TrStafffId<?= $admin_Teacher['Id']; ?>">
                                            <th scope="row" class="Avatar" style="text-align: center;">
                                                <?php
                                                $avatar_teach = $this->db->query("SELECT * FROM `l2_avatars`
     WHERE `For_User` = '" . $admin_Teacher['Id'] . "' AND `Type_Of_User` = 'Teacher' LIMIT 1 ")->result_array();
                                            ...
                                            <td>
                                                <?= $admin_Teacher['F_name_EN'] . ' ' . $admin_Teacher['M_name_EN'] . ' ' . $admin_Teacher['L_name_EN']; ?>
                                            </td>
                                            <td>
                                                <?= $admin_Teacher['National_Id']; ?>
                                            </td>

                                            <td>
                                                <a href="<?= base_url(); ?>EN/Schools/ChangeMemberAvatar/Teacher/<?= $admin_Teacher['Id']; ?>/<?= $admin_Teacher['National_Id'] ?>">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="card-title text-center">List of Students
                                ...
                                <div class="">
                                    <div class="card-body">
                                        <label for="SelectFromClass">Please select class</label>
            ...
            <div class="col-lg-4 showInPageCard hide-card">
                <div class="card bg-primary text-white-50" style="border: 0px;">
                    <div class="card-body">
                        ...
                        <h5 class="mt-0 mb-4 text-white"><i class="uil uil-camera mr-3"></i> You can open this list on a separate page.</h5>
                        <a href="<?= base_url(); ?>EN/Schools/SchowStudentsFromClass" id="Students_Link"><button type="button" class="btn btn-light waves-effect">Open in a separate page</button></a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#SelectFromClass").change(function() {
            ...
            var href = "<?= base_url() ?>EN/Schools/Class_Avatars/" + selectedclass;
            $('#Students_Link').attr('href', href);
            $.ajax({
                type: 'POST',
                url: '<?= base_url(); ?>EN/Schools/ListStudentsChangeAvatar',
                data: {
