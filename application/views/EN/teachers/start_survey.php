...
<body>
    <div class="main-content">
        <div class="page-content">
            <div class="row pl-4">
                <h3><?php echo $serv_data[0]['Title_en']; ?></h3><br>
                <p class="text-muted col-12 p-0"><?php echo $serv_data[0]['Message']  ?><a href="<?php echo $en_link ?>" class="btn float-right change_lange">english version</a></p>
            </div>
            <div class="row">
                <div class="container">
                    <div class="col-12 ">
                        <div class="card">
                            ...
                            <div class="alert alert-danger" role="alert" style="display: none;"></div>
                                <form id="my_answers" token="<?php echo md5(time()); ?>" method="post">
                                    ...
                                    <button class="btn btn-primary  waves-effect waves-light" type="Submit"> إحفظ إجاباتي </button>
                                </form>
                            </div>
                        </div>
                    </div>
...
$("#my_answers").on('submit', function (e) {
     ...
     $.ajax({
          type: 'POST',
          url: '<?php echo base_url(); ?>AR/teachers/start_survey?serv=<?php echo $serv_id; ?>&time=<?php echo date('H:i:s'); ?>',
          ...
          success: function (data) {
            if(data !== "ok"){
                ...
                setTimeout(function(){
                    location.href = "<?php echo base_url("AR/teachers/Show_surveys"); ?>";
                },1000);
            }  
          },
          ajaxError: function(){
