...
GROUP BY `l2_co_monthly_result`.`Created` ")->result_array();
	foreach($arrayOfPatient as $patient_result){
		...
		$arr[] = array("start" => $patient_result['Date'] , "title" => " Normal : $normal   " ,
					   "className" => 'bg-success' , "allDay" => "false" );
		$arr[] = array("start" => $patient_result['Date'] , "title" => " high : $high " , 
					   "className" => 'bg-danger' , "allDay" => "false" );
		$arr[] = array("start" => $patient_result['Date'] , "title" => " low : $low  " ,
					   "className" => 'bg-info' , "allDay" => "false" );
		$arr[] = array("start" => $patient_result['Date'] , "title" => " moderate : $moderate " , 
