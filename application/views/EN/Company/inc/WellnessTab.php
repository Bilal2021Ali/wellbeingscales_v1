...
<div class="col-lg-12">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <h4 class="card-title bordred_title" style="padding: 30px;background: #0eacd8;border: 2px solid #006a88;font-size: 25px;"> Graphical Presentation of Expired Surveys according to Gender</h4>
            <div class="card">
                <div class="card-body text-center">
                    <?php if (!empty($our_published_surveys)) { ?>
                        <div class="hori-timeline mt-5" dir="ltr">
                            <div class="owl-carousel owl-theme navs-carousel events" id="our_surveys_list">
                                <?php foreach ($our_published_surveys as $survey) { ?>
                                    <div class="item ml-3">
                                        <div class="card text-center">
                                            ...
                                            <div class="btn-group" role="group">
                                                <?php if ($survey['answers_counter'] > 0) { ?>
                                                    <a href="<?= base_url("EN/Company/survey-reports/" . $survey['survey_id']); ?>" class="btn btn-outline-light text-truncate"><i class="uil uil-notes mr-1"></i>Reports</a>
                                                <?php } ?>
                                                <a href="<?= base_url("EN/Company/survey-preview/" . $survey['survey_id']); ?>" target="_blank" class="btn btn-outline-light text-truncate"><i class="uil uil-eye mr-1"></i> Preview </a>
                                            </div>
                                        </div>
                                    </div>
                                <?php } ?>
                    ...
                    <?php } else { ?>
                        <img src="<?= base_url("assets/images/no_surveys_found.svg") ?>" style="max-width: 200px;" class="img-responsive w-100 p-1">
                    <?php }  ?>
                </div>
            </div>
        </div>
