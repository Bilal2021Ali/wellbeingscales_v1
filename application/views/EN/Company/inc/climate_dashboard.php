                            ...
                            <div class="col">
                                ...
                                <select name="dept" class="form-control">
                                    ...
                                    <?php foreach ($departments as $key => $department) {   ?>
                                        <option <?= $this->input->post('dept') == $department['Id'] ? "selected" : "" ?> value="<?= $department['Id'] ?>"><?= $department['Dept_Name_EN'] ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                            <div class="col">
                                <label>Climate Title:</label>
                                <input placeholder="Climate Title" name="search" class="form-control" type="search" value="<?= $this->input->post('search') ?? "" ?>">
                            </div>
                        <?php } ?>
                        <div class="col-12">
                                        ...
                                        <div class="card text-center">
                                            <div class="card-body">
                                                ...
                                                <div class="mb-8" style="position: relative">
                                                    <span class="percentage-elem">%</span>
                                                    <div class="GaugeChartContainer" id="GaugeChart_<?= $prefix ?? "" ?>_<?= $survey['survey_id'] ?>"></div>
                                                </div>
                                                <hr>
                                            </div>
                                            <a id="GaugeChart_action_<?= $prefix ?? "" ?>_<?= $survey['survey_id'] ?>" href="<?= base_url('EN/Company/climate-results-chart/' . $survey['survey_id']); ?>" class="w-100 btn btn-warning" style="border-radius: 0px;">Show Details <i class="uil uil-arrow-right"></i></a>
                                        </div>
                                    </div>
                                <?php } ?>
                            </div>
