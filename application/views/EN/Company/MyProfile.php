...
<a href="<?php echo base_url(); ?>EN/dashboardSystem" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
        </div>
                                  ...
                                  <a href="<?php echo base_url(); ?>EN/Users/changePhoto">
                                   ...
                                   <h5 class="font-size-15 mt-3" style="position: relative;top: -42px;margin: 0px;">
                                      ...
                                      <?php  $Useradta = $this->db->query("SELECT * FROM l0_organization WHERE Id = '".$sessiondata["admin_id"]."' ")->result_array();  
                                        ...
                                        <div class="form-group">
                                        <a class="" href="<?php echo base_url(); ?>EN/Users/ResetMyPassword">Password Change</a>      
                                        </div> 
                                        <button class="btn btn-primary w-sm waves-effect waves-light btn-block" type="Submit"
...
$( "#ResetUsername" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Users/ResetL1_Org',
