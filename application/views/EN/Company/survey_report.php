    ...
    <div class="main-content">
        <div class="page-content">
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-sm-8">
                                    ...
                                    <div class="mt-4">
                                        <a href="<?= base_url("EN/Company/survey-report-view/" . $serv_id); ?>" class="btn btn-success waves-effect waves-light">Let’s go!</a>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                ...
                <div class="col-lg-4">
                    <br><h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 071 Survey Counters</h4>
                    <div class="card">
                        <div class="card-body">
