...
<div class="main-content">
    <div class="page-content">
        <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">DASHBOARD</h4>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-6">
                                            ...
                                            <h3><?= $record['goal'] ?></h3>
                                            <p>Tageted goal</p>
                                            <p class="date"><?= $record['last_update'] ?><br>Last update</p>
                                        </div>
                ...
                <?php } else { ?>
                    <div class="col-md-12 mt-5">
                        <div class="text-center">
                            ...
                            <h4 class="text-uppercase mt-4">No Data to View</h4>
                        </div>
                    </div>
                <?php } ?>
            </div>
