            ...
            <div class="col-lg-8 offset-lg-2 mt-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button class="btn btn-success btn-block mt-1 goback" type="button"> If you are done, click here. </button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    $('.goback').click(function() {
        Swal.fire({
            title: " Thank you  ",
            text: ' We will review you report later , thank you',
            icon: 'success',
        });
        setTimeout(() => {
            location.href = "<?= base_url("EN/Students/Mylifereports") ?>";
        }, 1100);
    });
</script>