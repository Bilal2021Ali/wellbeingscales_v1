                            ...
                            <div class="card">
                                <div class="card-body p-4"> 
                                   ...
                                   if(!empty($avatarlist)){      
                                    ...
                                    ?>
                                  <a href="<?php echo base_url() ?>EN/Users/changePhoto/Student/<?php echo $CH_ID; ?>">
                                  ...
                                  <a href="<?php echo base_url(); ?>EN/Users/changePhoto/Student/<?php echo $data['Id']; ?>">
...
<script>
$('#Back').click(function(){
     location.href = "<?php echo base_url() ?>EN/results/Select_Child";
});
