     ...
     <div id="layout-wrapper">
          ...
          <div class="main-content">
               <div class="page-content">
					...
					<h4 class="card-title" style="background: #0eacd8; padding: 10px;color: #ffffff;border-radius: 4px;">SU 003: LIST OF ORGANIZATIONS AND COMPANY SYSTEMS</h4>
                         <div class="row">
                              <div class="col-md-4 col-xl-4 InfosCards">
                                   <div class="card">
                                        <div class="card-body" style="background-color: #097390;">
                                             <div class="float-right mt-2">
                                                 <div class="float-right mt-2"> <img src="<?= base_url(); ?>assets/images/icons/organizations.png" alt="schools" width="50px"> </div>
                                             </div>
                                             <div>
												 <?php
                                                  $allEn = $this->db->query("SELECT * FROM `l0_organization`  ")->num_rows();
                                                  $allDe = $this->db->query("SELECT * FROM `l0_organization` WHERE  `status` = '0' ")->num_rows();
                                                  $all_not_in_qatar = $this->db->query("SELECT * FROM `l0_organization` WHERE  `status` = '1' ")->num_rows();
                                                  ?>
                                                  <h4 class="mb-1 mt-1"><span data-plugin="counterup"><?php echo $allEn ?></span></h4>
                                                  <p class="mb-0">Total Organizations <br> Enabled & Disabled</p>
                                             </div>
                                        </div>
                                   </div>
                              </div> <!-- end col-->
                              <div class="col-md-4 col-xl-4 InfosCards">
                                   <div class="card">
                                        <div class="card-body" style="background-color: #0b86a8;">
                                             <div class="float-right mt-2">
                                                   <div class="float-right mt-2"> <img src="<?= base_url(); ?>assets/images/icons/organizations2.png" alt="schools" width="50px"> </div>
                                             </div>
                                             <div>
                                                  <h4 class="mb-1 mt-1">
                              ...
                              <div class="col-md-4 col-xl-4 InfosCards">
                                   <div class="card">
                                        <div class="card-body" style="background-color: #0c99c0;">
                                             <div class="float-right mt-2">
                                                <div class="float-right mt-2"> <img src="<?= base_url(); ?>assets/images/icons/png_icons/oefgcounter.png" alt="schools" width="50px"> </div>
                                             </div>
                                             <div>
                                                  <h4 class="mb-1 mt-1">
                                             ...
                                             <table id="datatable" class="table table-bordered table-striped  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                  <thead>
                                                       <tr>
                                                            ...
                                                            <th class="card-title" style="background: #add138; padding: 10px;color: #0c637b;border-radius: 4px;" >English system name</th>
                                                            <th class="card-title" style="background: #add138; padding: 10px;color: #0c637b;border-radius: 4px;" >Arabic system name</th>
                                                            ...
                                                            <th class="card-title" style="background: #add138; padding: 10px;color: #0c637b;border-radius: 4px;" >Actions</th>
                                                            <th class="actions" style="background: #add138; padding: 10px;color: #0c637b;border-radius: 4px;" > Status</th>
                                                       </tr>
                                                  </thead>
                                                  <tbody>
				   ...
				   WHERE id = '" . $admin['CountryID'] . "' ORDER BY `name` ASC")->result_array();
						 ...
						 <h4 class="card-title" style="background: #0eacd8; padding: 10px;color: #ffffff;border-radius: 4px;">SU 003: Protected by QlickHealth</h4>
                    ...
                    <div class="row">
                         ...
                         <div class="col-sm-6">
                              <div class="text-sm-right d-none d-sm-block">
                                   <a href="<?php echo base_url(); ?>" target="_blank" class="text-reset"></a>
                              </div>
                         </div>
                    </div>
               </div>
