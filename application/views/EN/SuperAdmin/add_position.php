                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"  placeholder="Please Enter The UserType ar..." name="position_ar" required="">
                                                <div class="valid-feedback"> Looks good! </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
...
<script>
    $("#addPosition").on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>EN/Dashboard/startAddNewPosition',
            data: {
                userposition: userposition,
                code: '<?= $code; ?>',
                position_ar : $('input[name="position_ar"]').val() ,
            },
