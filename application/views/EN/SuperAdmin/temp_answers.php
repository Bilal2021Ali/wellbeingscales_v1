            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="Add_choiceModalLabel">Add Choices Set Name: </h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <form id="creat_choice" class="p-2">
                        <label for="">Choices Set Name EN:</label>
                        <input type="text" name="title_en" minlength="3" maxlength="200" required class="form-control" placeholder="Choices Set Name EN">
                        <label class="mt-1">Choices Set Name AR:</label>
                        <input type="text" name="title_ar" minlength="3" maxlength="200" required class="form-control" placeholder="Choices Set Name AR">
                ...
                <div class="card" style="border: 0px; ">
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <th>#</th>
                                <th>Choices Set Name EN</th>
                                <th>Choices Set Name AR:</th>
                                <th>Actions</th>
                            </thead>
                            <tbody>
