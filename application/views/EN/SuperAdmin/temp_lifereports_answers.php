...
<div class="main-content">
    <div class="page-content">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="Add_choiceModalLabel">Add complaint type: </h5>
        ...
        <div class="row">
            <div class="col-lg-12">
					<h4 class="card-title" style="background: #7D0552; padding: 10px;color: #ffffff;border-radius: 4px;">SU 045: SPEAK OUT (Complaints System)</h4>
		<h4 class="card-title" style="background: #307D7E; padding: 10px;color: #ffffff;border-radius: 4px;">
		0001: Add complaint type<br>
		0002: Add complaint topics<br>
                ...
                <div class="card" style="border: 0px; ">
                    <div class="card-body">
                        <table class="table">
                            <thead>
                                <th>#</th>
                                <th>Complaint Name EN</th>
                                <th>Complaint Name AR</th>
                                <th>Actions</th>
                            </thead>
                            <tbody>
                                <?php foreach ($choices as $sn => $choice) { ?>
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="<?= base_url('EN/Dashboard/lifereports_choices/' . $choice['Id']) ?>">
                                                <i class="uil uil-notebooks text-warning" data-original-title="Adding complaints topics" data-placement="top" data-toggle="tooltip"></i>
                                            </a>
...
<script>
    ...
    $('#creat_choice').on('submit', function(e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url() ?>EN/Dashboard/template_lifereports',
