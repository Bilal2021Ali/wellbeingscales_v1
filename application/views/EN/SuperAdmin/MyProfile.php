...
<body class="authentication-bg">
     ...
     <a href="<?php echo base_url(); ?>EN/Dashboard" class="text-dark"><i class="mdi mdi-home-variant h2"></i></a>
        </div>
                                ...
                                <div class="card-body p-4"> 
                                  ...
                                  <a href="<?php echo base_url(); ?>EN/Users/changePhoto">
                                   ...
                                   <h5 class="font-size-15 mt-3" style="position: relative;top: -42px;margin: 0px;">
                                      ...
                                      <?php  $Useradta = $this->db->query("SELECT * FROM superadmin WHERE Id = '".$sessiondata["admin_id"]."' ")->result_array();  
									    ...
									    title="Sorry You Cant Change The Username" value="<?php echo $admin['Username'] ?>">   
                                        </div> 
                                        </form> 
                                         <?php } ?>
                                    </div>
...
$( "#ResetUsername" ).on( 'submit', function ( e ) {
     ...
     $.ajax( {
          type: 'POST',
          url: '<?php echo base_url(); ?>EN/Users/ResetSuperAdmin',
