                  ...
                  <div>
                    <div class="row">
                      <div class="col-lg-6">
                        ...
                        <span> <strong> Note: </strong> MAC Address Must Be Unique </span> </div>
                      <div class="col-lg-6">
                    ...
                    <div class="row" style="padding-top: 10px;">
                      <div class="col-lg-6">
                        ...
                        <span> <strong> Note: </strong> To Add Site ==> Add Members => +Site </span> </div>
                      <div class="col-lg-6">
                        <div class="form-group mb-4">
                          <label for="billing-name">Description of this Device EN</label>
