	...
	$s_number ++;	
		 ?>
          <tr>
               ...
               WHERE id = '".$admin['Citys']."' ORDER BY `Name_EN` ASC LIMIT 1")->result_array();                       foreach($contriesarray as $contrie){     
               echo $contrie['Name_EN'];
               }
               ?>
               </td>
               <td><a href="<?php echo base_url() ?>AR/DashboardSystem/UpdateSchoolData/<?php echo $admin['Id']; ?>">
               ...
               <input type="checkbox" theAdminId="<?php echo $admin['Id']; ?>" id="status" 
               <?php echo $cheked; ?> >
