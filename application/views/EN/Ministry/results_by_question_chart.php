            ...
            <div class="card">
                <div class="card-body">
                    <h1 class="card text-center"
                        style="background: #add138; padding: 30px;color: #2E1E1E;border-radius: 20px;"><?= $serv_data['set_name_en'] ?> </h1>
                    <form class="row" method="post">
                        ...
                        <div class="col-lg-12 school-select-container">
                            ...
                            <select name="schools[]" class="form-control select2 school-select" multiple="multiple"
                                    data-placeholder="Select Schools">
                        ...
                        <?php /*?> <div class="col-lg-12 mt-2 supported-classes-container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 px-5 default-choices-colors" style="display: grid;align-items: center;">
                            ...
                            <p class="mt-2">Showing results on the date range:
                                <br><b>From</b>: <?= $serv_data['From_date'] ?> <b>To</b> : <?= $serv_data['To_date'] ?>
                                                        ...
                                                        <?php foreach ($questions as $question_key => $question) { ?>
                                                            ...
                                                            <h3 class="card-title">Q<?= $questions_counter ?>
                                                                ...
                                                                <span class="open_more_q float-right"
                                                                      link="<?= base_url('EN/schools/question_detailed_report/' . $serv_id . "/" . $question['q_id'] . "/" . $group_choices . '/' . md5(time())) ?>"
                                                            ...
                                                            <div class="row p-2 rowOfChoices">
                                                                    ...
                                                                    <?php foreach ($choices as $key => $choice) { ?>
                                                                        ...
                                                                        if ($perc_result > 0) { ?>
                                                                            <div data-container="body"
                                                                                 ...
                                                                                 data-content="- <?= $use_count ?>  The number of users who selected this choice: <br> - The percentage of users who selected this choice:  <?= $perc_result ?>% <br> - The total number of users who answered the survey: <?= $all_count ?>"
                                                                ...
                                                                <?php } else { ?>
                                                                    <p class="p-2 text-center w-100 bg-warning text-white br-2 rounded">
                                                                        No answers were found for this survey.</p>
                                                                <?php } ?>
                                                            </div>
                                                        <?php } ?>
                                                    </div>
                                                        ...
                                                        <?php if (!empty($users_passed_survey)) { ?>
                                                            <?php foreach ($choices as $key => $choice) { ?>
                                                                ...
                                                                <div data-container="body" data-toggle="popover"
                                                                     ...
                                                                     title="<?= $choice['title_en']; ?>"
                                                                     data-html="true"
                                                                     data-content="- The number of users who selected this choice: <?= $use_count ?> <br> - The percentage of users who selected this choice:  <?= $perc_result ?>% <br> - The total number of users who answered the survey: <?= $all_count ?>"
