        ...
        <div class="row">
            ...
            <?php if ($temperatureandlabs) { ?>
                ...
                <div class="col-xl-12 mb-4">
                    ...
                    <?php $this->load->view('EN/Ministry/inc/schools-cards'); ?>
                </div>
                        ...
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body overflow-auto">
                                    <?php $this->load->view('EN/Ministry/inc/schools-table', ['schools' => $our_schools]); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;"><?= __("stay_home_counter_results_for_all_schools_3") ?></h4>
                </div>
                ...
                <div class="col-12">
                    <h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"><?= __("stay_home_counter_results_for_all_schools_4") ?></h4>
                </div>
                ...
                <div class="col-xl-12">
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="card">
                                <div class="card-body overflow-auto">
                                    <?php $this->load->view('EN/Ministry/inc/departments-table', ['departments' => $departments, "disableStatusControl" => true]); ?>
                                </div>
                            </div>
                        </div>
                    </div>
