...
<div class="main-content">
    <div class="page-content">
        ...
        <br>
        <br><h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CHW 064 COUNTERS</h4>
        <div class="row">
            <div class="col-lg-3">
        ...
        <div class="row">
            <div class="col-lg-6">
                <br><h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CHW 065 Graphical Presentation of Responses According to Gender</h4>
                <div class="card">
                    <div class="card-body">
                        <h3 class="text-center ">Graphical Presentation of Responses According to Gender</h3>
                        <div id="genders_charts"></div>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <br><h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CHW 066 AVERAGE TIME RESPONSE</h4>
                <div class="card p-4">
                    <div class="card-body text-center">
                        <i class="uil uil-clock-eight font-size-70"></i>
                        <h4>AVERAGE TIME RESPONSE </h4>
        ...
        <?php if ($type_of_user == "Students") { ?>
            <div class="col-12">
                <br><h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CHW 067 COUNTER of STUDENTS</h4>
                <div class="card p-4">
                    <div class="card-body text-center">
                                        ...
                                        <div class="card text-center">
                                            ...
                                            <!-- <div class="btn-group" role="group">
                                                <?php if ($survey['answers_counter'] > 0) { ?>
                                                    <!-- <a href="<?= base_url("EN/DashboardSystem/survey_reports/" . $survey['survey_id'] . '/' . $type_of_user); ?>" class="btn btn-outline-light text-truncate"><i class="uil uil-notes mr-1"></i>Reports</a> -->
                                                <?php } ?>
                                                <!-- <a href="<?= base_url("EN/DashboardSystem/survey_preview/" . $survey['survey_id']); ?>" target="_blank" class="btn btn-outline-light text-truncate"><i class="uil uil-eye mr-1"></i> Preview </a> -->
                                            </div> -->
                                        </div>
                                    </div>
                                <?php } ?>
