        ...
        <div class="page-content">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h3 class="text-uppercase text-center">new climate survey</h3>
                            <hr>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if (data == "ok_enabled") {
                        ...
                        setTimeout(() => {
                            location.href = "<?= base_url("EN/DashboardSystem/ClimateSurveys"); ?>";
                        }, 800);
                    } else if (data == "ok_disabled") {
                        Swal.fire({
                            title: 'added successfully',
                            html: 'You can <b>active</b> it ' + '<a href="<?= base_url("EN/DashboardSystem/ClimateSurveys"); ?>">here</a> ',
                            icon: 'success',
                            confirmButtonColor: '#5b8ce8',
