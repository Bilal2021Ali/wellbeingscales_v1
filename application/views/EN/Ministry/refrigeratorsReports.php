                        ...
                        <div class="col-lg-4">
                            ...
                            <select name="department" class="form-control">
                                ...
                                <?php foreach ($depts as $dept) { ?>
                                    <option value="<?= $dept['Id'] ?>" <?= $department == $dept['Id'] ? "selected" : "" ?>><?= $dept['School_Name_EN'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="col-lg-4">
...
<script>
    $('select[name="department"]').change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>EN/DashboardSystem/machenesForDepartment',
            data: {
                dept_id: id,
            },
    ...
    $('select[name="machine"]').change(function() {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>EN/DashboardSystem/tripNames_forthisMachine',
            data: {
                machine_id: id,
            },
            success: function(data) {
