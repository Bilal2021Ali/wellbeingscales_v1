...
?>
<div class="col-xl-12">
    <br><h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">CH 07<?php echo $counter+1 ?> Answer Counter Model</h4>
    <div class="card">
        <div class="card-body">
