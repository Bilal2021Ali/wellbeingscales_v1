                                    ...
                                    <tr id="serv_<?= $survey['survey_id'] ?>">
                                        ...
                                        <td class="text-center">
                                            <a data-toggle="tooltip" data-placement="top" title=""
                                               ...
                                               href="<?= base_url("EN/DashboardSystem/climatePreview/" . $survey['survey_id']); ?>"><i
                                                        class="uil uil-eye font-size-20"></i></a>
                                            <?php if (intval($survey['status']) == 1) { ?>
                                                <a data-toggle="tooltip" data-placement="top" title=""
                                                   data-original-title="Use this Survey"
                                                   href="<?= base_url("EN/DashboardSystem/newclimatesurvey/" . $survey['survey_id']); ?>"><i
                            ...
                            <table class="table dt-responsive nowrap">
                                ...
                                <?php foreach ($oursurveys as $key => $oursurvey) { ?>
                                    <tr id="serv_<?= $oursurvey['survey_id'] ?>">
                                        ...
                                        <td><?= $oursurvey['question'] ?><br><?= $oursurvey['question_ar'] ?></td>
                                        <td>
                                            <label class="switch <?= intval($oursurvey['adminStatus']) == 0 ? 'disabled' : '' ?>">
                                                <input type="checkbox"
                                                       name="ischecked" <?= intval($oursurvey['adminStatus']) == 0 ? 'disabled="disabled"' : '' ?>
                                        ...
                                        <td class="text-center">
                                            <a data-toggle="tooltip" data-placement="top" title=""
                                               data-original-title="Preview"
                                               href="<?= base_url("EN/DashboardSystem/climatePreview/" . $oursurvey['main_survey_id']); ?>"><i
                                                        class="uil uil-eye font-size-20"></i></a>
                                        </td>
                                    </tr>
                                <?php } ?>
