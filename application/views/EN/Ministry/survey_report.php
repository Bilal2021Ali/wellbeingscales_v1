    ...
    <div class="page-content">
                        ...
                        <div class="w-100 " data-simplebar style="height: 386px;">
                            ...
                            <ol class="activity-feed mb-0 pl-2 staffs">
                                <?php foreach ($Staffs as $user_passed) { ?>
                                    <li class="feed-item">
                                        <p class="text-muted mb-1 font-size-13"><?= $user_passed['U_Name'] ?>
                                            <small class="d-inline-block ml-1"><?= $user_passed['Finished_at']; ?></small>
                                        </p>
                        ...
                        <div class="row align-items-center">
                            <div class="col-sm-8">
                                <p class="text-white font-size-18">Show reports <b>as LIVE VIEW </b> for better tracking
                                    of
                                    results <i class="mdi mdi-arrow-right"></i></p>
                                <div class="mt-4">
                                    <a href="<?= base_url("EN/DashboardSystem/survey_report_view/" . $serv_id); ?>"
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item text-center active">
                                    ...
                                    <p class="font-size-15">User Respondent Counter</p>
                                </div>
                                <div class="carousel-item text-center">
                                    ...
                                    <p class="font-size-15">Staff Respondent Counter</p>
                                </div>
                                <div class="carousel-item text-center">
                                    <div class="avatar-sm mx-auto mb-4">
                                        <div class="avatar-title rounded-circle bg-soft-primary text-primary font-size-20">
        ...
        <div class="row">
            ...
            <div class="col-xl-12">
                <br><h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;">
                    CH 076 Answer Counter Model</h4>
                <div class="card">
                    <div class="card-body">
