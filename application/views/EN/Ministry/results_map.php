    ...
    <div class="main-content">
        <div class="page-content">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">PREVALENCE MAPS</h4>
                    <p class="card-title-desc"> Click the school to see the results for today`</p>
                    <hr>
                    <form action="" method="post">
                        <div class="row">
                            <div class="col-lg-6">
                                <label class="form-label">Date Range (For Results) <span class="text-danger">*</span>:</label>
                                <div class="input-daterange input-group" id="datepicker6" data-date-format="yyyy-mm-dd" data-date-autoclose="true" data-provide="datepicker" data-date-container='#datepicker6'>
                                    <input type="text" class="form-control" name="start" autocomplete="off" value="<?= $startdate ?>" placeholder="Start Date" />
                                    <input type="text" class="form-control" name="end" autocomplete="off" value="<?= $enddate ?>" placeholder="End Date" />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <label class="form-label">Show Alerts (By Marker Colors)<span class="text-danger">*</span>:</label>
                                <select class="form-control" name="colorsInOrderBy" id="colorsInOrderBy">
                                    <option value="Temperature" <?= $alertby == "Temperature" ? "selected" : "" ?>>Temperature</option>
                                    <option value="Lab" <?= $alertby == "Lab" ? "selected" : "" ?>>Lab Tests</option>
                                    <option value="Quarantine" <?= $alertby == "Quarantine" ? "selected" : "" ?>>Users in Quarantine</option>
                                    <option value="Home" <?= $alertby == "Home" ? "selected" : "" ?>>Users in Home</option>
                                </select>
                            </div>
                            <div class="col-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            function showresults(schoolId) {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?php echo base_url() ?>EN/DashboardSystem/schoolResults',
                    data: {
                        schoolId: schoolId,
                    },
