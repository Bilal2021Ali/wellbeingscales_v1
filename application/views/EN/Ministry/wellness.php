...
<div class="main-content">
  <div class="page-content">
                ...
                <form id="publish_this_serv">
                  <div class="row">
                    ...
                    <div class="col-lg-12 mb-1">
                      <label for="theme">Survey Theme:</label>
                      <span
                                                    class="float-right badge badge-pill badge-primary btn noti-icon right-bar-toggle waves-effect">from here</span>
                      <input type="text" value="not selected" class="form-control"
                                                   id="theme_title" readonly>
                      <input type="hidden" name="theme" id="theme" value="0">
                    </div>
                    <div class="col-lg-12">
                      <label for="">Instructions: </label>
                      <textarea class="form-control mb-2"
                                                      placeholder="Instructions for the respondents/users"
                                                      name="Message"></textarea>
                    </div>
                    <input type="hidden" name="serv_id">
                    <div class="col-lg-12">
                      <button type="Submit"
                                                    class="btn btn-primary btn-lg btn-block waves-effect waves-light mb-1"> Publish Survey </button>
                    </div>
                  </div>
                </form>
              </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="card"> <br>
          <div class="row image_container"> <img src="<?php echo base_url(); ?>assets/images/banners/MAINWELNEWSS.png" alt="schools"> </div>
          <br>
        </div>
      </div>
    </div>
    <br>
    <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> WEL 001 Wellbeing Management</h4>
    <div class="row mb-3">
      <div class="col-lg-12 text">
        <ul class="nav nav-tabs nav-tabs-custom nav-justified">
          <li class="nav-item"> <a class="nav-link active nav_1_b" tab_for="#home" role="tab"> <img src="<?php echo base_url('assets/images/icons/homewelness.png') ?>" alt=""> <span>HOME</span> </a> </li>
          <li class="nav-item"> <a class="nav-link nav_2_b" tab_for="#wellness" role="tab"> <img src="<?php echo base_url('assets/images/icons/wellness.png') ?>" alt=""> <span>WELLNESS DASHBOARD</span> </a> </li>
          <li class="nav-item"> <a class="nav-link nav_3_b" tab_for="#manage_surveys" role="tab"> <img src="<?php echo base_url('assets/images/icons/manage_survey.png') ?>" alt=""> <span class="d-none d-sm-block">MANAGE SURVEYS</span> </a> </li>
          <li class="nav-item"> <a class="nav-link nav_4_b" tab_for="#expired_surveys" role="tab"> <img src="<?php echo base_url('assets/images/icons/lib_surveys.png') ?>" alt=""> <span class="d-none d-sm-block">SURVEY LIBRARY</span> </a> </li>
          <!--          <li class="nav-item"> <a class="nav-link nav_6_b" tab_for="#media" role="tab"> <img src="-->
          <?php //echo base_url('assets/images/icons/media.png') ?><!--" alt=""> <span class="d-none d-sm-block">MEDIA GALLERY</span> </a> </li>-->
          <!--          <li class="nav-item"> <a class="nav-link nav_7_b" tab_for="#well_edu" role="tab"> <img src="-->
          <?php //echo base_url('assets/images/icons/well_edu.png') ?><!--" alt=""> <span class="d-none d-sm-block">WELLNESS EDUCATION RESOURCES </span> </a> </li>-->
          <!--          <li class="nav-item nav_5_b"> <a class="nav-link" tab_for="#action_planes" role="tab"> <img src="--><?php //echo base_url('assets/images/icons/action_planes.png') ?><!--" alt=""> <span class="d-none d-sm-block">ACTION PLANS</span> </a> </li>-->
<!--          <li class="nav-item"> <a class="nav-link nav_8_b" tab_for="#reports" role="tab"> <img src="--><?php //echo base_url('assets/images/icons/reports.png') ?><!--" alt=""> <span class="d-none d-sm-block">REPORTS</span> </a> </li>-->
        </ul>
      </div>
    </div>
          ...
          <div class="col-12">
            <div class="row homeimages">
              ...
              <div class="col-lg-12 mt-1 <?= $i == 1 ? "" : "hidden" ?>" id="Home_img_<?= $i ?>">
                <div class="img-fluid text-center"> <img src="<?php echo base_url('assets/images/homeimages/S' . $i . '.png'); ?>" alt="" style="width: 75%;">
    ...
    <div class="row mt2 real_wellness" id="wellness">
      <?php $this->load->view('EN/Ministry/inc/wellness_tab') ?>
    </div>
    <div class="row mt2 real_wellness" id="manage_surveys">
      <div class="col-12">
        <div class="card"> <br>
          <div class="row image_container"> <img src="<?php echo base_url(); ?>assets/images/banners/CH1.png" alt="schools"> </div>
          <br>
        </div>
      </div>
      <div class="col-12"> <br>
        <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CHW 055 Manage Survey-Questionnaires and Scales</h4>
      </div>
      <div class="card">
        <div class="card-body">
          <div class="table-responsive mb-0" data-pattern="priority-columns" data-simplebar="init">
            <table class="table dt-responsive nowrap">
              ...
              <tbody>
                ...
                $questions_count = $this->db->query( "SELECT Id FROM `sv_st_questions`
                ...
                <tr id="serv_<?= $survey['survey_id']; ?>">
                  ...
                  <td><input for_serv="<?= $survey['survey_id']; ?>" style="width: 122px;" type="text"
                                               class="form-control hidden_inp end_date" data-provide="datepicker"
                                               data-date-format="yyyy-mm-dd" value="<?= $survey['To_date']; ?>"></td>
                  <td><?= $survey['choices_en_title']; ?></td>
                  <td><?= $survey['answers_counter'] ?></td>
                  ...
                  <td class="text-center"><span data-toggle="tooltip" data-placement="top"
                                                      data-original-title="Show the survey questions"> <i class="uil uil-notes questions" data-toggle="modal"
                                                       data-target="#myModal"
                                                       group="<?= $survey['main_survey_id']; ?>"></i> </span></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
          ...
          <div class="row">
            <div class="col-12">
              <div class="card"> <br>
                <div class="row image_container"> <img src="<?php echo base_url(); ?>assets/images/banners/Maintiltles.png"
                                         alt="schools"> </div>
                <br>
              </div>
            </div>
          ...
          <br>
          <h4 class="card-title"
                        style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CHW 056 Manage Survey-Interview Guide</h4>
          <div class="table-responsive mb-0" data-pattern="priority-columns" data-simplebar="init">
            <table class="table dt-responsive nowrap">
              <thead>
              <th> #</th>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><input for_serv="<?= $avalaible_fillable_survey['survey_id']; ?>"
                                               style="width: 122px;" type="text"
                                               class="form-control hidden_inp end_date" data-provide="datepicker"
                                               data-date-format="yyyy-mm-dd" data-survey-type="fillable"
                                               value="<?= $avalaible_fillable_survey['To_date']; ?>"></td>
                  <td><label class="switch">
                      <input type="checkbox" name="ischecked" data-survey-type="fillable"
                                                   serv_Id="<?= $avalaible_fillable_survey['survey_id']; ?>" <?= $avalaible_fillable_survey['status'] == 1 ? 'checked' : ""; ?>>
                      <span class="slider round"></span> </label></td>
                  <td class="text-center"><span data-toggle="tooltip" data-placement="top"
                                                      data-original-title="Show the survey questions"> <i class="uil uil-notes questions" data-toggle="modal"
                                                       data-survey-type="fillable" data-target="#myModal"
                                                       group="<?= $avalaible_fillable_survey['main_survey_id']; ?>"></i> </span></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
    ...
    <div class="row mt3 real_wellness" id="expired_surveys">
      ...
      <div class="col-lg-12"> <br>
        <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CHW 057 SURVEY LIBRARY</h4>
        <div class="row">
          <div class="col-xl-12">
            <div class="card">
              <div class="card-body">
                  ...
                  <table class="table dt-responsive nowrap av_fillable_surveys_list">
                    ...
                    <tbody>
                      ...
                      foreach ( $avalaible_surveys as $key => $survey ) {
                          $choices_count = $this->db->query( "SELECT Id FROM `sv_set_template_answers_choices`
                                                    WHERE `group_id` = '" . $survey[ 'group_id' ] . "' " )->num_rows();
                          $answers_counter = $this->db->query( "SELECT Id FROM `sv_st_questions`
                                                    WHERE `survey_id` = '" . $survey[ 'survey_id' ] . "' " )->num_rows();
                          ?>
                      <tr id="serv_<?= $survey['survey_id']; ?>">
                        <td class="count"><?= $key + 1; ?></td>
                        <td><?= $survey['serv_code']; ?></td>
                        ...
                        <td class="text-center"><span data-toggle="tooltip" data-placement="top"
                                                                  data-original-title="Show the survey questions"> <i class="uil uil-notes questions" data-toggle="modal"
                                                                   data-target="#myModal"
                                                                   group="<?= $survey['survey_id']; ?>"></i> </span> <a href="<?= base_url() ?>EN/DashboardSystem/use_this_survey/<?= $survey['survey_id']; ?>"
                                                       class="use_ser" data-toggle="tooltip" data-placement="top"
                                                       data-original-title="Use this survey"> <i class="uil uil-channel"></i> </a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
                ...
                <br>
                <br>
                <h4 class="card-title" style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CHW 058 Interview Guide</h4>
                <div class="table-responsive mb-0 av_fillable_surveys_list"
                  ...
                  <table class="table dt-responsive nowrap">
                    ...
                    <tbody>
                      ...
                      <tr id="Interview <?= $survey['survey_id']; ?>">
                        <td class="count"><?= $key + 1; ?></td>
                        <td><?= $survey['serv_code']; ?></td>
                        ...
                        <td><?= $survey['questions_count'] ?></td>
                        <td class="text-center"><span data-toggle="tooltip" data-placement="top"
                                                                  data-original-title="Show the survey questions"> <i class="uil uil-notes fillablequestions"
                                                                   data-toggle="modal" data-target="#myModal"
                                                                   group="<?= $survey['survey_id']; ?>"></i> </span> <a href="<?= base_url() ?>EN/DashboardSystem/use_this_survey/<?= $survey['survey_id']; ?>/fillable"
                                                       class="use_ser" data-toggle="tooltip" data-placement="top"
                                                       data-original-title="Use this survey"> <i class="uil uil-channel"></i> </a></td>
                      </tr>
                      <?php } ?>
    ...
    <div class="row mt3 real_wellness" id="action_planes">
      ...
      <div class="col-lg-12"> <br>
        <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 061 ACTION PLANS </h4>
        <div class="card">
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6 col-xl-4">
                <div class="card">
                  ...
                  <?php
                  $file_info = explode( '.', $filertest[ 'file_url' ] );
                  ...
                  <img class="card-img-top img-fluid"
                                                             src="<?= base_url('uploads/Category_resources/' . $filertest['file_language'] . "/" . $filertest["file_url"]) ?>"
                                                             alt="Card image cap">
                  <?php } else { ?>
                  <img class="card-img-top img-fluid"
                                                             src="<?= base_url('uploads/Reports_resources/' . $filertest['file_language'] . "/" . $filertest["file_url"]) ?>"
                                                             alt="Card image cap">
                  <?php } ?>
                  <?php
                  unset( $media[ $key ] ); // removing the file from array
                  ?>
                  <?php
                  break;
                  }
                  ...
                  <?php if (!$havethumb) { ?>
                  <img class="card-img-top img-fluid"
                                                     src="<?= base_url("assets/images/Placeholder-Icon-File.png") ?>"
                                                     alt="Card image cap">
                  <?php } ?>
                  <div class="card-body">
                    <h4 class="card-title mt-0 text-center">
                      <?= $category['media_name_en'] == "" ? "No title" : $category['media_name_en']; ?>
                    </h4>
                    <hr>
                    <div class="linkslist">
                      <?php foreach ($media as $link) { ?>
                      <?php if ($link['file_type'] == "1") { ?>
                      <a href="<?= base_url('uploads/Category_resources/' . $link['file_language'] . "/" . $link["file_url"]) ?>"
                                                               target="_blank"
                                                               title="<?= strlen($link['file_name_en']) > 30 ? $link['file_name_en'] : ""; ?>"
                                                               class="btn btn-primary waves-effect waves-light w-100 mb-2 mt-1">
                      <?= strlen($link['file_name_en']) > 30 ? substr($link['file_name_en'], 0, 30) . "....." : $link['file_name_en']; ?>
                      </a>
                      <?php } else { ?>
                      <a href="<?= base_url('uploads/Category_resources/' . $link['file_language'] . "/" . $link["file_url"]) ?>"
                                                               target="_blank"
    ...
    <div class="row mt3 real_wellness" id="media">
      ...
      <div class="col-lg-12"> <br>
        <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 059 MEDIA GALLERY </h4>
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="linkslist">
                          ...
                          ?>
                          <img src="<?= $thumburl ?>" alt="" class="w-100"> <a href="<?= $link['link'] ?>" target="_blank"
                                                                   title="<?= strlen($link['title']) > 30 ? $link['title'] : ""; ?>"
                                                                   class="btn btn-primary waves-effect waves-light w-100 mb-2 mt-1">
                          <?= strlen($link['title']) > 30 ? substr($link['title'], 0, 30) . "....." : $link['title']; ?>
                          </a>
                          <?php } ?>
                        </div>
                      </div>
    ...
    <div class="row mt3 real_wellness" id="well_edu">
      <?php $this->load->view('EN/Ministry/inc/WELLNESS_EDUCATION_RESOURCES'); ?>
    </div>
    <div class="row mt3 real_wellness" id="reports">
      ...
      <div class="col-lg-12"> <br>
        <h4 class="card-title"
                    style="background: linear-gradient(90deg, rgba(116,83,163,1) 0%, rgba(121,195,236,1) 99%);padding: 10px;color: #ffffff;border-radius: 4px;margin-top: -30px;"> CH 062 REPORTS </h4>
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        ...
                        <div class="linkslist">
                          ...
                          <?php } else { ?>
                          <a href="<?= base_url('uploads/Reports_resources/' . $link['file_language'] . "/" . $link["file_url"]) ?>"
                                                                       target="_blank"
                                                                       title="<?= strlen($link['file_name_en']) > 30 ? $link['file_name_en'] : ""; ?>"
                                                                       class="btn btn-primary waves-effect waves-light w-100 mb-2 mt-1">
                          <?= strlen($link['file_name_en']) > 30 ? substr($link['file_name_en'], 0, 30) . "....." : $link['file_name_en']; ?>
...
<div class="right-bar">
  <div data-simplebar class="h-100">
    ...
    <div class="p-4 btn w-100 waves-effect waves-light"
                 onclick="setTheme(<?php echo $theme['Id'] ?>,'<?php echo $theme['title_an']; ?>')">
      <div class="mb-2">
...
<script>
    ...
    $('.end_date').each(function () {
        $(this).change(function () {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url(); ?>EN/DashboardSystem/change_serv_status',
                data: {
                    new_date: new_date,
                    serv_id: serv_id,
                    type: 'update_date',
    ...
    $("#publish_this_serv").on('submit', function (e) {
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url(); ?>EN/DashboardSystem/publish_serv',
